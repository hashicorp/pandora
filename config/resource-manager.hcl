...
service "containerservice" {
  ...
  available = ["2019-08-01", "2022-09-02-preview", "2023-02-02-preview"]
}
service "cosmos-db" {
  name      = "CosmosDB"
...
service "monitor" {
  name      = "Insights"
  available = ["2015-04-01", "2016-03-01", "2018-03-01", "2018-04-16", "2019-10-17-preview", "2020-10-01", "2021-04-01", "2021-05-01-preview", "2021-08-01", "2021-09-01", "2022-10-01", "2023-01-01"]
}
service "msi" {
...
service "recoveryservicesbackup" {
  ...
  available = ["2021-12-01", "2022-03-01", "2022-04-01", "2022-10-01", "2023-02-01"]
  ignore    = ["2023-01-01"]
}
...
service "security" {
  name      = "Security"
  available = ["2017-08-01-preview", "2019-01-01-preview", "2019-01-01", "2019-08-01", "2020-01-01", "2021-06-01", "2022-03-01", "2022-05-01", "2023-01-01"]
}
