...
service "containerservice" {
  ...
  available = ["2019-08-01", "2022-09-02-preview", "2023-02-02-preview", "2023-03-02-preview"]
}
service "cosmos-db" {
  name      = "CosmosDB"
...
service "recoveryservices" {
  ...
  available = ["2021-08-01", "2021-12-01", "2022-03-01", "2022-08-01", "2022-09-10", "2022-10-01", "2023-01-15", "2023-02-01"]
  ignore    = ["2023-01-01"]
}
