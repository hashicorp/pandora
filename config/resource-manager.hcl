...
service "compute" {
  name      = "Compute"
  available = ["2021-07-01", "2021-11-01", "2022-03-01", "2022-03-02", "2024-03-01"]
}
...
service "containerservice" {
  ...
  available = ["2019-08-01", "2022-09-02-preview", "2022-11-01", "2023-01-01", "2023-01-02-preview", "2023-02-02-preview"]
}
service "cosmos-db" {
  name      = "CosmosDB"
