...
service "appconfiguration" {
  ...
  available = ["2023-03-01", "2024-05-01", "2024-06-01"]
}
...
service "authorization" {
  name      = "Authorization"
  available = ["2018-01-01-preview", "2020-04-01-preview", "2020-10-01", "2022-04-01", "2022-05-01-preview", "2024-12-01-preview"]
}
service "automanage" {
  name      = "AutoManage"
...
service "batch" {
  name      = "Batch"
  available = ["2023-05-01", "2023-11-01", "2024-02-01", "2024-07-01"]
}
service "billing" {
  name      = "Billing"
  available = ["2019-10-01-preview", "2020-05-01", "2021-10-01", "2024-04-01"]
}
service "blueprint" {
  name      = "Blueprints"
...
service "compute" {
  name      = "Compute"
  available = ["2021-07-01", "2022-03-01", "2022-03-02", "2022-03-03", "2023-03-01", "2023-04-02", "2023-07-03", "2024-03-01", "2024-07-01", "2024-11-01"]
}
...
service "consumption" {
  name      = "Consumption"
  available = ["2019-10-01", "2021-10-01", "2022-09-01", "2023-05-01", "2023-11-01", "2024-08-01"]
  ignore    = ["2023-03-01"]
}
...
service "containerregistry" {
  ...
  available = ["2019-06-01-preview", "2023-06-01-preview", "2023-07-01", "2023-11-01-preview", "2025-04-01"]
}
...
service "cosmos-db" {
  name      = "CosmosDB"
  available = ["2022-05-15", "2022-11-15", "2023-04-15", "2023-09-15", "2023-11-15", "2024-05-15", "2024-08-15", "2024-11-15", "2025-04-15"]
}
service "cost-management" {
  name      = "CostManagement"
  available = ["2021-10-01", "2022-06-01-preview", "2022-10-01", "2023-03-01", "2023-07-01-preview", "2023-08-01", "2023-11-01", "2024-08-01", "2025-03-01"]
}
...
service "dynatrace" {
  name      = "Dynatrace"
  available = ["2021-09-01", "2023-04-27", "2024-04-24"]
}
service "elastic" {
  name      = "Elastic"
...
service "frontdoor" {
  name      = "FrontDoor"
  available = ["2020-04-01", "2020-05-01", "2022-05-01", "2024-02-01", "2025-03-01"]
}
...
service "labservices" {
  name      = "LabServices"
  available = ["2022-08-01", "2023-06-07"]
}
...
service "mysql" {
  name      = "MySql"
  available = ["2017-12-01", "2020-01-01", "2021-05-01", "2021-12-01-preview", "2022-01-01", "2023-12-30"]
}
service "netapp" {
  name      = "NetApp"
...
service "oracle" {
  name      = "OracleDatabase"
  available = ["2024-06-01", "2025-03-01"]
}
service "orbital" {
  name      = "Orbital"
  available = ["2022-11-01"]
...
service "quota" {
  name      = "Quota"
  available = ["2023-02-01", "2025-03-01", "2025-07-15"]
}
service "recoveryservices" {
  name      = "RecoveryServices"
  available = ["2024-01-01", "2024-02-01", "2024-04-01", "2024-10-01", "2025-02-01"]
}
...
service "resources" {
  name      = "Resources"
  available = ["2015-11-01", "2020-05-01", "2020-10-01", "2021-07-01", "2022-02-01", "2022-06-01", "2022-09-01", "2022-12-01", "2023-07-01", "2023-08-01", "2024-03-01", "2024-04-01", "2024-07-01", "2024-08-01", "2025-01-01", "2025-03-01", "2025-04-01"]
  ignore    = ["2023-11-01"]
}
service "scvmm" {
  name      = "SystemCenterVirtualMachineManager"
  available = ["2023-10-07", "2024-06-01", "2025-03-13"]
}
service "search" {
  name      = "Search"
  available = ["2022-09-01", "2023-11-01", "2024-06-01-preview", "2025-05-01"]
}
service "security" {
  name      = "Security"
  available = ["2019-01-01-preview", "2020-01-01", "2021-06-01", "2022-03-01", "2022-05-01", "2022-12-01-preview", "2023-01-01", "2023-05-01", "2023-10-01-preview", "2023-11-15", "2024-01-01", "2024-04-01", "2024-08-01", "2025-03-01"]
}
...
service "vmware" {
  name      = "VMware"
  available = ["2022-05-01", "2023-03-01", "2023-09-01", "2024-09-01"]
}
