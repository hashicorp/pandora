...
func TestDirectAssignment_CreateOrUpdate_Identity_SystemAssigned_RequiredToRequired(t *testing.T) {
	...
	testData := []struct {
		...
		{
			schemaModelFieldType: models.SystemAssignedIdentityTerraformSchemaObjectDefinitionType,
			sdkFieldType:         models.SystemAssignedIdentitySDKObjectDefinitionType,
