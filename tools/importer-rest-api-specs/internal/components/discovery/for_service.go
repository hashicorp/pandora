...
func DiscoverForService(service services.Service, workingDirectory string, skipDataPlane bool, threadID int) (*models.AvailableDataSet, error) {
	...
	for _, apiVersion := range service.Available {
		...
		dataSet, err := discoverDataSetForAPIVersion(apiVersion, *filePaths, skipDataPlane)
		if err != nil {
