...
var workarounds = []workaround{
	...
	commonWorkaroundIsLRO{"RecoveryServicesBackup", []string{"2025-02-01", "2025-08-01"}, []string{"ProtectedItems"}, []string{"Delete"}, nil},
	// https://github.com/Azure/azure-rest-api-specs/issues/37325
	commonWorkaroundIsLRO{"RecoveryServicesBackup", []string{"2025-02-01", "2025-08-01"}, []string{"ProtectionContainers"}, []string{"Unregister"}, nil},
