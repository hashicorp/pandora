...
type expected struct {
	...
	Computed            bool
	ForceNew            bool
	FieldType           sdkModels.TerraformSchemaObjectDefinitionType
	ReferenceName       *string
	NestedReferenceName *string
	NestedReferenceType sdkModels.TerraformSchemaObjectDefinitionType
	Validation          *expectedValidation
}

type expectedValidation struct {
	Type               sdkModels.TerraformSchemaFieldValidationType
...
type IdentityConfig struct {
	*FieldConfig
	IdentityType sdkModels.TerraformSchemaObjectDefinitionType
}
...
func (r resourceUnderTest) checkFieldName(t *testing.T, input sdkModels.TerraformSchemaModel) {
	if r.NameConfig == nil {
...
func (r resourceUnderTest) checkFieldLocation(t *testing.T, input sdkModels.TerraformSchemaModel) {
	...
	if !ok {
		...
		if location.ObjectDefinition.Type != sdkModels.LocationTerraformSchemaObjectDefinitionType {
...
func (r resourceUnderTest) checkFieldTags(t *testing.T, input sdkModels.TerraformSchemaModel) {
	if r.TagsConfig == nil {
	...
	if !ok {
		...
		if tags.ObjectDefinition.Type != sdkModels.TagsTerraformSchemaObjectDefinitionType {
...
func (r resourceUnderTest) checkFieldIdentity(t *testing.T, input sdkModels.TerraformSchemaModel) {
...
func (r resourceUnderTest) checkField(t *testing.T, input sdkModels.TerraformSchemaModel, exp expected) {
	...
	if exp.Validation != nil && field.Validation != nil {
		switch exp.Validation.Type {
		case sdkModels.PossibleValuesTerraformSchemaFieldValidationType:
			{
				if v, ok := field.Validation.(sdkModels.TerraformSchemaFieldValidationPossibleValuesDefinition); ok {
					if exp.Validation.PossibleValueCount != 0 && v.PossibleValues != nil {
		...
		default:
			{
				t.Errorf("(%s) expected the field %q (model: %q) to have Validation Type of %q, but got %T", r.Name, exp.FieldName, r.CurrentModel, string(exp.Validation.Type), field.Validation)
			}
		}
	}
}
