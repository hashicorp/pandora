...
func TestModelsWithASystemAssignedIdentity(t *testing.T) {
	parsed, err := Load("testdata/", "models_system_assigned.json", true)
	if err != nil {
...
func TestModelsWithASystemAssignedIdentityInlined(t *testing.T) {
	parsed, err := Load("testdata/", "models_system_assigned_inlined.json", true)
	if err != nil {
		t.Fatalf("loading: %+v", err)
	}
...
func TestModelsWithAUserAssignedListIdentity(t *testing.T) {
	parsed, err := Load("testdata/", "models_user_assigned_list.json", true)
	if err != nil {
		t.Fatalf("loading: %+v", err)
	}
...
func TestModelsWithAUserAssignedListIdentityInlined(t *testing.T) {
	parsed, err := Load("testdata/", "models_user_assigned_list_inlined.json", true)
	if err != nil {
		t.Fatalf("loading: %+v", err)
	}
...
func TestModelsWithAUserAssignedMapIdentity(t *testing.T) {
	parsed, err := Load("testdata/", "models_user_assigned_map.json", true)
	if err != nil {
		t.Fatalf("loading: %+v", err)
	}
...
func TestModelsWithAUserAssignedMapIdentityInlined(t *testing.T) {
	parsed, err := Load("testdata/", "models_user_assigned_map_inlined.json", true)
	if err != nil {
		t.Fatalf("loading: %+v", err)
	}
