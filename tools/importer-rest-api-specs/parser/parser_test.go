				...
				Operations: map[string]models.OperationDetails{
					"Create": {
						...
						RequestObject: &models.ObjectDefinition{
							...
							ReferenceName: strPtr("ConfigurationStore"),
						},
					...
					"ListKeys": {
						...
						ResponseObject: &models.ObjectDefinition{
							Type:          models.ObjectDefinitionReference,
							ReferenceName: strPtr("AccessKey"),
						},
					...
					"Update": {
						RequestObject: &models.ObjectDefinition{
							Type:          models.ObjectDefinitionReference,
							ReferenceName: strPtr("ConfigurationStoreUpdateParameters"),
						},
						ResourceIdName: strPtr("ConfigurationStore"),
			...
			"PrivateEndpointConnections": {
				...
				Operations: map[string]models.OperationDetails{
					"CreateOrUpdate": {
						...
						RequestObject: &models.ObjectDefinition{
							Type:          models.ObjectDefinitionReference,
							ReferenceName: strPtr("PrivateEndpointConnection"),
						},
						Options:        map[string]models.OperationOption{},
			...
			"PrivateLinkResources": {
				...
				Operations: map[string]models.OperationDetails{
					"Get": {
						...
						ResponseObject: &models.ObjectDefinition{
							Type:          models.ObjectDefinitionReference,
							ReferenceName: strPtr("PrivateLinkResource"),
						},
