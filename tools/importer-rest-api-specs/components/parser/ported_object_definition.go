...
func (d *SwaggerDefinition) parseObjectDefinition(
	...
	input *spec.Schema,
	known parserModels.ParseResult,
	parsingModel bool,
) (*sdkModels.SDKObjectDefinition, *parserModels.ParseResult, error) {
...
func (d *SwaggerDefinition) parseDataFactoryCustomTypes(input *spec.Schema, known parserModels.ParseResult) (*sdkModels.SDKObjectDefinition, *parserModels.ParseResult, error) {
	formatVal := ""
