...
func normalizedResourceId(segments []models.ResourceIdSegment) string {
	...
	for _, segment := range segments {
		...
		case resourcemanager.ConstantSegment, resourcemanager.ResourceGroupSegment, models.ScopeSegment, resourcemanager.SubscriptionIdSegment, models.UserSpecifiedSegment:
			// e.g. {example}
