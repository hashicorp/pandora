...
func (d *SwaggerDefinition) parseModel(name string, input spec.Schema) (*parserModels.ParseResult, error) {
...
func (d *SwaggerDefinition) findConstantsWithinModel(fieldName string, modelName *string, input spec.Schema, known parserModels.ParseResult) (*parserModels.ParseResult, error) {
...
func (d *SwaggerDefinition) detailsForField(modelName string, propertyName string, value spec.Schema, isRequired bool, known parserModels.ParseResult) (*sdkModels.SDKField, *parserModels.ParseResult, error) {
...
func (d *SwaggerDefinition) fieldsForModel(modelName string, input spec.Schema, known parserModels.ParseResult) (*map[string]sdkModels.SDKField, *parserModels.ParseResult, error) {
...
func (d *SwaggerDefinition) findOrphanedDiscriminatedModels(serviceName string) (*parserModels.ParseResult, error) {
	result := parserModels.ParseResult{
		Constants: map[string]sdkModels.SDKConstant{},
		Models:    map[string]sdkModels.SDKModel{},
	}
