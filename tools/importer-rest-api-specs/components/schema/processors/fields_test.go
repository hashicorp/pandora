...
//func TestProcessField_FlattenReferenceId(t *testing.T) {
//	testData := []struct {
//		fieldInput   string
...
//		t.Logf("[DEBUG] Testing %s", v.fieldInput)
//
//		actual, _ := fieldNameFlattenReferenceId{}.UpdatedNameForField(v.fieldInput, &v.builderInput, &v.metadataInput, nil)
//
//		if actual == nil {
//			if v.expected == nil {
//				continue
