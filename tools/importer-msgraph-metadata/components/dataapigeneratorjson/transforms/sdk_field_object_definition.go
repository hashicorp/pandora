...
func mapSDKObjectDefinitionToRepository(details models.SDKObjectDefinition, constants map[string]models.SDKConstant, models map[string]models.SDKModel, commonTypes models.CommonTypes) (*dataapimodels.ObjectDefinition, error) {
...
func validateObjectDefinition(input dataapimodels.ObjectDefinition, constants map[string]models.SDKConstant, models map[string]models.SDKModel, commonTypes models.CommonTypes) error {
