...
func PersistFileSystem(workingDirectory string, dataType models.SourceDataType, relativeOutputDirectory string, serviceName *string, input *FileSystem) error {
	...
	if serviceName != nil {
		...
		logging.Log.Debug("Creating directories")
	}
