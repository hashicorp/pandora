...
func (s *Generator) writeToPathForResource(directory, filePath string, templater templaterForResource, data GeneratorData) error {
...
func (s *Generator) writeToPathForVersion(directory, filePath string, templater templaterForVersion) error {
