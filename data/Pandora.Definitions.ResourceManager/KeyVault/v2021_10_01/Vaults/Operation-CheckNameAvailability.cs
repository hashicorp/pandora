...
internal class CheckNameAvailabilityOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(VaultCheckNameAvailabilityParametersModel);

    public override ResourceID? ResourceId() => new SubscriptionId();

    public override Type? ResponseObject() => typeof(CheckNameAvailabilityResultModel);

    public override string? UriSuffix() => "/providers/Microsoft.KeyVault/checkNameAvailability";
