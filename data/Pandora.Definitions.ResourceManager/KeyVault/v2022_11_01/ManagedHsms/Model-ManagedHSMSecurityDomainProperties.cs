...
internal class ManagedHSMSecurityDomainPropertiesModel
{
    [JsonPropertyName("activationStatus")]
    public ActivationStatusConstant? ActivationStatus { get; set; }

    [JsonPropertyName("activationStatusMessage")]
