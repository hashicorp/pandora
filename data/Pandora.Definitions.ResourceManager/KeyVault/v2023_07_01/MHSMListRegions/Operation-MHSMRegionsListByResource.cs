...
internal class MHSMRegionsListByResourceOperation : Pandora.Definitions.Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new ManagedHSMId();

    public override Type NestedItemType() => typeof(MHSMGeoReplicatedRegionModel);
