...
internal class SkuVersionId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{locationName}/publishers/{publisherName}/artifactTypes/vmImage/offers/{offerName}/skus/{skuName}/versions/{versionName}";
