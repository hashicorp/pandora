...
internal class OSDiskImageSecurityProfileModel
{
    [JsonPropertyName("confidentialVMEncryptionType")]
    public ConfidentialVMEncryptionTypeConstant? ConfidentialVMEncryptionType { get; set; }
