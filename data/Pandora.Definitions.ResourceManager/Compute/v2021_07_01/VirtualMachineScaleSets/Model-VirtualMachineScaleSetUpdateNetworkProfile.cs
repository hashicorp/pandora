...
internal class VirtualMachineScaleSetUpdateNetworkProfileModel
{
    ...
    public List<VirtualMachineScaleSetUpdateNetworkConfigurationModel>? NetworkInterfaceConfigurations { get; set; }
}
