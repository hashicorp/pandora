...
internal class VirtualMachineScaleSetVMProfileModel
{
    ...
    [JsonPropertyName("securityPostureReference")]
    public SecurityPostureReferenceModel? SecurityPostureReference { get; set; }

    [JsonPropertyName("securityProfile")]
    public SecurityProfileModel? SecurityProfile { get; set; }

    [JsonPropertyName("serviceArtifactReference")]
    public ServiceArtifactReferenceModel? ServiceArtifactReference { get; set; }
