...
{
    [JsonPropertyName("allocatedMediaAddressPrefixes")]
    public List<string>? AllocatedMediaAddressPrefixes { get; set; }

    [JsonPropertyName("allocatedSignalingAddressPrefixes")]
    public List<string>? AllocatedSignalingAddressPrefixes { get; set; }

    [JsonPropertyName("apiBridge")]
    public ApiBridgePropertiesModel? ApiBridge { get; set; }
    ...
    [JsonPropertyName("customSipHeaders")]
    public CustomSipHeadersPropertiesModel? CustomSipHeaders { get; set; }

    [JsonPropertyName("dnsDelegations")]
    public DnsDelegationsPropertiesModel? DnsDelegations { get; set; }
