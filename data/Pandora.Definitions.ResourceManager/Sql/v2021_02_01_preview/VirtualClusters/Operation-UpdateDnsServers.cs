...
internal class UpdateDnsServersOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? ResponseObject() => typeof(UpdateManagedInstanceDnsServersOperationModel);
