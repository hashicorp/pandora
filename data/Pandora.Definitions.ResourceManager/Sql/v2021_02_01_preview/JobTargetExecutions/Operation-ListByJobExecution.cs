...
internal class ListByJobExecutionOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(ListByJobExecutionOperation.ListByJobExecutionOptions);

    public override string? UriSuffix() => "/targets";

    internal class ListByJobExecutionOptions
    {
