...
namespace Pandora.Definitions.ResourceManager.Sql.v2021_02_01_preview.VirtualNetworkRules;

internal class VirtualNetworkRuleId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/virtualNetworkRules/{virtualNetworkRuleName}";
