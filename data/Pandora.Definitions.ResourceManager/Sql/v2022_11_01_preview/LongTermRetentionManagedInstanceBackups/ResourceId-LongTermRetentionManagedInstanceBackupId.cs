...
internal class LongTermRetentionManagedInstanceBackupId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/providers/Microsoft.Sql/locations/{locationName}/longTermRetentionManagedInstances/{longTermRetentionManagedInstanceName}/longTermRetentionDatabases/{longTermRetentionDatabaseName}/longTermRetentionManagedInstanceBackups/{longTermRetentionManagedInstanceBackupName}";
