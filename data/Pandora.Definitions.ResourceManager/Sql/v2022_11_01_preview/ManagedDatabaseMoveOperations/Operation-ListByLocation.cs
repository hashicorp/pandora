...
internal class ListByLocationOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(ManagedDatabaseMoveOperationResultModel);

    public override Type? OptionsObject() => typeof(ListByLocationOperation.ListByLocationOptions);

    public override string? UriSuffix() => "/managedDatabaseMoveOperationResults";

    internal class ListByLocationOptions
    {
