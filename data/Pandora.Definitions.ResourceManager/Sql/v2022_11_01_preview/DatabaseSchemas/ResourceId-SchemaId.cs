...
namespace Pandora.Definitions.ResourceManager.Sql.v2022_11_01_preview.DatabaseSchemas;

internal class SchemaId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/schemas/{schemaName}";
