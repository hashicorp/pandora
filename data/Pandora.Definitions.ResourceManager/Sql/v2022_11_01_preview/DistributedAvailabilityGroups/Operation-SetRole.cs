...
internal class SetRoleOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(DistributedAvailabilityGroupSetRoleModel);
