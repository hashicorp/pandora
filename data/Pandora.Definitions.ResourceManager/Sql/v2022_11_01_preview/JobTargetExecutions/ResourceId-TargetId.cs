...
namespace Pandora.Definitions.ResourceManager.Sql.v2022_11_01_preview.JobTargetExecutions;

internal class TargetId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents/{jobAgentName}/jobs/{jobName}/executions/{jobExecutionId}/steps/{stepName}/targets/{targetId}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.UserSpecified("jobExecutionId"),
        ResourceIDSegment.Static("staticSteps", "steps"),
        ResourceIDSegment.UserSpecified("stepName"),
        ResourceIDSegment.Static("staticTargets", "targets"),
        ResourceIDSegment.UserSpecified("targetId"),
    };
}
