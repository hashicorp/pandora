...
internal class CreateOrUpdateOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(BackupLongTermRetentionPolicyModel);

    public override ResourceID? ResourceId() => new DatabaseId();

    public override Type? ResponseObject() => typeof(BackupLongTermRetentionPolicyModel);
