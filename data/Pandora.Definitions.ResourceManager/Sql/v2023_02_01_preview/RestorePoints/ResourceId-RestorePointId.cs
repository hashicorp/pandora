...
namespace Pandora.Definitions.ResourceManager.Sql.v2023_02_01_preview.RestorePoints;

internal class RestorePointId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/restorePoints/{restorePointName}";
