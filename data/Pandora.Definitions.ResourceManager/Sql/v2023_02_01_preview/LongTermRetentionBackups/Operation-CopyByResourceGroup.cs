...
internal class CopyByResourceGroupOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CopyLongTermRetentionBackupParametersModel);
