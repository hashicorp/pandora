...
internal class ServiceObjectiveCapabilityModel
{
    ...
    [JsonPropertyName("supportedFreeLimitExhaustionBehaviors")]
    public List<FreeLimitExhaustionBehaviorCapabilityModel>? SupportedFreeLimitExhaustionBehaviors { get; set; }
