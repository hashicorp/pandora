...
namespace Pandora.Definitions.ResourceManager.Sql.v2023_02_01_preview.ManagedDatabaseSensitivityLabels;

internal class SensitivityLabelSensitivityLabelSourceId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/sensitivityLabels/{sensitivityLabelSource}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Constant("sensitivityLabelSource", typeof(SensitivityLabelSourceConstant)),
    };
}
