...
internal class ImportDatabaseOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ImportNewDatabaseDefinitionModel);
