...
internal class ImportOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ImportExistingDatabaseDefinitionModel);
