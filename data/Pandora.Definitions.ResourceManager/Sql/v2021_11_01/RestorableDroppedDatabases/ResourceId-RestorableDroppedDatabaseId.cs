...
namespace Pandora.Definitions.ResourceManager.Sql.v2021_11_01.RestorableDroppedDatabases;

internal class RestorableDroppedDatabaseId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/restorableDroppedDatabases/{restorableDroppedDatabaseId}";
