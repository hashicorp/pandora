...
internal class ManagedInstanceFamilyCapabilityModel
{
    ...
    [JsonPropertyName("supportedVcoresValues")]
    public List<ManagedInstanceVcoresCapabilityModel>? SupportedVcoresValues { get; set; }
}
