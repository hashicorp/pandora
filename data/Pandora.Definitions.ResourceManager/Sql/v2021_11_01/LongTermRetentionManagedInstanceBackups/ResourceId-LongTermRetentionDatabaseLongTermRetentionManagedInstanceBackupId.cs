...
internal class LongTermRetentionDatabaseLongTermRetentionManagedInstanceBackupId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/locations/{locationName}/longTermRetentionManagedInstances/{longTermRetentionManagedInstanceName}/longTermRetentionDatabases/{longTermRetentionDatabaseName}/longTermRetentionManagedInstanceBackups/{longTermRetentionManagedInstanceBackupName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticLongTermRetentionManagedInstanceBackups", "longTermRetentionManagedInstanceBackups"),
        ResourceIDSegment.UserSpecified("longTermRetentionManagedInstanceBackupName"),
    };
}
