...
internal class OperationsStatusId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/providers/Microsoft.Chaos/locations/{locationName}/operationsStatuses/{asyncOperationId}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticOperationsStatuses", "operationsStatuses"),
