...
internal class MarketplaceAgreementsCreateOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(AgreementTermsModel);
