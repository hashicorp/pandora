...
internal class OperationLocationId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/mediaServices/{accountName}/liveEvents/{liveEventName}/operationLocations/{operationId}";
