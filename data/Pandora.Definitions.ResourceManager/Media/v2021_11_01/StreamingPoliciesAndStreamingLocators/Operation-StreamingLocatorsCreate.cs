...
internal class StreamingLocatorsCreateOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(StreamingLocatorModel);
