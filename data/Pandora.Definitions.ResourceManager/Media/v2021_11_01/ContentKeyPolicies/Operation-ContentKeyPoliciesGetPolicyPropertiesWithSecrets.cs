...
internal class ContentKeyPoliciesGetPolicyPropertiesWithSecretsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/getPolicyPropertiesWithSecrets";
