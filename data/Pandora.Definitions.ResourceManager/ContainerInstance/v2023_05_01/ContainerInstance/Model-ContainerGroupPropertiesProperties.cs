...
{
    [JsonPropertyName("confidentialComputeProperties")]
    public ConfidentialComputePropertiesModel? ConfidentialComputeProperties { get; set; }
    ...
    public List<DeploymentExtensionSpecModel>? Extensions { get; set; }
    ...
    public ContainerGroupPriorityConstant? Priority { get; set; }
