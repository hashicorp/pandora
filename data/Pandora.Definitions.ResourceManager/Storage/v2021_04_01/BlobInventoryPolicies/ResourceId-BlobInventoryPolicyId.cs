...
internal class BlobInventoryPolicyId : ResourceID
{
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticInventoryPolicies", "inventoryPolicies"),
        ResourceIDSegment.Constant("blobInventoryPolicyName", typeof(BlobInventoryPolicyNameConstant)),
    };
}
