...
internal class SourceControlId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/sourceControls/{name}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
                ...
                new()
                {
                    Name = "staticSourceControls",
                    Type = ResourceIDSegmentType.Static,
                    FixedValue = "sourceControls"
                },
