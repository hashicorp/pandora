...
internal class ManagedEnvironmentsDiagnosticsGetRootOperation : Pandora.Definitions.Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/detectorProperties/rootApi";
