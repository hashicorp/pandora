...
internal class ManagedEnvironmentDiagnosticsListDetectorsOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new ManagedEnvironmentId();

    public override Type? ResponseObject() => typeof(DiagnosticsCollectionModel);
