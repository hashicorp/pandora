...
internal class ConnectedEnvironmentsCertificatesCreateOrUpdateOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override ResourceID? ResourceId() => new ConnectedEnvironmentCertificateId();
