...
internal class StopMultipleExecutionsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(JobExecutionNamesCollectionModel);
