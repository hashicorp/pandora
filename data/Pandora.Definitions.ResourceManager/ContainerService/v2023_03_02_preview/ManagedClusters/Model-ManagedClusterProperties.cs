...
internal class ManagedClusterPropertiesModel
{
    ...
    [JsonPropertyName("guardrailsProfile")]
    public GuardrailsProfileModel? GuardrailsProfile { get; set; }
    ...
    public ManagedClusterIngressProfileModel? IngressProfile { get; set; }
    ...
    public ManagedClusterNodeResourceGroupProfileModel? NodeResourceGroupProfile { get; set; }
    ...
    public ServiceMeshProfileModel? ServiceMeshProfile { get; set; }
    ...
    public KubernetesSupportPlanConstant? SupportPlan { get; set; }

    [JsonPropertyName("upgradeSettings")]
    public ClusterUpgradeSettingsModel? UpgradeSettings { get; set; }
