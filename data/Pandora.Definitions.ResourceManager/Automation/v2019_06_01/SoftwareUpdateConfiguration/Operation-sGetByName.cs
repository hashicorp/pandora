...
internal class sGetByNameOperation : Pandora.Definitions.Operations.GetOperation
{
    ...
    public override Type? OptionsObject() => typeof(sGetByNameOperation.sGetByNameOptions);

    internal class sGetByNameOptions
    {
