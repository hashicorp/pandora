...
internal class sDeleteOperation : Pandora.Definitions.Operations.DeleteOperation
{
    ...
    public override Type? OptionsObject() => typeof(sDeleteOperation.sDeleteOptions);

    internal class sDeleteOptions
    {
