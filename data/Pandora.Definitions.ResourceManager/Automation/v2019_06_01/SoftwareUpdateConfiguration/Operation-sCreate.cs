...
internal class sCreateOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? OptionsObject() => typeof(sCreateOperation.sCreateOptions);

    internal class sCreateOptions
    {
