...
internal class GetByNameOperation : Pandora.Definitions.Operations.GetOperation
{
    ...
    public override Type? OptionsObject() => typeof(GetByNameOperation.GetByNameOptions);

    internal class GetByNameOptions
    {
