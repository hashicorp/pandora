...
namespace Pandora.Definitions.ResourceManager.Automation.v2023_11_01.TestJobStream;

internal class RunbookId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/runbooks/{runbookName}";
