...
internal class Definition : ResourceDefinition
{
    ...
    public IEnumerable<Interfaces.ApiOperation> Operations => new List<Interfaces.ApiOperation>
    {
        ...
        new AccountBackupsListByNetAppAccountOperation(),
        new CreateOperation(),
        new DeleteOperation(),
        new GetOperation(),
        new GetLatestStatusOperation(),
        new ListByVaultOperation(),
        new UnderAccountMigrateBackupsOperation(),
        new UnderBackupVaultRestoreFilesOperation(),
        new UnderVolumeMigrateBackupsOperation(),
        new UpdateOperation(),
    };
