...
internal class UpdateNetworkSiblingSetOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(UpdateNetworkSiblingSetRequestModel);
