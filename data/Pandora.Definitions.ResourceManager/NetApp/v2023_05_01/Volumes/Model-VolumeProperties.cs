...
{
    [JsonPropertyName("actualThroughputMibps")]
    public float? ActualThroughputMibps { get; set; }
    ...
    public CoolAccessRetrievalPolicyConstant? CoolAccessRetrievalPolicy { get; set; }
    ...
    [JsonPropertyName("dataStoreResourceId")]
    public List<string>? DataStoreResourceId { get; set; }
    ...
    public EncryptionKeySourceConstant? EncryptionKeySource { get; set; }

    [JsonPropertyName("exportPolicy")]
    public VolumePropertiesExportPolicyModel? ExportPolicy { get; set; }

    [JsonPropertyName("fileAccessLogs")]
    public FileAccessLogsConstant? FileAccessLogs { get; set; }
    ...
    [JsonPropertyName("originatingResourceId")]
    ...
    [JsonPropertyName("provisionedAvailabilityZone")]
    ...
    public SmbAccessBasedEnumerationConstant? SmbAccessBasedEnumeration { get; set; }
    ...
    public SmbNonBrowsableConstant? SmbNonBrowsable { get; set; }
