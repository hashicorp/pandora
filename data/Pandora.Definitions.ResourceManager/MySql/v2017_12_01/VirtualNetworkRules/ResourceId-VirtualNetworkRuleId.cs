...
namespace Pandora.Definitions.ResourceManager.MySql.v2017_12_01.VirtualNetworkRules;

internal class VirtualNetworkRuleId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/virtualNetworkRules/{virtualNetworkRuleName}";
