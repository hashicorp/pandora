...
internal class BatchUpdateOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ConfigurationListForBatchUpdateModel);
