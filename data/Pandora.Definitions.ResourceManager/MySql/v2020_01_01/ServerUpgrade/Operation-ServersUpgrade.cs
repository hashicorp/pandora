...
internal class ServersUpgradeOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ServerUpgradeParametersModel);
