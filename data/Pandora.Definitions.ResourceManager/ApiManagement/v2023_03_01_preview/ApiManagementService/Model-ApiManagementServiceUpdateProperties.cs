...
internal class ApiManagementServiceUpdatePropertiesModel
{
    ...
    public ConfigurationApiModel? ConfigurationApi { get; set; }
    ...
    public DeveloperPortalStatusConstant? DeveloperPortalStatus { get; set; }
    ...
    public LegacyPortalStatusConstant? LegacyPortalStatus { get; set; }
