...
internal class Definition : ResourceDefinition
{
    ...
    public IEnumerable<Interfaces.ApiOperation> Operations => new List<Interfaces.ApiOperation>
    {
        ...
        new UpdateOperation(),
        new WorkspaceApiCreateOrUpdateOperation(),
        new WorkspaceApiDeleteOperation(),
        new WorkspaceApiGetOperation(),
        new WorkspaceApiGetEntityTagOperation(),
        new WorkspaceApiListByServiceOperation(),
        new WorkspaceApiUpdateOperation(),
    };
