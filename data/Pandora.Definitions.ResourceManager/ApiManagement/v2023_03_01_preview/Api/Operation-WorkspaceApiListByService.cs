...
internal class WorkspaceApiListByServiceOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(WorkspaceApiListByServiceOperation.WorkspaceApiListByServiceOptions);

    public override string? UriSuffix() => "/apis";

    internal class WorkspaceApiListByServiceOptions
    {
