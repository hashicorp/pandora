...
internal class WorkspaceTagCreateOrUpdateOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? OptionsObject() => typeof(WorkspaceTagCreateOrUpdateOperation.WorkspaceTagCreateOrUpdateOptions);

    internal class WorkspaceTagCreateOrUpdateOptions
    {
        [HeaderName("If-Match")]
        [Optional]
