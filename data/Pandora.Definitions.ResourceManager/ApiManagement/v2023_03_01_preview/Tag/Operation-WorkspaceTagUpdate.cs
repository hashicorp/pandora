...
internal class WorkspaceTagUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? OptionsObject() => typeof(WorkspaceTagUpdateOperation.WorkspaceTagUpdateOptions);

    internal class WorkspaceTagUpdateOptions
    {
        [HeaderName("If-Match")]
