...
internal class WorkspaceGroupUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? OptionsObject() => typeof(WorkspaceGroupUpdateOperation.WorkspaceGroupUpdateOptions);

    internal class WorkspaceGroupUpdateOptions
    {
        [HeaderName("If-Match")]
