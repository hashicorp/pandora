...
internal class Definition : ResourceDefinition
{
    ...
    public IEnumerable<Interfaces.ApiOperation> Operations => new List<Interfaces.ApiOperation>
    {
        ...
        new UpdateOperation(),
        new WorkspaceGroupCreateOrUpdateOperation(),
        new WorkspaceGroupDeleteOperation(),
        new WorkspaceGroupGetOperation(),
        new WorkspaceGroupGetEntityTagOperation(),
        new WorkspaceGroupListByServiceOperation(),
        new WorkspaceGroupUpdateOperation(),
    };
