...
internal class Definition : ResourceDefinition
{
    ...
    public IEnumerable<Interfaces.ApiOperation> Operations => new List<Interfaces.ApiOperation>
    {
        ...
        new WorkspaceApiPolicyCreateOrUpdateOperation(),
        new WorkspaceApiPolicyDeleteOperation(),
        new WorkspaceApiPolicyGetOperation(),
        new WorkspaceApiPolicyGetEntityTagOperation(),
        new WorkspaceApiPolicyListByApiOperation(),
    };
