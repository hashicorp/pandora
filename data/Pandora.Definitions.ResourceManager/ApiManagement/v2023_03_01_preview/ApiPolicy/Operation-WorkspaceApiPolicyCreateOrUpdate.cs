...
internal class WorkspaceApiPolicyCreateOrUpdateOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? OptionsObject() => typeof(WorkspaceApiPolicyCreateOrUpdateOperation.WorkspaceApiPolicyCreateOrUpdateOptions);

    public override string? UriSuffix() => "/policies/policy";

    internal class WorkspaceApiPolicyCreateOrUpdateOptions
    {
        [HeaderName("If-Match")]
        [Optional]
