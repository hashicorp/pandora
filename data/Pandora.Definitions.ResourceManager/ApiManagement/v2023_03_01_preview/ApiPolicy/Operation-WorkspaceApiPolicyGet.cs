...
internal class WorkspaceApiPolicyGetOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new WorkspaceApiId();

    public override Type? ResponseObject() => typeof(PolicyContractModel);

    public override Type? OptionsObject() => typeof(WorkspaceApiPolicyGetOperation.WorkspaceApiPolicyGetOptions);

    public override string? UriSuffix() => "/policies/policy";

    internal class WorkspaceApiPolicyGetOptions
    {
