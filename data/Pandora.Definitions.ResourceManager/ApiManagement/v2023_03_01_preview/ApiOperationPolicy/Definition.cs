...
internal class Definition : ResourceDefinition
{
    ...
    public IEnumerable<Interfaces.ApiOperation> Operations => new List<Interfaces.ApiOperation>
    {
        ...
        new WorkspaceApiOperationPolicyCreateOrUpdateOperation(),
        new WorkspaceApiOperationPolicyDeleteOperation(),
        new WorkspaceApiOperationPolicyGetOperation(),
        new WorkspaceApiOperationPolicyGetEntityTagOperation(),
        new WorkspaceApiOperationPolicyListByOperationOperation(),
    };
