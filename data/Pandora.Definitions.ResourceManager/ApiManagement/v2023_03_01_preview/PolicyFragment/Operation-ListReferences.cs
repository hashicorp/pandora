...
internal class ListReferencesOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? OptionsObject() => typeof(ListReferencesOperation.ListReferencesOptions);

    public override string? UriSuffix() => "/listReferences";

    internal class ListReferencesOptions
    {
