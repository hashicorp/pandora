...
internal class WorkspaceApiOperationListByApiOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(WorkspaceApiOperationListByApiOperation.WorkspaceApiOperationListByApiOptions);

    public override string? UriSuffix() => "/operations";

    internal class WorkspaceApiOperationListByApiOptions
    {
