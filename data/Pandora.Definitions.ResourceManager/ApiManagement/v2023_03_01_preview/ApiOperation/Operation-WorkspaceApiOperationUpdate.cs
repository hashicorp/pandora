...
internal class WorkspaceApiOperationUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? OptionsObject() => typeof(WorkspaceApiOperationUpdateOperation.WorkspaceApiOperationUpdateOptions);

    internal class WorkspaceApiOperationUpdateOptions
    {
        [HeaderName("If-Match")]
