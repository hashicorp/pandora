...
{
    public override Type? RequestObject() => typeof(AzureMonitorWorkspaceResourceModel);

    public override ResourceID? ResourceId() => new AccountId();

    public override Type? ResponseObject() => typeof(AzureMonitorWorkspaceResourceModel);
