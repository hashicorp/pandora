...
internal class ListAtSubscriptionScopePostOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(SubscriptionScopeMetricsRequestBodyParametersModel);

    public override ResourceID? ResourceId() => new SubscriptionId();

    public override Type? ResponseObject() => typeof(ResponseModel);

    public override Type? OptionsObject() => typeof(ListAtSubscriptionScopePostOperation.ListAtSubscriptionScopePostOptions);

    public override string? UriSuffix() => "/providers/Microsoft.Insights/metrics";

    internal class ListAtSubscriptionScopePostOptions
    {
