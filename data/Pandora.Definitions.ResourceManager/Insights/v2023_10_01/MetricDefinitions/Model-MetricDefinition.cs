...
internal class MetricDefinitionModel
{
    ...
    public AggregationTypeConstant? PrimaryAggregationType { get; set; }

    [JsonPropertyName("resourceId")]
    public string? ResourceId { get; set; }

    [JsonPropertyName("supportedAggregationTypes")]
    public List<AggregationTypeConstant>? SupportedAggregationTypes { get; set; }
