...
internal class ListBySubscriptionOperation : Pandora.Definitions.Operations.GetOperation
{
    ...
    public override Type? ResponseObject() => typeof(LogSearchRuleResourceCollectionModel);

    public override Type? OptionsObject() => typeof(ListBySubscriptionOperation.ListBySubscriptionOptions);

    public override string? UriSuffix() => "/providers/Microsoft.Insights/scheduledQueryRules";
