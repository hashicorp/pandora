...
internal class AzureMonitorPrivateLinkScopePropertiesModel
{
    [JsonPropertyName("accessModeSettings")]
    [Required]
    public AccessModeSettingsModel AccessModeSettings { get; set; }
