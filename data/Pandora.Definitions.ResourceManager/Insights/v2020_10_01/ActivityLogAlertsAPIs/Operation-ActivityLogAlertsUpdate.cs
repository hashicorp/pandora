...
internal class ActivityLogAlertsUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(AlertRulePatchObjectModel);
