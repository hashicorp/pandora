...
internal class MachinesGetOperation : Operations.GetOperation
{
    public override ResourceID? ResourceId() => new MachineId();

    public override Type? ResponseObject() => typeof(MachineModel);

    public override Type? OptionsObject() => typeof(MachinesGetOperation.MachinesGetOptions);

    internal class MachinesGetOptions
    {
