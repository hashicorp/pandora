...
internal class AssessPatchesOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? ResponseObject() => typeof(MachineAssessPatchesResultModel);
