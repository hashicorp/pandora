...
internal class ConfigurationProfileVersionId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AutoManage/configurationProfiles/{configurationProfileName}/versions/{versionName}";
