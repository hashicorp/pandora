...
internal class ListChildResourcesOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new ConfigurationProfileId();

    public override Type? ResponseObject() => typeof(ConfigurationProfileListModel);
