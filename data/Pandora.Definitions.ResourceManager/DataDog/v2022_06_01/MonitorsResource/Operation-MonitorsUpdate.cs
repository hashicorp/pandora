...
internal class MonitorsUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    public override bool LongRunning() => true;

    public override Type? RequestObject() => typeof(DatadogMonitorResourceUpdateParametersModel);
