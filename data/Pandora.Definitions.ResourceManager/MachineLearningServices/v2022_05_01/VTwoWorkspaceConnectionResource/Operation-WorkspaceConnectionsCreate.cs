...
internal class WorkspaceConnectionsCreateOperation : Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(WorkspaceConnectionPropertiesVTwoBasicResourceModel);

    public override ResourceID? ResourceId() => new ConnectionId();

    public override Type? ResponseObject() => typeof(WorkspaceConnectionPropertiesVTwoBasicResourceModel);
