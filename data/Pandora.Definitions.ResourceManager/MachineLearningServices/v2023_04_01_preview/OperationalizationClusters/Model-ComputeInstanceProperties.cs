...
internal class ComputeInstancePropertiesModel
{
    ...
    [JsonPropertyName("autologgerSettings")]
    public ComputeInstanceAutologgerSettingsModel? AutologgerSettings { get; set; }
    ...
    [JsonPropertyName("idleTimeBeforeShutdown")]
    ...
    public ImageMetadataModel? OsImageMetadata { get; set; }
