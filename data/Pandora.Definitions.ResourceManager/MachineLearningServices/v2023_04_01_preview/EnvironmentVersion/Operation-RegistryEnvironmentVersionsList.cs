...
internal class RegistryEnvironmentVersionsListOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(RegistryEnvironmentVersionsListOperation.RegistryEnvironmentVersionsListOptions);

    public override string? UriSuffix() => "/versions";

    internal class RegistryEnvironmentVersionsListOptions
    {
