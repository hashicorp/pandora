...
internal abstract class OnlineDeploymentModel
{
    ...
    [JsonPropertyName("dataCollector")]
    public DataCollectorModel? DataCollector { get; set; }

    [JsonPropertyName("description")]
    public string? Description { get; set; }

    [JsonPropertyName("egressPublicNetworkAccess")]
    public EgressPublicNetworkAccessTypeConstant? EgressPublicNetworkAccess { get; set; }
