...
internal class ForecastingTrainingSettingsModel
{
    [JsonPropertyName("allowedTrainingAlgorithms")]
    public List<ForecastingModelsConstant>? AllowedTrainingAlgorithms { get; set; }

    [JsonPropertyName("blockedTrainingAlgorithms")]
    public List<ForecastingModelsConstant>? BlockedTrainingAlgorithms { get; set; }
    ...
    public TrainingModeConstant? TrainingMode { get; set; }
}
