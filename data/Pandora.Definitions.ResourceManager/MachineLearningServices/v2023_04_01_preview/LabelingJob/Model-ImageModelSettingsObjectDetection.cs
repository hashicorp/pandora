...
internal class ImageModelSettingsObjectDetectionModel
{
    ...
    [JsonPropertyName("logTrainingMetrics")]
    public LogTrainingMetricsConstant? LogTrainingMetrics { get; set; }

    [JsonPropertyName("logValidationLoss")]
    public LogValidationLossConstant? LogValidationLoss { get; set; }
