...
internal class DataReferenceVersionId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/dataReferences/{dataReferenceName}/versions/{versionName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticDataReferences", "dataReferences"),
        ResourceIDSegment.UserSpecified("dataReferenceName"),
