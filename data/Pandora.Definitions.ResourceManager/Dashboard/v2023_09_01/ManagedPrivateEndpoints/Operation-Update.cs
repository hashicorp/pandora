...
internal class UpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(ManagedPrivateEndpointUpdateParametersModel);

    public override ResourceID? ResourceId() => new ManagedPrivateEndpointId();

    public override Type? ResponseObject() => typeof(ManagedPrivateEndpointModelModel);
