...
internal class ListAdminCredentialsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? ResponseObject() => typeof(OpenShiftClusterAdminKubeconfigModel);
