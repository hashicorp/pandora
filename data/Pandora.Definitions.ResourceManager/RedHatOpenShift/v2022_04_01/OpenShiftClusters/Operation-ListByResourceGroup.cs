...
internal class ListByResourceGroupOperation : Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(OpenShiftClusterModel);

    public override string? UriSuffix() => "/providers/Microsoft.RedHatOpenShift/openShiftClusters";
