...
internal class ListCredentialsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? ResponseObject() => typeof(OpenShiftClusterCredentialsModel);
