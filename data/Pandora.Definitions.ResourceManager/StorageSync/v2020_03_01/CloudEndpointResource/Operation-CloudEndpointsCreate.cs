...
internal class CloudEndpointsCreateOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(CloudEndpointCreateParametersModel);
