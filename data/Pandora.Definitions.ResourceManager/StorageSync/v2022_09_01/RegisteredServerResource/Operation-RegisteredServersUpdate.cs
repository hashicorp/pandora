...
internal class RegisteredServersUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(RegisteredServerUpdateParametersModel);
