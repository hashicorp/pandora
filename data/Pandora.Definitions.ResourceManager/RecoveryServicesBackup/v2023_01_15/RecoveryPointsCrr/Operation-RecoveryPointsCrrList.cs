...
internal class RecoveryPointsCrrListOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(RecoveryPointsCrrListOperation.RecoveryPointsCrrListOptions);

    public override string? UriSuffix() => "/recoveryPoints";

    internal class RecoveryPointsCrrListOptions
    {
