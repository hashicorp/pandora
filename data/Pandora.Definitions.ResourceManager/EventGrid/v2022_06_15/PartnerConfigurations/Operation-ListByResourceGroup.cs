...
internal class ListByResourceGroupOperation : Pandora.Definitions.Operations.GetOperation
{
    ...
    public override Type? ResponseObject() => typeof(PartnerConfigurationsListResultModel);

    public override string? UriSuffix() => "/providers/Microsoft.EventGrid/partnerConfigurations";
