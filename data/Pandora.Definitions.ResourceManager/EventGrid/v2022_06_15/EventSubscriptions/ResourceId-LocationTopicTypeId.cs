...
internal class LocationTopicTypeId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/providers/Microsoft.EventGrid/locations/{locationName}/topicTypes/{topicTypeName}";
