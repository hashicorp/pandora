...
internal class ListByDomainTopicOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(ListByDomainTopicOperation.ListByDomainTopicOptions);

    public override string? UriSuffix() => "/providers/Microsoft.EventGrid/eventSubscriptions";

    internal class ListByDomainTopicOptions
    {
