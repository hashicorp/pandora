...
internal class BotsListSecretsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? ResponseObject() => typeof(HealthBotKeysResponseModel);
