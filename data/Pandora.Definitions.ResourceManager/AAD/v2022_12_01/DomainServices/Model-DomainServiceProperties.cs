...
{
    [JsonPropertyName("configDiagnostics")]
    public ConfigDiagnosticsModel? ConfigDiagnostics { get; set; }
    ...
    [JsonPropertyName("syncApplicationId")]
    public string? SyncApplicationId { get; set; }

    [JsonPropertyName("syncOwner")]
    public string? SyncOwner { get; set; }

    [JsonPropertyName("syncScope")]
    public SyncScopeConstant? SyncScope { get; set; }
