...
internal class PrivateCloudPropertiesModel
{
    ...
    [JsonPropertyName("extendedNetworkBlocks")]
    public List<string>? ExtendedNetworkBlocks { get; set; }
    ...
    [JsonPropertyName("nsxPublicIpQuotaRaised")]
    public NsxPublicIPQuotaRaisedEnumConstant? NsxPublicIPQuotaRaised { get; set; }
