...
internal class ScriptCmdletId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/scriptPackages/{scriptPackageName}/scriptCmdlets/{scriptCmdletName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticScriptCmdlets", "scriptCmdlets"),
        ResourceIDSegment.UserSpecified("scriptCmdletName"),
    };
}
