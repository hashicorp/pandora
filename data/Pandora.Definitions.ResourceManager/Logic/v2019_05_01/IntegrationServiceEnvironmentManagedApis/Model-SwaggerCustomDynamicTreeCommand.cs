...
internal class SwaggerCustomDynamicTreeCommandModel
{
    [JsonPropertyName("itemFullTitlePath")]
    public string? ItemFullTitlePath { get; set; }

    [JsonPropertyName("itemIsParent")]
    ...
    public Dictionary<string, SwaggerCustomDynamicTreeParameterModel>? Parameters { get; set; }

    [JsonPropertyName("selectableFilter")]
