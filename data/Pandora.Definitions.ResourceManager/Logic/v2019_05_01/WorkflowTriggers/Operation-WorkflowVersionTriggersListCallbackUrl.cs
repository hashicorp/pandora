...
internal class WorkflowVersionTriggersListCallbackUrlOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override ResourceID? ResourceId() => new VersionTriggerId();

    public override Type? ResponseObject() => typeof(WorkflowTriggerCallbackUrlModel);

    public override string? UriSuffix() => "/listCallbackUrl";
