...
internal class ComputePolicyId : ResourceID
{
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticComputePolicies", "computePolicies"),
        ResourceIDSegment.UserSpecified("computePolicyName"),
    };
}
