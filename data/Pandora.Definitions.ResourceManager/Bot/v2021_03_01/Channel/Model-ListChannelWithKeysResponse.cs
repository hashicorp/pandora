...
internal class ListChannelWithKeysResponseModel
{
    ...
    public ChannelModel? Properties { get; set; }

    [JsonPropertyName("provisioningState")]
    public string? ProvisioningState { get; set; }

    [JsonPropertyName("resource")]
    public ChannelModel? Resource { get; set; }

    [JsonPropertyName("setting")]
    public ChannelSettingsModel? Setting { get; set; }
