...
internal class ListOutboundNetworkDependenciesEndpointsOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new IntegrationRuntimeId();

    public override Type? ResponseObject() => typeof(IntegrationRuntimeOutboundNetworkDependenciesEndpointsResponseModel);
