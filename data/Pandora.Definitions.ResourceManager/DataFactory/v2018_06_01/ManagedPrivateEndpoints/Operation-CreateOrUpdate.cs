...
internal class CreateOrUpdateOperation : Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(ManagedPrivateEndpointResourceModel);

    public override ResourceID? ResourceId() => new ManagedPrivateEndpointId();

    public override Type? ResponseObject() => typeof(ManagedPrivateEndpointResourceModel);
