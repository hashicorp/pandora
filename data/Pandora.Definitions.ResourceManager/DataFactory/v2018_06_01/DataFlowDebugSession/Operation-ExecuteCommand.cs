...
internal class ExecuteCommandOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(DataFlowDebugCommandRequestModel);
