...
{
    [JsonPropertyName("agentUpdate")]
    public AgentUpdatePatchPropertiesModel? AgentUpdate { get; set; }
    ...
    public HostpoolPublicNetworkAccessConstant? PublicNetworkAccess { get; set; }
