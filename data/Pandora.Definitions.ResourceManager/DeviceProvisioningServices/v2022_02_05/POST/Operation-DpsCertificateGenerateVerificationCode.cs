...
internal class DpsCertificateGenerateVerificationCodeOperation : Operations.PostOperation
{
    ...
    public override Type? OptionsObject() => typeof(DpsCertificateGenerateVerificationCodeOperation.DpsCertificateGenerateVerificationCodeOptions);

    public override string? UriSuffix() => "/generateVerificationCode";

    internal class DpsCertificateGenerateVerificationCodeOptions
    {
