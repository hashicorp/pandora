...
internal class ForResourceGroupCreateOrUpdateOperation : Pandora.Definitions.Operations.PutOperation
{
    public override Type? RequestObject() => typeof(ConfigurationAssignmentModel);

    public override ResourceID? ResourceId() => new ProviderConfigurationAssignmentId();
