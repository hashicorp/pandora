...
internal class GuestConfigurationHCRPAssignmentReportsListOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new GuestConfigurationAssignmentId();

    public override Type? ResponseObject() => typeof(GuestConfigurationAssignmentReportListModel);
