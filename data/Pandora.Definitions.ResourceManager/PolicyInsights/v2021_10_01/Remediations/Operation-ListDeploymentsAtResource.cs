...
internal class ListDeploymentsAtResourceOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(ListDeploymentsAtResourceOperation.ListDeploymentsAtResourceOptions);

    public override string? UriSuffix() => "/listDeployments";

    public override System.Net.Http.HttpMethod Method() => System.Net.Http.HttpMethod.Post;

    internal class ListDeploymentsAtResourceOptions
    {
        [QueryStringName("$top")]
        [Optional]
