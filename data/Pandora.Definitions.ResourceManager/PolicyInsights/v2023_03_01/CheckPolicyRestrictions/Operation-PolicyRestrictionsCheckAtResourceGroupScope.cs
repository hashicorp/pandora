...
internal class PolicyRestrictionsCheckAtResourceGroupScopeOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckRestrictionsRequestModel);
