...
namespace Pandora.Definitions.ResourceManager.PostgreSqlHSC.v2022_11_08.PrivateLinkResources;

internal class PrivateLinkResourceId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{serverGroupsv2Name}/privateLinkResources/{privateLinkResourceName}";
