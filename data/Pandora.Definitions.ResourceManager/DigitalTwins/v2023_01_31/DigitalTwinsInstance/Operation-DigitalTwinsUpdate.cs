...
internal class DigitalTwinsUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(DigitalTwinsPatchDescriptionModel);
