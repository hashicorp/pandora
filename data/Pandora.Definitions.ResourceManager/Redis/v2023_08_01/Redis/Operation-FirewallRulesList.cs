...
internal class FirewallRulesListOperation : Pandora.Definitions.Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new RediId();

    public override Type NestedItemType() => typeof(RedisFirewallRuleModel);
