...
internal class BulkUploadEncryptedOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(EncryptedSimUploadListModel);
