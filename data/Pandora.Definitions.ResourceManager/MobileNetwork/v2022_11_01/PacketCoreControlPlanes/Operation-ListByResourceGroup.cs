...
internal class ListByResourceGroupOperation : Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(PacketCoreControlPlaneModel);

    public override string? UriSuffix() => "/providers/Microsoft.MobileNetwork/packetCoreControlPlanes";
