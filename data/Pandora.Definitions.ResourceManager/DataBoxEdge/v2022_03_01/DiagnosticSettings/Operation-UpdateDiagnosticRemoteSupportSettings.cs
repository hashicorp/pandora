...
internal class UpdateDiagnosticRemoteSupportSettingsOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(DiagnosticRemoteSupportSettingsModel);
