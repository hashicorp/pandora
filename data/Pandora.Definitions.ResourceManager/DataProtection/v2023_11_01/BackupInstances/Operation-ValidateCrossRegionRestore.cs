...
internal class ValidateCrossRegionRestoreOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ValidateCrossRegionRestoreRequestObjectModel);
