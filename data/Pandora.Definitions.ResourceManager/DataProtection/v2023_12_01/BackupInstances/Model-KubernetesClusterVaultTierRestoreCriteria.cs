...
[ValueForType("KubernetesClusterVaultTierRestoreCriteria")]
internal class KubernetesClusterVaultTierRestoreCriteriaModel : ItemLevelRestoreCriteriaModel
{
    ...
    [JsonPropertyName("resourceModifierReference")]
    public NamespacedNameResourceModel? ResourceModifierReference { get; set; }

    [JsonPropertyName("restoreHookReferences")]
    public List<NamespacedNameResourceModel>? RestoreHookReferences { get; set; }

    [JsonPropertyName("stagingResourceGroupId")]
    public string? StagingResourceGroupId { get; set; }

    [JsonPropertyName("stagingStorageAccountId")]
