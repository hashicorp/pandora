...
internal class GetByEnvironmentOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new EnvironmentManagedClusterVersionId();
