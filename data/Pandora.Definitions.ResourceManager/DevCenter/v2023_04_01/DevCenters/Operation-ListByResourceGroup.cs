...
namespace Pandora.Definitions.ResourceManager.DevCenter.v2023_04_01.DevCenters;
...
internal class ListByResourceGroupOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(DevCenterModel);

    public override Type? OptionsObject() => typeof(ListByResourceGroupOperation.ListByResourceGroupOptions);

    public override string? UriSuffix() => "/providers/Microsoft.DevCenter/devCenters";
