...
internal class ServicesUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(DataMigrationServiceModel);
