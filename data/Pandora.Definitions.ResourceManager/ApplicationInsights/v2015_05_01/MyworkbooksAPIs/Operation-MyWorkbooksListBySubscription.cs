...
internal class MyWorkbooksListBySubscriptionOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new SubscriptionId();

    public override Type? ResponseObject() => typeof(MyWorkbooksListResultModel);

    public override Type? OptionsObject() => typeof(MyWorkbooksListBySubscriptionOperation.MyWorkbooksListBySubscriptionOptions);

    public override string? UriSuffix() => "/providers/Microsoft.Insights/myWorkbooks";

    internal class MyWorkbooksListBySubscriptionOptions
    {
