...
internal class CachePropertiesModel
{
    ...
    [JsonPropertyName("primingJobs")]
    public List<PrimingJobModel>? PrimingJobs { get; set; }
    ...
    [JsonPropertyName("spaceAllocation")]
    public List<StorageTargetSpaceAllocationModel>? SpaceAllocation { get; set; }

    [JsonPropertyName("subnet")]
    public string? Subnet { get; set; }

    [JsonPropertyName("upgradeSettings")]
    public CacheUpgradeSettingsModel? UpgradeSettings { get; set; }
