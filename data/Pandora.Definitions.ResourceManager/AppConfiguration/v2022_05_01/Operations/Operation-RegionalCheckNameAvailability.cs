...
internal class RegionalCheckNameAvailabilityOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? ResponseObject() => typeof(NameAvailabilityStatusModel);
