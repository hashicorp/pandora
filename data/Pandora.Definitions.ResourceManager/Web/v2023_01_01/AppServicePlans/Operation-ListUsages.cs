...
internal class ListUsagesOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(ListUsagesOperation.ListUsagesOptions);

    public override string? UriSuffix() => "/usages";

    internal class ListUsagesOptions
    {
