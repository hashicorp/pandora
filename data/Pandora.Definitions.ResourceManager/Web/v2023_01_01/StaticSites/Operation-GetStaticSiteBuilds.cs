...
internal class GetStaticSiteBuildsOperation : Pandora.Definitions.Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new StaticSiteId();

    public override Type NestedItemType() => typeof(StaticSiteBuildARMResourceModel);
