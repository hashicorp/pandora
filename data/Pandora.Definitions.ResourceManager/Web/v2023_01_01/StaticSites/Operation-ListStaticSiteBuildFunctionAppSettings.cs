...
internal class ListStaticSiteBuildFunctionAppSettingsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/listFunctionAppSettings";
