...
internal class ListMultiRolePoolInstanceMetricDefinitionsOperation : Pandora.Definitions.Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new DefaultInstanceId();
