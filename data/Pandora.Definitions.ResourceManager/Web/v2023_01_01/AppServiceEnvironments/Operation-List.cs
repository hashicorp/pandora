...
internal class ListOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(AppServiceEnvironmentResourceModel);

    public override string? UriSuffix() => "/providers/Microsoft.Web/hostingEnvironments";
