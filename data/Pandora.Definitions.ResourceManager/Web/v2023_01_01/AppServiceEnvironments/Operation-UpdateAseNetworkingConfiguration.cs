...
internal class UpdateAseNetworkingConfigurationOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override string? UriSuffix() => "/configurations/networking";
