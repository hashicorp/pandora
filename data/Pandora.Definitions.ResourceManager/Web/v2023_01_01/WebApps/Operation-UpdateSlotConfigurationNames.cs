...
internal class UpdateSlotConfigurationNamesOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override string? UriSuffix() => "/config/slotConfigNames";
