...
internal class ListApplicationSettingsSlotOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/config/appSettings/list";
