...
internal class HostDefaultId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName}/host/default/{defaultName}/{keyName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticHost", "host"),
        ResourceIDSegment.Static("staticDefault", "default"),
        ResourceIDSegment.UserSpecified("defaultName"),
