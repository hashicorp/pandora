...
internal class ListSitePushSettingsSlotOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/config/pushsettings/list";
