...
internal class CreateOrUpdateHostSecretSlotOperation : Pandora.Definitions.Operations.PutOperation
{
    public override Type? RequestObject() => typeof(KeyInfoModel);

    public override ResourceID? ResourceId() => new HostDefaultId();
