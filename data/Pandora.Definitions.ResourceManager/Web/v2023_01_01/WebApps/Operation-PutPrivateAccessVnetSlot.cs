...
internal class PutPrivateAccessVnetSlotOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override string? UriSuffix() => "/privateAccess/virtualNetworks";
