...
internal class ListInstanceWorkflowsSlotOperation : Pandora.Definitions.Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new SlotId();

    public override Type NestedItemType() => typeof(WorkflowEnvelopeModel);
