...
internal class UpdateConnectionStringsSlotOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override string? UriSuffix() => "/config/connectionStrings";
