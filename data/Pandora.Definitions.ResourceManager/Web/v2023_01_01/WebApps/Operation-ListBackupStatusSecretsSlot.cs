...
internal class ListBackupStatusSecretsSlotOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override ResourceID? ResourceId() => new SlotBackupId();

    public override Type? ResponseObject() => typeof(BackupItemModel);

    public override string? UriSuffix() => "/list";
