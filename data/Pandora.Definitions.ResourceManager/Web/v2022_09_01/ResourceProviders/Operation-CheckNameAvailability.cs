...
internal class CheckNameAvailabilityOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? ResponseObject() => typeof(ResourceNameAvailabilityModel);

    public override string? UriSuffix() => "/providers/Microsoft.Web/checknameavailability";
