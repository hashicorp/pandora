...
internal class RouteId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/serverFarms/{serverFarmName}/virtualNetworkConnections/{virtualNetworkConnectionName}/routes/{routeName}";
