...
internal class CreateOrUpdateStaticSiteBuildFunctionAppSettingsOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override string? UriSuffix() => "/config/functionAppSettings";
