...
internal class GetInboundNetworkDependenciesEndpointsOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override string? UriSuffix() => "/inboundNetworkDependenciesEndpoints";
