...
internal class VersionId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/hostRuntime/runtime/webHooks/workflow/api/management/workflows/{workflowName}/versions/{versionId}";
