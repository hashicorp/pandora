...
internal class DomainOwnershipIdentifierId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/domainOwnershipIdentifiers/{domainOwnershipIdentifierName}";
