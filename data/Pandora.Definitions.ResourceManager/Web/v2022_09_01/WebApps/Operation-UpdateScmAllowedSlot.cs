...
internal class UpdateScmAllowedSlotOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override string? UriSuffix() => "/basicPublishingCredentialsPolicies/scm";
