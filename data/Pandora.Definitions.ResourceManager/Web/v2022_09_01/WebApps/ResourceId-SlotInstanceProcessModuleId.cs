...
internal class SlotInstanceProcessModuleId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName}/instances/{instanceId}/processes/{processId}/modules/{moduleName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticProcesses", "processes"),
        ResourceIDSegment.UserSpecified("processId"),
