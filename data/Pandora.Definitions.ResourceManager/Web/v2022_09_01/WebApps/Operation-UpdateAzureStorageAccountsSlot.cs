...
internal class UpdateAzureStorageAccountsSlotOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override string? UriSuffix() => "/config/azurestorageaccounts";
