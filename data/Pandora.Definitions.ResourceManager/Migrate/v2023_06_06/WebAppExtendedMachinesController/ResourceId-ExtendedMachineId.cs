...
internal class ExtendedMachineId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{masterSiteName}/webAppSites/{webAppSiteName}/extendedMachines/{extendedMachineName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticExtendedMachines", "extendedMachines"),
        ResourceIDSegment.UserSpecified("extendedMachineName"),
    };
}
