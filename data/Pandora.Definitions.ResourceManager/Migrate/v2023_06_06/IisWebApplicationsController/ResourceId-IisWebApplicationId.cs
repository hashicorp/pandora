...
internal class IisWebApplicationId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{masterSiteName}/webAppSites/{webAppSiteName}/iisWebApplications/{iisWebApplicationName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticIisWebApplications", "iisWebApplications"),
        ResourceIDSegment.UserSpecified("iisWebApplicationName"),
    };
}
