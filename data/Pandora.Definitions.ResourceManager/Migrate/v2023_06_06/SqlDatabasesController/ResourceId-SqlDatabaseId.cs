...
internal class SqlDatabaseId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{masterSiteName}/sqlSites/{sqlSiteName}/sqlDatabases/{sqlDatabaseName}";
