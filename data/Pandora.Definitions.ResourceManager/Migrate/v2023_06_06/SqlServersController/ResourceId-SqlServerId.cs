...
internal class SqlServerId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{masterSiteName}/sqlSites/{sqlSiteName}/sqlServers/{sqlServerName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticSqlServers", "sqlServers"),
        ResourceIDSegment.UserSpecified("sqlServerName"),
    };
}
