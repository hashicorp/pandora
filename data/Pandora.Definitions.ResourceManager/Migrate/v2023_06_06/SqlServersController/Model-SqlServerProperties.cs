...
internal class SqlServerPropertiesModel
{
    ...
    [JsonPropertyName("machineArmIds")]
    public List<string>? MachineArmIds { get; set; }

    [JsonPropertyName("machineOverviewList")]
    public List<SqlMachineOverviewModel>? MachineOverviewList { get; set; }
