...
internal class TomcatWebApplicationPropertiesModel
{
    ...
    [JsonPropertyName("hasDatabaseDependency")]
    public bool? HasDatabaseDependency { get; set; }
    ...
    [JsonPropertyName("isExternalLoggingConfigured")]
    public bool? IsExternalLoggingConfigured { get; set; }
