...
namespace Pandora.Definitions.ResourceManager.Migrate.v2023_06_06.SqlRunAsAccountsController;

internal class SqlSiteRunAsAccountId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{masterSiteName}/sqlSites/{sqlSiteName}/runAsAccounts/{runAsAccountName}";
