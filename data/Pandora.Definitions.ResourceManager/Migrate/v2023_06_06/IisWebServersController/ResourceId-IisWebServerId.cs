...
internal class IisWebServerId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{masterSiteName}/webAppSites/{webAppSiteName}/iisWebServers/{iisWebServerName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticIisWebServers", "iisWebServers"),
        ResourceIDSegment.UserSpecified("iisWebServerName"),
    };
}
