...
internal class UpdateTagsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(UpdateMachineTagsModel);

    public override ResourceID? ResourceId() => new VMwareSiteId();

    public override Type? ResponseObject() => typeof(object);

    public override string? UriSuffix() => "/updateTags";
