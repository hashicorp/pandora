...
namespace Pandora.Definitions.ResourceManager.Migrate.v2023_06_06.SqlJobsController;

internal class SqlSiteJobId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{masterSiteName}/sqlSites/{sqlSiteName}/jobs/{jobName}";
