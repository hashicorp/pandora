...
internal class SqlContainerGetPropertiesResourceModel
{
    ...
    public List<ComputedPropertyModel>? ComputedProperties { get; set; }
    ...
    public RestoreParametersBaseModel? RestoreParameters { get; set; }
