...
internal class SqlResourcesCreateUpdateSqlContainerOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(SqlContainerCreateUpdateParametersModel);
