...
internal class TableResourcesCreateUpdateTableOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(TableCreateUpdateParametersModel);
