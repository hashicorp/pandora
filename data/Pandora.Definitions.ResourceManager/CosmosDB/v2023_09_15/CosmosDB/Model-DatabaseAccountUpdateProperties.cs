...
internal class DatabaseAccountUpdatePropertiesModel
{
    ...
    public CustomerManagedKeyStatusConstant? CustomerManagedKeyStatus { get; set; }
    ...
    public DatabaseAccountKeysMetadataModel? KeysMetadata { get; set; }

    [JsonPropertyName("locations")]
    public List<LocationModel>? Locations { get; set; }

    [JsonPropertyName("minimalTlsVersion")]
    public MinimalTlsVersionConstant? MinimalTlsVersion { get; set; }
