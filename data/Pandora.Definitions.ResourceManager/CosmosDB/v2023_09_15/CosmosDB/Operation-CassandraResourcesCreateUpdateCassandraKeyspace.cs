...
internal class CassandraResourcesCreateUpdateCassandraKeyspaceOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(CassandraKeyspaceCreateUpdateParametersModel);
