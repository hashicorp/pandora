...
internal class GremlinResourcesCreateUpdateGremlinDatabaseOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(GremlinDatabaseCreateUpdateParametersModel);
