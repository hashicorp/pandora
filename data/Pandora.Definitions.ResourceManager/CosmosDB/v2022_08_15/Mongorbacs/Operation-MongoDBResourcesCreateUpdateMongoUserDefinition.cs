...
internal class MongoDBResourcesCreateUpdateMongoUserDefinitionOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(MongoUserDefinitionCreateUpdateParametersModel);
