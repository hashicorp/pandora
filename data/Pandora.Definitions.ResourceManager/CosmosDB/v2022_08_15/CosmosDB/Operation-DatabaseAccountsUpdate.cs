...
internal class DatabaseAccountsUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(DatabaseAccountUpdateParametersModel);
