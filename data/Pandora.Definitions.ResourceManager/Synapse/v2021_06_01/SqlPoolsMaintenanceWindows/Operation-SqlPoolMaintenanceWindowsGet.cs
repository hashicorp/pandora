...
internal class SqlPoolMaintenanceWindowsGetOperation : Operations.GetOperation
{
    public override ResourceID? ResourceId() => new SqlPoolId();

    public override Type? ResponseObject() => typeof(MaintenanceWindowsModel);

    public override Type? OptionsObject() => typeof(SqlPoolMaintenanceWindowsGetOperation.SqlPoolMaintenanceWindowsGetOptions);

    public override string? UriSuffix() => "/maintenancewindows/current";

    internal class SqlPoolMaintenanceWindowsGetOptions
    {
