...
namespace Pandora.Definitions.ResourceManager.Synapse.v2021_06_01.Keys;

internal class KeyId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/keys/{keyName}";
