...
internal class SqlPoolSecurityAlertPoliciesListOperation : Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new SqlPoolId();

    public override Type NestedItemType() => typeof(SqlPoolSecurityAlertPolicyModel);
