...
internal class RuleId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/dataMaskingPolicies/default/rules/{dataMaskingRuleName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticDataMaskingPolicies", "dataMaskingPolicies"),
        ResourceIDSegment.Static("dataMaskingPolicyName", "default"),
        ResourceIDSegment.Static("staticRules", "rules"),
        ResourceIDSegment.UserSpecified("dataMaskingRuleName"),
    };
}
