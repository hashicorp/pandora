...
internal class SqlPoolSchemasListOperation : Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(SqlPoolSchemasListOperation.SqlPoolSchemasListOptions);

    public override string? UriSuffix() => "/schemas";

    internal class SqlPoolSchemasListOptions
    {
