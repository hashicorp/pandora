...
internal class PoolPropertiesModel
{
    ...
    [JsonPropertyName("currentNodeCommunicationMode")]
    public NodeCommunicationModeConstant? CurrentNodeCommunicationMode { get; set; }
    ...
    [JsonPropertyName("targetNodeCommunicationMode")]
    public NodeCommunicationModeConstant? TargetNodeCommunicationMode { get; set; }
