...
internal class VideoAnalyzersUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(VideoAnalyzerUpdateModel);
