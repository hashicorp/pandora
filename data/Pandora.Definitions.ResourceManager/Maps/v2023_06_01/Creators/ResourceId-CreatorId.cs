...
namespace Pandora.Definitions.ResourceManager.Maps.v2023_06_01.Creators;
...
internal class CreatorId : ResourceID
{
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.ResourceProvider("staticMicrosoftMaps", "Microsoft.Maps"),
        ResourceIDSegment.Static("staticAccounts", "accounts"),
        ResourceIDSegment.UserSpecified("accountName"),
        ResourceIDSegment.Static("staticCreators", "creators"),
        ResourceIDSegment.UserSpecified("creatorName"),
    };
}
