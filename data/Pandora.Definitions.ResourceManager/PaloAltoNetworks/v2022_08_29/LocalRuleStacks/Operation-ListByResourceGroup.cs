...
internal class ListByResourceGroupOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(LocalRulestackResourceModel);

    public override string? UriSuffix() => "/providers/PaloAltoNetworks.CloudNGFW/localRuleStacks";
