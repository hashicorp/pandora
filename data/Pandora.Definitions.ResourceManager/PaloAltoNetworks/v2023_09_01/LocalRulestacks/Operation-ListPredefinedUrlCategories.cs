...
internal class ListPredefinedUrlCategoriesOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(PredefinedUrlCategoryModel);
