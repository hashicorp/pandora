...
internal class PropertyConditionPropertiesModel : AutomationRuleConditionModel
{
    [JsonPropertyName("conditionProperties")]
    public AutomationRulePropertyValuesConditionModel? ConditionProperties { get; set; }
}
