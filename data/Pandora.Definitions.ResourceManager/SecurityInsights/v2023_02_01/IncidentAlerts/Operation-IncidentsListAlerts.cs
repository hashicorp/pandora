...
internal class IncidentsListAlertsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? ResponseObject() => typeof(IncidentAlertListModel);
