...
{
    public string Name => "ContentProductTemplates";
    public IEnumerable<Interfaces.ApiOperation> Operations => new List<Interfaces.ApiOperation>
    {
        new ProductTemplateGetOperation(),
        new ProductTemplatesListOperation(),
    };
    ...
    public IEnumerable<System.Type> Models => new List<System.Type>
    {
        ...
        typeof(ProductTemplateModelModel),
        typeof(ProductTemplatePropertiesModel),
    };
}
