...
{
    public string Name => "ContentTemplates";
    public IEnumerable<Interfaces.ApiOperation> Operations => new List<Interfaces.ApiOperation>
    {
        new ContentTemplateDeleteOperation(),
        new ContentTemplateGetOperation(),
        new ContentTemplateInstallOperation(),
        new ListOperation(),
    };
    ...
    public IEnumerable<System.Type> Models => new List<System.Type>
    {
        ...
        typeof(TemplateModelModel),
        typeof(TemplatePropertiesModel),
    };
}
