...
{
    public string Name => "ContentProductPackages";
    public IEnumerable<Interfaces.ApiOperation> Operations => new List<Interfaces.ApiOperation>
    {
        new ProductPackageGetOperation(),
        new ProductPackagesListOperation(),
    };
    ...
    public IEnumerable<System.Type> Models => new List<System.Type>
    {
        ...
        typeof(ProductPackageModelModel),
        typeof(ProductPackagePropertiesModel),
    };
}
