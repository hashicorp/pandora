...
internal class ProductPackagePropertiesModel
{
    ...
    [JsonPropertyName("metadataResourceId")]
    public string? MetadataResourceId { get; set; }

    [JsonPropertyName("packagedContent")]
    public object? PackagedContent { get; set; }
