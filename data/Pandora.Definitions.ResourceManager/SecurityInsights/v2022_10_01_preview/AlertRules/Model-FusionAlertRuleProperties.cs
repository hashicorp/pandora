...
internal class FusionAlertRulePropertiesModel
{
    ...
    [JsonPropertyName("scenarioExclusionPatterns")]
    public List<FusionScenarioExclusionPatternModel>? ScenarioExclusionPatterns { get; set; }

    [JsonPropertyName("severity")]
    public AlertSeverityConstant? Severity { get; set; }

    [JsonPropertyName("sourceSettings")]
    public List<FusionSourceSettingsModel>? SourceSettings { get; set; }
