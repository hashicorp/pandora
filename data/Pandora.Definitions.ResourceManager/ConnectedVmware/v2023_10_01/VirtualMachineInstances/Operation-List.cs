...
internal class ListOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(VirtualMachineInstanceModel);

    public override string? UriSuffix() => "/providers/Microsoft.ConnectedVMwarevSphere/virtualMachineInstances";
