...
internal class ListByPublisherOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(ListByPublisherOperation.ListByPublisherOptions);

    public override string? UriSuffix() => "/offers";

    internal class ListByPublisherOptions
    {
