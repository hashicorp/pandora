...
internal class ConsentAndInstallDefaultExtensionsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/consentAndInstallDefaultExtensions";
