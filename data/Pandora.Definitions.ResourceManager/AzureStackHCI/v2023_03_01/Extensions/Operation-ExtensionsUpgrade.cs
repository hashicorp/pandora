...
internal class ExtensionsUpgradeOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ExtensionUpgradeParametersModel);
