...
internal class GetAzureReachabilityReportOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AzureReachabilityReportParametersModel);
