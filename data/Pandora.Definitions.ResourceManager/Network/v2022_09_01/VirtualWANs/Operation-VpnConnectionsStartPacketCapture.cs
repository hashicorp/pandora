...
internal class VpnConnectionsStartPacketCaptureOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(VpnConnectionPacketCaptureStartParametersModel);
