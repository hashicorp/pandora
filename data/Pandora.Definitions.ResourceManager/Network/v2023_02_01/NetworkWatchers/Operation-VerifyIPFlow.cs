...
internal class VerifyIPFlowOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(VerificationIPFlowParametersModel);
