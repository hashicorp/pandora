...
internal class NatRulesListByVpnGatewayOperation : Pandora.Definitions.Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new VpnGatewayId();

    public override Type NestedItemType() => typeof(VpnGatewayNatRuleModel);
