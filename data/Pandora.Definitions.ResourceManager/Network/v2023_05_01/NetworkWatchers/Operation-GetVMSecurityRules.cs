...
internal class GetVMSecurityRulesOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(SecurityGroupViewParametersModel);
