...
internal class GetNetworkConfigurationDiagnosticOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(NetworkConfigurationDiagnosticParametersModel);
