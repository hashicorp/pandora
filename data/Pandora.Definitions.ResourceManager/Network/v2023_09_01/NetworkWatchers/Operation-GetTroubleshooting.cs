...
internal class GetTroubleshootingOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(TroubleshootingParametersModel);
