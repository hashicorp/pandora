...
internal class ListAvailableProvidersOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AvailableProvidersListParametersModel);
