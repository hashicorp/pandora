...
internal class PacketCaptureResultPropertiesModel
{
    ...
    public PacketCaptureMachineScopeModel? Scope { get; set; }
    ...
    public PacketCaptureTargetTypeConstant? TargetType { get; set; }
