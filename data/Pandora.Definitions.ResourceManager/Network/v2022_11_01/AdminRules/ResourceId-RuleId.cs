...
namespace Pandora.Definitions.ResourceManager.Network.v2022_11_01.AdminRules;

internal class RuleId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityAdminConfigurations/{securityAdminConfigurationName}/ruleCollections/{ruleCollectionName}/rules/{ruleName}";
