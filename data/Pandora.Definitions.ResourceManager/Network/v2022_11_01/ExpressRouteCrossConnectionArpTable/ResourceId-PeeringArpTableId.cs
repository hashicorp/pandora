...
namespace Pandora.Definitions.ResourceManager.Network.v2022_11_01.ExpressRouteCrossConnectionArpTable;

internal class PeeringArpTableId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{expressRouteCrossConnectionName}/peerings/{peeringName}/arpTables/{arpTableName}";
