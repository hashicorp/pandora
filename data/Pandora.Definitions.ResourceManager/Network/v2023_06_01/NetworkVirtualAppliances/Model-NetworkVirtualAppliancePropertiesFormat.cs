...
namespace Pandora.Definitions.ResourceManager.Network.v2023_06_01.NetworkVirtualAppliances;


internal class NetworkVirtualAppliancePropertiesFormatModel
{
    [JsonPropertyName("additionalNics")]
    public List<VirtualApplianceAdditionalNicPropertiesModel>? AdditionalNics { get; set; }
    ...
    public DelegationPropertiesModel? Delegation { get; set; }
    ...
    [JsonPropertyName("internetIngressPublicIps")]
    public List<InternetIngressPublicIPsPropertiesModel>? InternetIngressPublicIPs { get; set; }

    [JsonPropertyName("nvaSku")]
    public VirtualApplianceSkuPropertiesModel? NvaSku { get; set; }

    [JsonPropertyName("partnerManagedResource")]
    public PartnerManagedResourcePropertiesModel? PartnerManagedResource { get; set; }
