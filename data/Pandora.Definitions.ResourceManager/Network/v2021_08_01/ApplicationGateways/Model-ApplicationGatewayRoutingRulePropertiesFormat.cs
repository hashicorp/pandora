...
internal class ApplicationGatewayRoutingRulePropertiesFormatModel
{
    [JsonPropertyName("backendAddressPool")]
    public SubResourceModel? BackendAddressPool { get; set; }

    [JsonPropertyName("backendSettings")]
    public SubResourceModel? BackendSettings { get; set; }

    [JsonPropertyName("listener")]
    public SubResourceModel? Listener { get; set; }
