...
internal class VirtualHubIPConfigurationListOperation : Pandora.Definitions.Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new VirtualHubId();

    public override Type NestedItemType() => typeof(HubIPConfigurationModel);
