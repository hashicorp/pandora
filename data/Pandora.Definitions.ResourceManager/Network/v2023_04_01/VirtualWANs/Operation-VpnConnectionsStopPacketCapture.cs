...
internal class VpnConnectionsStopPacketCaptureOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(VpnConnectionPacketCaptureStopParametersModel);
