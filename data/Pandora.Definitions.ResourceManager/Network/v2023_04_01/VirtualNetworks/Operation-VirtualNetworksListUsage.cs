...
internal class VirtualNetworksListUsageOperation : Pandora.Definitions.Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new VirtualNetworkId();

    public override Type NestedItemType() => typeof(VirtualNetworkUsageModel);
