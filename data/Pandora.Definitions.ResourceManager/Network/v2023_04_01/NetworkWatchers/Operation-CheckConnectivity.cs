...
internal class CheckConnectivityOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ConnectivityParametersModel);
