...
internal class ResetSharedKeyOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ConnectionResetSharedKeyModel);
