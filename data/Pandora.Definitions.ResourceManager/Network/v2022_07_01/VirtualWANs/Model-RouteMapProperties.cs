...
internal class RouteMapPropertiesModel
{
    [JsonPropertyName("associatedInboundConnections")]
    public List<string>? AssociatedInboundConnections { get; set; }

    [JsonPropertyName("associatedOutboundConnections")]
    ...
    public List<RouteMapRuleModel>? Rules { get; set; }
}
