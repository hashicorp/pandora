...
internal class VirtualHubPropertiesModel
{
    ...
    [JsonPropertyName("routeMaps")]
    public List<SubResourceModel>? RouteMaps { get; set; }
    ...
    [JsonPropertyName("virtualRouterAutoScaleConfiguration")]
    public VirtualRouterAutoScaleConfigurationModel? VirtualRouterAutoScaleConfiguration { get; set; }
