...
namespace Pandora.Definitions.ResourceManager.Network.v2022_07_01.NetworkGroups;

internal class NetworkGroupId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/networkGroups/{networkGroupName}";
