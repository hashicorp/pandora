...
internal class ApplicationGatewaySslProfilePropertiesFormatModel
{
    [JsonPropertyName("clientAuthConfiguration")]
    public ApplicationGatewayClientAuthConfigurationModel? ClientAuthConfiguration { get; set; }
    ...
    public List<SubResourceModel>? TrustedClientCertificates { get; set; }
}
