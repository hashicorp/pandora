...
internal class SwitchProviderOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(SwitchProviderInputModel);
    ...
    public override string? UriSuffix() => "/switchProvider";
