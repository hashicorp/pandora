...
internal class UnplannedFailoverOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(RecoveryPlanUnplannedFailoverInputModel);
