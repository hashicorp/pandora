...
internal class TestMigrateOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(TestMigrateInputModel);
    ...
    public override string? UriSuffix() => "/testMigrate";
