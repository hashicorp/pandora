...
internal class TestFailoverCleanupOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(RecoveryPlanTestFailoverCleanupInputModel);
