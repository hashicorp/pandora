...
{
    [JsonPropertyName("applianceMonitoringDetails")]
    public ApplianceMonitoringDetailsModel? ApplianceMonitoringDetails { get; set; }

    [JsonPropertyName("confidentialVmKeyVaultId")]
    ...
    [JsonPropertyName("deltaSyncProgressPercentage")]
    public int? DeltaSyncProgressPercentage { get; set; }

    [JsonPropertyName("deltaSyncRetryCount")]
    public int? DeltaSyncRetryCount { get; set; }

    [JsonPropertyName("firmwareType")]
    public string? FirmwareType { get; set; }

    [JsonPropertyName("gatewayOperationDetails")]
    public GatewayOperationDetailsModel? GatewayOperationDetails { get; set; }
    ...
    [JsonPropertyName("isCheckSumResyncCycle")]
    public string? IsCheckSumResyncCycle { get; set; }
    ...
    [JsonPropertyName("targetVmSecurityProfile")]
    public VMwareCbtSecurityProfilePropertiesModel? TargetVMSecurityProfile { get; set; }
