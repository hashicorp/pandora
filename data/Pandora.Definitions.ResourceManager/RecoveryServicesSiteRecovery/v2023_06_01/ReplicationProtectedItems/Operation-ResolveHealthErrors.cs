...
internal class ResolveHealthErrorsOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ResolveHealthInputModel);
