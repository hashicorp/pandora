...
internal class UpdateProtectionContainerMappingInputPropertiesModel
{
    [JsonPropertyName("providerSpecificInput")]
    public ReplicationProviderSpecificUpdateContainerMappingInputModel? ProviderSpecificInput { get; set; }
}
