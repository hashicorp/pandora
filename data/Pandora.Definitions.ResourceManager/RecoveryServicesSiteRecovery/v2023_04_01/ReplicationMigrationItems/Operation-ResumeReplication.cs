...
internal class ResumeReplicationOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ResumeReplicationInputModel);
