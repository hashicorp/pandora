...
internal class ResyncOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ResyncInputModel);
    ...
    public override string? UriSuffix() => "/resync";
