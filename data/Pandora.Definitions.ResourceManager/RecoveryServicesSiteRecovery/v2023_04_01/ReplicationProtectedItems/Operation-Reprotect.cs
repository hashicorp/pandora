...
internal class ReprotectOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ReverseReplicationInputModel);
    ...
    public override string? UriSuffix() => "/reProtect";
