...
internal class InMageProtectedDiskDetailsModel
{
    ...
    [JsonPropertyName("psDataInMB")]
    public float? PsDataInMB { get; set; }
    ...
    [JsonPropertyName("sourceDataInMB")]
    public float? SourceDataInMB { get; set; }

    [JsonPropertyName("targetDataInMB")]
    public float? TargetDataInMB { get; set; }
}
