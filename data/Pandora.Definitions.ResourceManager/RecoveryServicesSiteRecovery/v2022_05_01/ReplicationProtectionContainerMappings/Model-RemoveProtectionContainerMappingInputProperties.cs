...
internal class RemoveProtectionContainerMappingInputPropertiesModel
{
    [JsonPropertyName("providerSpecificInput")]
    public ReplicationProviderContainerUnmappingInputModel? ProviderSpecificInput { get; set; }
}
