...
namespace Pandora.Definitions.ResourceManager.RecoveryServicesSiteRecovery.v2022_05_01.TargetComputeSizes;

internal class ReplicationProtectedItemId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/replicationFabrics/{replicationFabricName}/replicationProtectionContainers/{replicationProtectionContainerName}/replicationProtectedItems/{replicationProtectedItemName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.UserSpecified("replicationProtectedItemName"),
    };
}
