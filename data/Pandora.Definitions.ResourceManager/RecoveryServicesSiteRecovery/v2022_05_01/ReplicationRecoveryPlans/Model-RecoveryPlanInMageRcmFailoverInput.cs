...
internal class RecoveryPlanInMageRcmFailoverInputModel : RecoveryPlanProviderSpecificFailoverInputModel
{
    [JsonPropertyName("recoveryPointType")]
    [Required]
    public RecoveryPlanPointTypeConstant RecoveryPointType { get; set; }
