...
internal class ContainerRegistriesValidateOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ContainerRegistryPropertiesModel);
