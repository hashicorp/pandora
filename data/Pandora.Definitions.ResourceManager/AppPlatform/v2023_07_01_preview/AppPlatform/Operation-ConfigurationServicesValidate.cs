...
internal class ConfigurationServicesValidateOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ConfigurationServiceSettingsModel);
