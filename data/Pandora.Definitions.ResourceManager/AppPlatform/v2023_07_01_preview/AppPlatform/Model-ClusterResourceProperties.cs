...
internal class ClusterResourcePropertiesModel
{
    ...
    [JsonPropertyName("infraResourceGroup")]
    public string? InfraResourceGroup { get; set; }

    [JsonPropertyName("maintenanceScheduleConfiguration")]
    public MaintenanceScheduleConfigurationModel? MaintenanceScheduleConfiguration { get; set; }
