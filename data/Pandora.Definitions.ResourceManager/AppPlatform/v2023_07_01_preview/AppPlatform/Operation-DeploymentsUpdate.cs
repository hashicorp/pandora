...
internal class DeploymentsUpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(DeploymentResourceModel);
