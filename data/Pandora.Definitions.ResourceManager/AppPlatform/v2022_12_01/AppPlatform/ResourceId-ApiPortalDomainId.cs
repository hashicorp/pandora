...
internal class ApiPortalDomainId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/spring/{serviceName}/apiPortals/{apiPortalName}/domains/{domainName}";
    ...
    public List<ResourceIDSegment> Segments => new List<ResourceIDSegment>
    {
        ...
        ResourceIDSegment.Static("staticApiPortals", "apiPortals"),
        ResourceIDSegment.UserSpecified("apiPortalName"),
