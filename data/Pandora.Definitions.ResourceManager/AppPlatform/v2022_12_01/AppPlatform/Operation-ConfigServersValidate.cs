...
internal class ConfigServersValidateOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? ResponseObject() => typeof(ConfigServerSettingsValidateResultModel);
