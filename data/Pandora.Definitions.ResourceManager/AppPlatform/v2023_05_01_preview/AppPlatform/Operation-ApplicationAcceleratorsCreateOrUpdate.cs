...
internal class ApplicationAcceleratorsCreateOrUpdateOperation : Pandora.Definitions.Operations.PutOperation
{
    public override bool LongRunning() => true;

    public override Type? RequestObject() => typeof(ApplicationAcceleratorResourceModel);
