...
namespace Pandora.Definitions.ResourceManager.KubernetesConfiguration.v2022_03_01.ExtensionOperationStatus;

internal class OperationScopedId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/{scope}/providers/Microsoft.KubernetesConfiguration/extensions/{extensionName}/operations/{operationId}";
