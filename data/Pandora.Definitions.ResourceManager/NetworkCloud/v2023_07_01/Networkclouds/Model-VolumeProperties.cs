...
internal class VolumePropertiesModel
{
    ...
    public List<string>? AttachedTo { get; set; }

    [JsonPropertyName("detailedStatus")]
    public VolumeDetailedStatusConstant? DetailedStatus { get; set; }

    [JsonPropertyName("detailedStatusMessage")]
    public string? DetailedStatusMessage { get; set; }

    [JsonPropertyName("provisioningState")]
    public VolumeProvisioningStateConstant? ProvisioningState { get; set; }

    [JsonPropertyName("serialNumber")]
    public string? SerialNumber { get; set; }

    [JsonPropertyName("sizeMiB")]
    [Required]
