...
internal class BmcKeySetPropertiesModel
{
    ...
    public BmcKeySetDetailedStatusConstant? DetailedStatus { get; set; }
    ...
    [Required]
    public BmcKeySetPrivilegeLevelConstant PrivilegeLevel { get; set; }

    [JsonPropertyName("provisioningState")]
    public BmcKeySetProvisioningStateConstant? ProvisioningState { get; set; }
