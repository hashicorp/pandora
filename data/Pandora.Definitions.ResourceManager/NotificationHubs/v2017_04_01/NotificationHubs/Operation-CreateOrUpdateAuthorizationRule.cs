...
internal class CreateOrUpdateAuthorizationRuleOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(SharedAccessAuthorizationRuleCreateOrUpdateParametersModel);
