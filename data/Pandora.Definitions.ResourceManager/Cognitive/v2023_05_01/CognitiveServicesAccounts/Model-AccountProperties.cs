...
internal class AccountPropertiesModel
{
    ...
    public AbusePenaltyModel? AbusePenalty { get; set; }
    ...
    public List<CommitmentPlanAssociationModel>? CommitmentPlanAssociations { get; set; }
    ...
    public MultiRegionSettingsModel? Locations { get; set; }
