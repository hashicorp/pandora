...
internal class CommitmentPlansUpdatePlanOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(PatchResourceTagsAndSkuModel);
