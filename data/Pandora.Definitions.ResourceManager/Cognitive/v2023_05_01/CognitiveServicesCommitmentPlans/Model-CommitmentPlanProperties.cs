...
internal class CommitmentPlanPropertiesModel
{
    ...
    [JsonPropertyName("commitmentPlanGuid")]
    ...
    public List<string>? ProvisioningIssues { get; set; }

    [JsonPropertyName("provisioningState")]
    public CommitmentPlanProvisioningStateConstant? ProvisioningState { get; set; }
}
