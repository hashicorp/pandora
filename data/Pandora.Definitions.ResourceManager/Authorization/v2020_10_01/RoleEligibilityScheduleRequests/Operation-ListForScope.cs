...
internal class ListForScopeOperation : Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(RoleEligibilityScheduleRequestModel);

    public override Type? OptionsObject() => typeof(ListForScopeOperation.ListForScopeOptions);

    public override string? UriSuffix() => "/providers/Microsoft.Authorization/roleEligibilityScheduleRequests";
