...
internal class ListForScopeOperation : Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(RoleAssignmentScheduleRequestModel);

    public override Type? OptionsObject() => typeof(ListForScopeOperation.ListForScopeOptions);

    public override string? UriSuffix() => "/providers/Microsoft.Authorization/roleAssignmentScheduleRequests";
