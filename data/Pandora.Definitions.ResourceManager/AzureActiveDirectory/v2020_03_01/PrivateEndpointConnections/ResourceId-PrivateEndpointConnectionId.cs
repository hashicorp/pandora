...
internal class PrivateEndpointConnectionId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AADIAM/privateLinkForAzureAd/{privateLinkForAzureAdName}/privateEndpointConnections/{privateEndpointConnectionName}";
