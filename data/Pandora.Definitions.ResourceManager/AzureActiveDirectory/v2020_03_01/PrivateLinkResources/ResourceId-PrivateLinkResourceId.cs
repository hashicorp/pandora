...
internal class PrivateLinkResourceId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AADIAM/privateLinkForAzureAd/{privateLinkForAzureAdName}/privateLinkResources/{privateLinkResourceName}";
