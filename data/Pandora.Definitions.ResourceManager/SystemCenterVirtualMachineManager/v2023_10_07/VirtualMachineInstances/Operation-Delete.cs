...
internal class DeleteOperation : Pandora.Definitions.Operations.DeleteOperation
{
    ...
    public override string? UriSuffix() => "/providers/Microsoft.ScVmm/virtualMachineInstances/default";

    internal class DeleteOptions
    {
        [QueryStringName("deleteFromHost")]
        [Optional]
        public DeleteFromHostConstant DeleteFromHost { get; set; }

        [QueryStringName("force")]
        [Optional]
        public ForceConstant Force { get; set; }
    }
}
