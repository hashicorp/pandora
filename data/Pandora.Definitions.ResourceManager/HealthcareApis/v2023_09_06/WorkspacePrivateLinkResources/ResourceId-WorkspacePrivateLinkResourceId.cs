...
namespace Pandora.Definitions.ResourceManager.HealthcareApis.v2023_09_06.WorkspacePrivateLinkResources;

internal class WorkspacePrivateLinkResourceId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/workspaces/{workspaceName}/privateLinkResources/{privateLinkResourceName}";
