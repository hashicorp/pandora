...
internal class ListByResourceGroupOperation : Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(ApplicationDefinitionModel);

    public override string? UriSuffix() => "/providers/Microsoft.Solutions/applicationDefinitions";
