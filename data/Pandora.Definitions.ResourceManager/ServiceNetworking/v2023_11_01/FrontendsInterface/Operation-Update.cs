...
internal class UpdateOperation : Pandora.Definitions.Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(FrontendUpdateModel);

    public override ResourceID? ResourceId() => new FrontendId();

    public override Type? ResponseObject() => typeof(FrontendModel);
