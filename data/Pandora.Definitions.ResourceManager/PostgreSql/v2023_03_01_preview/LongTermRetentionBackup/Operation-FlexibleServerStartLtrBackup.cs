...
internal class FlexibleServerStartLtrBackupOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(LtrBackupRequestModel);
