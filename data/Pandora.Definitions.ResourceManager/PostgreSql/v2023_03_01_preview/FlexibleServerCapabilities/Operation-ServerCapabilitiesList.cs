...
internal class ServerCapabilitiesListOperation : Pandora.Definitions.Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";

    public override ResourceID? ResourceId() => new FlexibleServerId();

    public override Type NestedItemType() => typeof(FlexibleServerCapabilityModel);
