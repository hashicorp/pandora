...
namespace Pandora.Definitions.ResourceManager.PostgreSql.v2023_06_01_preview.PrivateLinkResources;

internal class PrivateLinkResourceId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{flexibleServerName}/privateLinkResources/{privateLinkResourceName}";
