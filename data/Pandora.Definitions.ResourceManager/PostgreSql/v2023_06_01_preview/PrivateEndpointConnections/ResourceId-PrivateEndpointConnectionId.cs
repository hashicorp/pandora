...
internal class PrivateEndpointConnectionId : ResourceID
{
    ...
    public string ID => "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{flexibleServerName}/privateEndpointConnections/{privateEndpointConnectionName}";
