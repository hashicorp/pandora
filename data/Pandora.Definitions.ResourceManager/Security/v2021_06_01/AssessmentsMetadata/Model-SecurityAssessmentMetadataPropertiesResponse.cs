...
internal class SecurityAssessmentMetadataPropertiesResponseModel
{
    ...
    [JsonPropertyName("plannedDeprecationDate")]
    ...
    [JsonPropertyName("publishDates")]
    public SecurityAssessmentMetadataPropertiesResponsePublishDatesModel? PublishDates { get; set; }
    ...
    public List<TacticsConstant>? Tactics { get; set; }

    [JsonPropertyName("techniques")]
    public List<TechniquesConstant>? Techniques { get; set; }
