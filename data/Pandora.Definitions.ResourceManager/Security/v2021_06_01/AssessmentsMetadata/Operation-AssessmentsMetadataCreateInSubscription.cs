...
internal class AssessmentsMetadataCreateInSubscriptionOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(SecurityAssessmentMetadataResponseModel);
