...
internal class StandardsGetOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new RegulatoryComplianceStandardId();

    public override Type? ResponseObject() => typeof(RegulatoryComplianceStandardModel);
