...
internal class ControlsGetOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new RegulatoryComplianceControlId();

    public override Type? ResponseObject() => typeof(RegulatoryComplianceControlModel);
