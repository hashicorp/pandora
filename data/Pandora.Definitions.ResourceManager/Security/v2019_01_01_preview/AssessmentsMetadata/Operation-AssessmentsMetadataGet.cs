...
internal class AssessmentsMetadataGetOperation : Pandora.Definitions.Operations.GetOperation
{
    public override ResourceID? ResourceId() => new AssessmentMetadataId();
