...
internal class AggregatedAlertsListOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(AggregatedAlertsListOperation.AggregatedAlertsListOptions);

    public override string? UriSuffix() => "/analyticsModels/default/aggregatedAlerts";

    internal class AggregatedAlertsListOptions
    {
        [QueryStringName("$top")]
        [Optional]
