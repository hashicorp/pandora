...
internal class ListOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type NestedItemType() => typeof(InformationProtectionPolicyModel);

    public override string? UriSuffix() => "/providers/Microsoft.Security/informationProtectionPolicies";
