...
internal class Definition : ResourceDefinition
{
    ...
    {
        new SecurityContactsCreateOperation(),
        new SecurityContactsDeleteOperation(),
        new SecurityContactsGetOperation(),
        new SecurityContactsListOperation(),
        new SecurityContactsUpdateOperation(),
    };
