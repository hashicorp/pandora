...
internal class SecureScoreControlsListBySecureScoreOperation : Pandora.Definitions.Operations.ListOperation
{
    ...
    public override Type? OptionsObject() => typeof(SecureScoreControlsListBySecureScoreOperation.SecureScoreControlsListBySecureScoreOptions);

    public override string? UriSuffix() => "/secureScoreControls";

    internal class SecureScoreControlsListBySecureScoreOptions
    {
