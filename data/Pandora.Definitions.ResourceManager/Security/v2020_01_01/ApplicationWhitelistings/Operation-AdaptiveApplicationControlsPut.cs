...
internal class AdaptiveApplicationControlsPutOperation : Pandora.Definitions.Operations.PutOperation
{
    ...
    public override Type? RequestObject() => typeof(AdaptiveApplicationControlGroupModel);
