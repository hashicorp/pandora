...
{
    public string Name => "AggregatedAlert";
    public IEnumerable<Interfaces.ApiOperation> Operations => new List<Interfaces.ApiOperation>
    {
        ...
        new IotSecuritySolutionsAnalyticsAggregatedAlertListOperation(),
    };
    ...
    public IEnumerable<System.Type> Models => new List<System.Type>
    {
        ...
        typeof(IoTSecurityAggregatedAlertPropertiesTopDevicesListInlinedModel),
    };
}
