...
internal class IotRecommendationPropertiesModel
{
    [JsonPropertyName("deviceId")]
    public string? DeviceId { get; set; }

    [JsonPropertyName("discoveredTimeUtc")]
    public string? DiscoveredTimeUtc { get; set; }

    [JsonPropertyName("recommendationAdditionalData")]
