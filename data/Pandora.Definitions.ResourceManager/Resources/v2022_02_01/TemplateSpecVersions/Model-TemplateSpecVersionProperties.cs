...
internal class TemplateSpecVersionPropertiesModel
{
    [JsonPropertyName("description")]
    public string? Description { get; set; }

    [JsonPropertyName("linkedTemplates")]
    public List<LinkedTemplateArtifactModel>? LinkedTemplates { get; set; }
    ...
    [JsonPropertyName("uiFormDefinition")]
