...
internal class CreateOrUpdateAtResourceLevelOperation : Pandora.Definitions.Operations.PutOperation
{
    public override Type? RequestObject() => typeof(ManagementLockObjectModel);

    public override ResourceID? ResourceId() => new ResourceLockId();
