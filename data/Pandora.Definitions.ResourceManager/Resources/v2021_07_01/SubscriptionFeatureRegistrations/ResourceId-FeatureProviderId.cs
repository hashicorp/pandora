...
internal class FeatureProviderId : ResourceID
{
    public string? CommonAlias => null;

    public string ID => "/subscriptions/{subscriptionId}/providers/Microsoft.Features/featureProviders/{featureProviderName}";
