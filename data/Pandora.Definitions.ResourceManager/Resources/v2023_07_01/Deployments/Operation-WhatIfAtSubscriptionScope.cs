...
internal class WhatIfAtSubscriptionScopeOperation : Pandora.Definitions.Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(DeploymentWhatIfModel);
