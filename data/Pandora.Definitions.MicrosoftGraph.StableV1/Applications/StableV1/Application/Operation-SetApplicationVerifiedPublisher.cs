...
internal class SetApplicationVerifiedPublisherOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(SetApplicationVerifiedPublisherRequestModel);
