...
internal class CheckApplicationByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckApplicationByIdMemberObjectRequestModel);
