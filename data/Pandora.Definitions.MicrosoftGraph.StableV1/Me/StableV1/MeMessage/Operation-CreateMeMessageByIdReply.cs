...
internal class CreateMeMessageByIdReplyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMessageByIdReplyRequestModel);
