...
internal class CreateMeMessageByIdReplyAllOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMessageByIdReplyAllRequestModel);
