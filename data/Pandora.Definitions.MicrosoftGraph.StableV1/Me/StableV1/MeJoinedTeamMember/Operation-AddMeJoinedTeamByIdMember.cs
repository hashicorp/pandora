...
internal class AddMeJoinedTeamByIdMemberOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AddMeJoinedTeamByIdMemberRequestModel);
