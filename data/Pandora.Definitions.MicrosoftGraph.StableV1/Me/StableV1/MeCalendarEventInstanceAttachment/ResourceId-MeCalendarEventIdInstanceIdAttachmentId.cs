...
internal class MeCalendarEventIdInstanceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendar/events/{eventId}/instances/{eventId1}/attachments/{attachmentId}";
