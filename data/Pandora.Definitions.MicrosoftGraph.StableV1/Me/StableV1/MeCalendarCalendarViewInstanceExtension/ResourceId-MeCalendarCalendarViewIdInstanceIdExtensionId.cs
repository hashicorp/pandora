...
internal class MeCalendarCalendarViewIdInstanceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendar/calendarView/{eventId}/instances/{eventId1}/extensions/{extensionId}";
