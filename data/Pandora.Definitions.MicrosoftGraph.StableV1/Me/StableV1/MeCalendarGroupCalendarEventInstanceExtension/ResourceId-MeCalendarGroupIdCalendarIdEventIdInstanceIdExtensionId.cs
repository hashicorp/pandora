...
internal class MeCalendarGroupIdCalendarIdEventIdInstanceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendarGroups/{calendarGroupId}/calendars/{calendarId}/events/{eventId}/instances/{eventId1}/extensions/{extensionId}";
