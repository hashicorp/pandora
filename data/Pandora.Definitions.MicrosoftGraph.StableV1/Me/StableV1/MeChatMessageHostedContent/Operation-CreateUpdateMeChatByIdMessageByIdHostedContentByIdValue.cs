...
internal class CreateUpdateMeChatByIdMessageByIdHostedContentByIdValueOperation : Operations.PutOperation
{
    ...
    public override ResourceID? ResourceId() => new MeChatIdMessageIdHostedContentId();
