...
internal class CreateUpdateMeTodoListByIdTaskByIdAttachmentByIdValueOperation : Operations.PutOperation
{
    ...
    public override ResourceID? ResourceId() => new MeTodoListIdTaskIdAttachmentId();
