...
internal class CreateMeTodoListByIdTaskByIdAttachmentCreateUploadSessionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeTodoListByIdTaskByIdAttachmentCreateUploadSessionRequestModel);
