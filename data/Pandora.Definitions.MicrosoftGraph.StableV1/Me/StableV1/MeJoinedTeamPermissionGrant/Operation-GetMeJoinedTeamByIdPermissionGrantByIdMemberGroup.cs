...
internal class GetMeJoinedTeamByIdPermissionGrantByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetMeJoinedTeamByIdPermissionGrantByIdMemberGroupRequestModel);
