...
internal class MeCalendarCalendarViewIdInstanceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendar/calendarView/{eventId}/instances/{eventId1}/attachments/{attachmentId}";
