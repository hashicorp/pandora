...
internal class CreateMeMailFolderByIdMessageByIdMoveOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMailFolderByIdMessageByIdMoveRequestModel);
