...
internal class CreateMeMailFolderByIdMessageByIdReplyAllOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMailFolderByIdMessageByIdReplyAllRequestModel);
