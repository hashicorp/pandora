...
internal class CreateMeCalendarByIdCalendarViewByIdAcceptOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeCalendarByIdCalendarViewByIdAcceptRequestModel);
