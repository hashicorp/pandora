...
internal class AddMeJoinedTeamByIdChannelByIdMemberOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AddMeJoinedTeamByIdChannelByIdMemberRequestModel);
