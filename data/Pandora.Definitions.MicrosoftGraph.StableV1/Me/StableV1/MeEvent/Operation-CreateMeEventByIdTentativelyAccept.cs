...
internal class CreateMeEventByIdTentativelyAcceptOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeEventByIdTentativelyAcceptRequestModel);
