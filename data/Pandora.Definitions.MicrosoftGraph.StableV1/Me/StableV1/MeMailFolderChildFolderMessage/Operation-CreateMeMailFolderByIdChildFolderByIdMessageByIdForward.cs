...
internal class CreateMeMailFolderByIdChildFolderByIdMessageByIdForwardOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMailFolderByIdChildFolderByIdMessageByIdForwardRequestModel);
