...
internal class MeJoinedTeamIdPrimaryChannelSharedWithTeamId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/joinedTeams/{teamId}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfoId}";
