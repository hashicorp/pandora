...
internal class SetMeChatByIdMessageByIdReactionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(SetMeChatByIdMessageByIdReactionRequestModel);
