...
internal class UnsetMeChatByIdMessageByIdReactionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(UnsetMeChatByIdMessageByIdReactionRequestModel);
