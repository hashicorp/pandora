...
internal class CreateMeOnenoteSectionByIdCopyToNotebookOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeOnenoteSectionByIdCopyToNotebookRequestModel);
