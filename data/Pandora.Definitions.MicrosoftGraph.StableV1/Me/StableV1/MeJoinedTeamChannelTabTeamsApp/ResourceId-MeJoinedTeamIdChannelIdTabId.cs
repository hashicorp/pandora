...
namespace Pandora.Definitions.MicrosoftGraph.StableV1.Me.StableV1.MeJoinedTeamChannelTabTeamsApp;

internal class MeJoinedTeamIdChannelIdTabId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/joinedTeams/{teamId}/channels/{channelId}/tabs/{teamsTabId}";
