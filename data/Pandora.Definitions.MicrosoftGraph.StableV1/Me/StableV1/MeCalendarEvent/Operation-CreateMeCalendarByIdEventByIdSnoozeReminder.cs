...
internal class CreateMeCalendarByIdEventByIdSnoozeReminderOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeCalendarByIdEventByIdSnoozeReminderRequestModel);
