...
internal class GetMeAuthenticationPasswordMethodByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new MeAuthenticationPasswordMethodId();
