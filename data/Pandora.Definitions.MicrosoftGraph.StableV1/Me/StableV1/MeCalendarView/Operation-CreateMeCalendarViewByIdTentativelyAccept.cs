...
internal class CreateMeCalendarViewByIdTentativelyAcceptOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeCalendarViewByIdTentativelyAcceptRequestModel);
