...
internal class ValidateMeChatByIdPermissionGrantsPropertyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ValidateMeChatByIdPermissionGrantsPropertyRequestModel);
