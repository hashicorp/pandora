...
internal class MeCalendarGroupIdCalendarIdCalendarViewIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendarGroups/{calendarGroupId}/calendars/{calendarId}/calendarView/{eventId}/extensions/{extensionId}";
