...
internal class GetUserByIdJoinedTeamByIdScheduleTimeOffReasonCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/schedule/timeOffReasons/$count";
}
