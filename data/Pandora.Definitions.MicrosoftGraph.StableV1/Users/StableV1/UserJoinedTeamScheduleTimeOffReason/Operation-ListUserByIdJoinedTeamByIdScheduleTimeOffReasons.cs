...
internal class ListUserByIdJoinedTeamByIdScheduleTimeOffReasonsOperation : Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";
    public override ResourceID? ResourceId() => new UserIdJoinedTeamId();
    public override Type NestedItemType() => typeof(TimeOffReasonCollectionResponseModel);
