...
internal class GetUserByIdJoinedTeamByIdScheduleTimesOffCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/schedule/timesOff/$count";
}
