...
internal class GetUserByIdJoinedTeamByIdPermissionGrantsByIdsOperation : Operations.ListOperation
{
    ...
    public override string? UriSuffix() => "/permissionGrants/getByIds";
}
