...
internal class ValidateUserByIdJoinedTeamByIdPermissionGrantsPropertyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ValidateUserByIdJoinedTeamByIdPermissionGrantsPropertyRequestModel);
