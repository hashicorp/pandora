...
internal class CheckUserByIdJoinedTeamByIdPermissionGrantByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckUserByIdJoinedTeamByIdPermissionGrantByIdMemberObjectRequestModel);
