...
internal class GetUserByIdJoinedTeamByIdPermissionGrantByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetUserByIdJoinedTeamByIdPermissionGrantByIdMemberGroupRequestModel);
