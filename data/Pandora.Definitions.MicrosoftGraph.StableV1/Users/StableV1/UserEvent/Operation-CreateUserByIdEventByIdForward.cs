...
internal class CreateUserByIdEventByIdForwardOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdEventByIdForwardRequestModel);
