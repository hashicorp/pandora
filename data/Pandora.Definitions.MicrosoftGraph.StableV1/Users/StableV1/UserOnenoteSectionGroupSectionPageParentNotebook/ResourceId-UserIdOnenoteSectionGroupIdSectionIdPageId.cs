...
namespace Pandora.Definitions.MicrosoftGraph.StableV1.Users.StableV1.UserOnenoteSectionGroupSectionPageParentNotebook;

internal class UserIdOnenoteSectionGroupIdSectionIdPageId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/onenote/sectionGroups/{sectionGroupId}/sections/{onenoteSectionId}/pages/{onenotePageId}";
