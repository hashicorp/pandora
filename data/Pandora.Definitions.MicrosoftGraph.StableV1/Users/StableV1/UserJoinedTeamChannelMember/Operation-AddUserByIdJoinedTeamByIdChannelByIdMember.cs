...
internal class AddUserByIdJoinedTeamByIdChannelByIdMemberOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AddUserByIdJoinedTeamByIdChannelByIdMemberRequestModel);
