...
internal class GetUserByIdJoinedTeamByIdPrimaryChannelMessageCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/primaryChannel/messages/$count";
}
