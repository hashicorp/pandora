...
internal class GetUserByIdJoinedTeamByIdPrimaryChannelSharedWithTeamCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/primaryChannel/sharedWithTeams/$count";
}
