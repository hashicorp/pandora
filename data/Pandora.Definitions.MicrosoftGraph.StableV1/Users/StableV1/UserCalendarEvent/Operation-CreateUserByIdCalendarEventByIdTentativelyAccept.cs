...
internal class CreateUserByIdCalendarEventByIdTentativelyAcceptOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdCalendarEventByIdTentativelyAcceptRequestModel);
