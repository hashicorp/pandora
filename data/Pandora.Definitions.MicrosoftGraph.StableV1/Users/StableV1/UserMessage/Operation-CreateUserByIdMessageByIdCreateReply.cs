...
internal class CreateUserByIdMessageByIdCreateReplyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMessageByIdCreateReplyRequestModel);
