...
internal class CreateUserByIdMessageByIdForwardOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMessageByIdForwardRequestModel);
