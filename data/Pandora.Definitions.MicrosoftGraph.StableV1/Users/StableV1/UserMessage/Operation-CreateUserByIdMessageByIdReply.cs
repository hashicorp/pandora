...
internal class CreateUserByIdMessageByIdReplyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMessageByIdReplyRequestModel);
