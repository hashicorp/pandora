...
internal class UserIdOnenoteNotebookIdSectionGroupIdSectionGroupId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/onenote/notebooks/{notebookId}/sectionGroups/{sectionGroupId}/sectionGroups/{sectionGroupId1}";
