...
internal class GetUserByIdJoinedTeamByIdScheduleOfferShiftRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/schedule/offerShiftRequests/$count";
}
