...
internal class UserIdJoinedTeamIdScheduleOfferShiftRequestId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/joinedTeams/{teamId}/schedule/offerShiftRequests/{offerShiftRequestId}";
