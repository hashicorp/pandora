...
internal class GetUserByIdManagedDeviceByIdLogCollectionRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/logCollectionRequests/$count";
}
