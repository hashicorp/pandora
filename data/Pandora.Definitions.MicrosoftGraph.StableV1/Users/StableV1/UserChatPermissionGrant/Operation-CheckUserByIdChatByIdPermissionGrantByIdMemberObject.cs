...
internal class CheckUserByIdChatByIdPermissionGrantByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckUserByIdChatByIdPermissionGrantByIdMemberObjectRequestModel);
