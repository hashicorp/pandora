...
internal class GetUserByIdChatByIdPermissionGrantByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetUserByIdChatByIdPermissionGrantByIdMemberObjectRequestModel);
