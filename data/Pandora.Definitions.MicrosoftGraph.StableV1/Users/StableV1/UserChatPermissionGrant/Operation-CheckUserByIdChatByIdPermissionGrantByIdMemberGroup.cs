...
internal class CheckUserByIdChatByIdPermissionGrantByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckUserByIdChatByIdPermissionGrantByIdMemberGroupRequestModel);
