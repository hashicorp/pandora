...
internal class GetUserByIdJoinedTeamByIdScheduleOpenShiftCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/schedule/openShifts/$count";
}
