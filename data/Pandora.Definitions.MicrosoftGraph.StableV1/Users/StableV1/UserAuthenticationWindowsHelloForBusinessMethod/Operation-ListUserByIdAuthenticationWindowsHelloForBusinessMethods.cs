...
internal class ListUserByIdAuthenticationWindowsHelloForBusinessMethodsOperation : Operations.ListOperation
{
    ...
    public override string? UriSuffix() => "/authentication/windowsHelloForBusinessMethods";
}
