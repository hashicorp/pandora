...
internal class GetUserByIdOnlineMeetingByIdAttendanceReportByIdAttendanceRecordCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/attendanceRecords/$count";
}
