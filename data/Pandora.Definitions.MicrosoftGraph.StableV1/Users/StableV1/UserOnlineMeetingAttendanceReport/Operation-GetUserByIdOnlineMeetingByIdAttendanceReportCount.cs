...
internal class GetUserByIdOnlineMeetingByIdAttendanceReportCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/attendanceReports/$count";
}
