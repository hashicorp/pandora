...
internal class GetUserByIdManagedDeviceByIdDeviceConfigurationStateCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/deviceConfigurationStates/$count";
}
