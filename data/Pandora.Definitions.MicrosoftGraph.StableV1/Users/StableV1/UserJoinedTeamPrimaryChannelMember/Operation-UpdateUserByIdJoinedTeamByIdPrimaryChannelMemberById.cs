...
internal class UpdateUserByIdJoinedTeamByIdPrimaryChannelMemberByIdOperation : Operations.PatchOperation
{
    ...
    public override ResourceID? ResourceId() => new UserIdJoinedTeamIdPrimaryChannelMemberId();
