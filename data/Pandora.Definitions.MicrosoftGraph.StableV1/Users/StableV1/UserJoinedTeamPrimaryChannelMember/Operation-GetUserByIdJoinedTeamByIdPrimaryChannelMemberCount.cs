...
internal class GetUserByIdJoinedTeamByIdPrimaryChannelMemberCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/primaryChannel/members/$count";
}
