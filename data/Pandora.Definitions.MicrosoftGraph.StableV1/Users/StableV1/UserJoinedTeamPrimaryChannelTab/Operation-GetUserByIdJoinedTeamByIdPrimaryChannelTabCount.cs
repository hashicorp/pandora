...
internal class GetUserByIdJoinedTeamByIdPrimaryChannelTabCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/primaryChannel/tabs/$count";
}
