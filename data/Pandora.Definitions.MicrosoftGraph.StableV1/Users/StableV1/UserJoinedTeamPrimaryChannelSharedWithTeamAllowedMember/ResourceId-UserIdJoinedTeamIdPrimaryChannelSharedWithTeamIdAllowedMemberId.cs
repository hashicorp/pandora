...
internal class UserIdJoinedTeamIdPrimaryChannelSharedWithTeamIdAllowedMemberId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/joinedTeams/{teamId}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfoId}/allowedMembers/{conversationMemberId}";
