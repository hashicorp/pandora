...
internal class AddUserByIdJoinedTeamByIdMemberOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AddUserByIdJoinedTeamByIdMemberRequestModel);
