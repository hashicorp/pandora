...
internal class CreateUserByIdMailFolderByIdMessageByIdReplyAllOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMailFolderByIdMessageByIdReplyAllRequestModel);
