...
internal class CreateUserByIdMailFolderByIdMessageByIdForwardOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMailFolderByIdMessageByIdForwardRequestModel);
