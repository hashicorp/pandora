...
internal class CreateUserByIdMailFolderByIdMessageByIdCopyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMailFolderByIdMessageByIdCopyRequestModel);
