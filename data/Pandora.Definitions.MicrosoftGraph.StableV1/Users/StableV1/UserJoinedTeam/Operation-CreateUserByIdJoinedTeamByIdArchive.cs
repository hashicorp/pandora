...
internal class CreateUserByIdJoinedTeamByIdArchiveOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdJoinedTeamByIdArchiveRequestModel);
