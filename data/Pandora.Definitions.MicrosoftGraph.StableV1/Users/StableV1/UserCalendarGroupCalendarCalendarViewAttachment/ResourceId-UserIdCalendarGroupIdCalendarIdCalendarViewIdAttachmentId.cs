...
internal class UserIdCalendarGroupIdCalendarIdCalendarViewIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendarGroups/{calendarGroupId}/calendars/{calendarId}/calendarView/{eventId}/attachments/{attachmentId}";
