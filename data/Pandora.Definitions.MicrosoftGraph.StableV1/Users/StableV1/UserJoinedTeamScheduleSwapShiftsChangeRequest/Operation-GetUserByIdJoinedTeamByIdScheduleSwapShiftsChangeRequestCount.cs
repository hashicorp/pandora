...
internal class GetUserByIdJoinedTeamByIdScheduleSwapShiftsChangeRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/schedule/swapShiftsChangeRequests/$count";
}
