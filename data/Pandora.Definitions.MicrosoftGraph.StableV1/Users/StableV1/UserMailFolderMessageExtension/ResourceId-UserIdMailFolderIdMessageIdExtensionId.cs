...
internal class UserIdMailFolderIdMessageIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/mailFolders/{mailFolderId}/messages/{messageId}/extensions/{extensionId}";
