...
internal class UserIdCalendarIdCalendarViewIdInstanceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendars/{calendarId}/calendarView/{eventId}/instances/{eventId1}/extensions/{extensionId}";
