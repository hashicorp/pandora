...
namespace Pandora.Definitions.MicrosoftGraph.StableV1.Users.StableV1.UserOnenoteNotebookSectionGroupSectionParentSectionGroup;

internal class UserIdOnenoteNotebookIdSectionGroupIdSectionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/onenote/notebooks/{notebookId}/sectionGroups/{sectionGroupId}/sections/{onenoteSectionId}";
