...
internal class GetUserByIdCalendarGroupByIdCalendarByIdCalendarPermissionCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/calendarPermissions/$count";
}
