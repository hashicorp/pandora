...
internal class GetUserByIdTodoListByIdTaskByIdLinkedResourceCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/linkedResources/$count";
}
