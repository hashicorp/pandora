...
internal class GetUserByIdJoinedTeamByIdChannelByIdSharedWithTeamCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/sharedWithTeams/$count";
}
