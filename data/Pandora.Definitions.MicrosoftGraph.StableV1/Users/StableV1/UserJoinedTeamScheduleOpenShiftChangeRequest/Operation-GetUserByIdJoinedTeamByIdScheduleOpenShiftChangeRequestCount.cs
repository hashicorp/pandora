...
internal class GetUserByIdJoinedTeamByIdScheduleOpenShiftChangeRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/schedule/openShiftChangeRequests/$count";
}
