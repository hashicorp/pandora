...
internal class CreateUserByIdJoinedTeamByIdScheduleOpenShiftChangeRequestOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/schedule/openShiftChangeRequests";
}
