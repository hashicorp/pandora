...
internal class GetUserByIdJoinedTeamByIdScheduleTimeOffRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/schedule/timeOffRequests/$count";
}
