...
internal class GetUserByIdJoinedTeamByIdScheduleSchedulingGroupCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/schedule/schedulingGroups/$count";
}
