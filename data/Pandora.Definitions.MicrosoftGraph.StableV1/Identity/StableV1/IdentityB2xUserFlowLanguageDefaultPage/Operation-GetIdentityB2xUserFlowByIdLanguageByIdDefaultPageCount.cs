...
internal class GetIdentityB2xUserFlowByIdLanguageByIdDefaultPageCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/defaultPages/$count";
}
