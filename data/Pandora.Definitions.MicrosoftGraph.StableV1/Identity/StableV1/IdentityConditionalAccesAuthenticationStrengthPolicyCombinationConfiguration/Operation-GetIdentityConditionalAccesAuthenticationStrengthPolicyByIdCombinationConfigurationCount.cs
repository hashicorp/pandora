...
internal class GetIdentityConditionalAccesAuthenticationStrengthPolicyByIdCombinationConfigurationCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/combinationConfigurations/$count";
}
