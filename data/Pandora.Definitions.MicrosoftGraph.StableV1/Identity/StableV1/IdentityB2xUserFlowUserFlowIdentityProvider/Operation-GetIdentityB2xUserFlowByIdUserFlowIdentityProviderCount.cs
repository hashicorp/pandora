...
internal class GetIdentityB2xUserFlowByIdUserFlowIdentityProviderCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/userFlowIdentityProviders/$count";
}
