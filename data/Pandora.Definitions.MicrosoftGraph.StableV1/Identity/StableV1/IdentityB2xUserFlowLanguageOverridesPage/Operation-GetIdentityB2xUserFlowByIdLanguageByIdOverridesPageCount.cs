...
internal class GetIdentityB2xUserFlowByIdLanguageByIdOverridesPageCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/overridesPages/$count";
}
