...
internal class GetIdentityB2xUserFlowByIdIdentityProviderCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/identityProviders/$count";
}
