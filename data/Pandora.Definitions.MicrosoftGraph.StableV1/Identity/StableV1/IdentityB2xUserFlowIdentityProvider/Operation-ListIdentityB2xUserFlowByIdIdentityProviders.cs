...
internal class ListIdentityB2xUserFlowByIdIdentityProvidersOperation : Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";
    public override ResourceID? ResourceId() => new IdentityB2xUserFlowId();
    public override Type NestedItemType() => typeof(IdentityProviderCollectionResponseModel);
