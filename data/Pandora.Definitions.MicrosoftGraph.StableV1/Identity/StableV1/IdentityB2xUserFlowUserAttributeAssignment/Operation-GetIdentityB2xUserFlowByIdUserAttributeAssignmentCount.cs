...
internal class GetIdentityB2xUserFlowByIdUserAttributeAssignmentCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/userAttributeAssignments/$count";
}
