...
internal class GetGroupByIdConversationByIdThreadByIdPostByIdInReplyToAttachmentCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/inReplyTo/attachments/$count";
}
