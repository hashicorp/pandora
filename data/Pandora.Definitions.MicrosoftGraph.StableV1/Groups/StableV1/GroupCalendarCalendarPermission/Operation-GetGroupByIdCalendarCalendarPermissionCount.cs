...
internal class GetGroupByIdCalendarCalendarPermissionCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/calendar/calendarPermissions/$count";
}
