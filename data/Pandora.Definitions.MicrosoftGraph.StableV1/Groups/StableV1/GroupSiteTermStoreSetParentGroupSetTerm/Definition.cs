...
internal class Definition : ResourceDefinition
{
    ...
    {
        new CreateGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermOperation(),
        new CreateGroupByIdSiteByIdTermStoreSetByIdParentGroupSetByIdTermOperation(),
        new DeleteGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermByIdOperation(),
        new DeleteGroupByIdSiteByIdTermStoreSetByIdParentGroupSetByIdTermByIdOperation(),
        new GetGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermByIdOperation(),
        new GetGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermCountOperation(),
        ...
        new ListGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermsOperation(),
        new ListGroupByIdSiteByIdTermStoreSetByIdParentGroupSetByIdTermsOperation(),
        new UpdateGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermByIdOperation(),
