...
internal class Definition : ResourceDefinition
{
    ...
    {
        new CreateGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermByIdRelationOperation(),
        new CreateGroupByIdSiteByIdTermStoreSetByIdParentGroupSetByIdTermByIdRelationOperation(),
        new DeleteGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermByIdRelationByIdOperation(),
        new DeleteGroupByIdSiteByIdTermStoreSetByIdParentGroupSetByIdTermByIdRelationByIdOperation(),
        new GetGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermByIdRelationByIdOperation(),
        new GetGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermByIdRelationCountOperation(),
        ...
        new ListGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermByIdRelationsOperation(),
        new ListGroupByIdSiteByIdTermStoreSetByIdParentGroupSetByIdTermByIdRelationsOperation(),
        new UpdateGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetByIdTermByIdRelationByIdOperation(),
