...
internal class ListGroupByIdSiteByIdListByIdSubscriptionsOperation : Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";
    public override ResourceID? ResourceId() => new GroupIdSiteIdListId();
    public override Type NestedItemType() => typeof(SubscriptionCollectionResponseModel);
