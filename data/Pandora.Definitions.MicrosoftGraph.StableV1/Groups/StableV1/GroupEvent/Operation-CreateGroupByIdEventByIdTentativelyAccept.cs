...
internal class CreateGroupByIdEventByIdTentativelyAcceptOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdEventByIdTentativelyAcceptRequestModel);
