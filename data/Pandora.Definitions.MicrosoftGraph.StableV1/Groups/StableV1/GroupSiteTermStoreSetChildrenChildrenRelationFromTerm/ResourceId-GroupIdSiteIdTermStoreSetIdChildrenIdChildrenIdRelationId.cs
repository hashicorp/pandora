...
internal class GroupIdSiteIdTermStoreSetIdChildrenIdChildrenIdRelationId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/termStore/sets/{setId}/children/{termId}/children/{termId1}/relations/{relationId}";
