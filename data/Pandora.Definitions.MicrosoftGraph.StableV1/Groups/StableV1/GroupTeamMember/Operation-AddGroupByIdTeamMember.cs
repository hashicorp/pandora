...
internal class AddGroupByIdTeamMemberOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AddGroupByIdTeamMemberRequestModel);
    ...
    public override string? UriSuffix() => "/team/members/add";
}
