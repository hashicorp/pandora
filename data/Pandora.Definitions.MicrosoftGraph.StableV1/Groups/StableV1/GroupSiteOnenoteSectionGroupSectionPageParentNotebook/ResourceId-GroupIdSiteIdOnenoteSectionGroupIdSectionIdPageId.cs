...
namespace Pandora.Definitions.MicrosoftGraph.StableV1.Groups.StableV1.GroupSiteOnenoteSectionGroupSectionPageParentNotebook;

internal class GroupIdSiteIdOnenoteSectionGroupIdSectionIdPageId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/onenote/sectionGroups/{sectionGroupId}/sections/{onenoteSectionId}/pages/{onenotePageId}";
