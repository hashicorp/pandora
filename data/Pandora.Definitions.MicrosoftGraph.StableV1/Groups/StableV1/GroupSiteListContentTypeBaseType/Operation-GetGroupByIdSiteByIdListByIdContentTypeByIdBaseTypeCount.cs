...
internal class GetGroupByIdSiteByIdListByIdContentTypeByIdBaseTypeCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/baseTypes/$count";
}
