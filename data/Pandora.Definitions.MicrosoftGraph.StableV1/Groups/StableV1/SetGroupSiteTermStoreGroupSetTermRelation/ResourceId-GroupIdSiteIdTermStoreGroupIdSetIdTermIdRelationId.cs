...
internal class GroupIdSiteIdTermStoreGroupIdSetIdTermIdRelationId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/termStore/groups/{groupId1}/sets/{setId}/terms/{termId}/relations/{relationId}";
