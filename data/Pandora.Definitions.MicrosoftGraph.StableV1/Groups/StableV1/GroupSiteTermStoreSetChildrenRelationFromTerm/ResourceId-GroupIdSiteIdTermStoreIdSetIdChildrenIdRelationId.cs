...
internal class GroupIdSiteIdTermStoreIdSetIdChildrenIdRelationId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/termStores/{storeId}/sets/{setId}/children/{termId}/relations/{relationId}";
