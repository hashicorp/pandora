...
internal class GroupIdSiteIdTermStoreIdGroupIdSetIdChildrenId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/termStores/{storeId}/groups/{groupId1}/sets/{setId}/children/{termId}";
