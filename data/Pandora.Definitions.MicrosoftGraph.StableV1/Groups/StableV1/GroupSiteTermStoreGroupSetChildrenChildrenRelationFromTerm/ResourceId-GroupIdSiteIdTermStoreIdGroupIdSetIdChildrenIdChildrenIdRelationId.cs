...
internal class GroupIdSiteIdTermStoreIdGroupIdSetIdChildrenIdChildrenIdRelationId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/termStores/{storeId}/groups/{groupId1}/sets/{setId}/children/{termId}/children/{termId1}/relations/{relationId}";
