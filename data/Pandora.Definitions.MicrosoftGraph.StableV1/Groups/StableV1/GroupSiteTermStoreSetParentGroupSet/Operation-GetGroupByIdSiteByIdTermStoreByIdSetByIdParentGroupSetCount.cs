...
internal class GetGroupByIdSiteByIdTermStoreByIdSetByIdParentGroupSetCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/parentGroup/sets/$count";
}
