...
internal class CreateGroupByIdOnenotePageByIdCopyToSectionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdOnenotePageByIdCopyToSectionRequestModel);
