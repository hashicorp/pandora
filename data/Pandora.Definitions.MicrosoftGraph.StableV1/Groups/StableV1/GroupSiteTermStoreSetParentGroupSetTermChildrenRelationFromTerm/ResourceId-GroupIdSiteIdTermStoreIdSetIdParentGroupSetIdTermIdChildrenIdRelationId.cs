...
internal class GroupIdSiteIdTermStoreIdSetIdParentGroupSetIdTermIdChildrenIdRelationId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/termStores/{storeId}/sets/{setId}/parentGroup/sets/{setId1}/terms/{termId}/children/{termId1}/relations/{relationId}";
