...
internal class ValidateGroupByIdPermissionGrantsPropertyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ValidateGroupByIdPermissionGrantsPropertyRequestModel);
