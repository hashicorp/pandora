...
internal class GetGroupByIdTransitiveMemberOfByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new GroupIdTransitiveMemberOfId();
