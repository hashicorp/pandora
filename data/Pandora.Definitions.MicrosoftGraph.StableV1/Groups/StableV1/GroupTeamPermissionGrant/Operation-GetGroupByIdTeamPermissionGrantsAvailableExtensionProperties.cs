...
internal class GetGroupByIdTeamPermissionGrantsAvailableExtensionPropertiesOperation : Operations.ListOperation
{
    ...
    public override string? UriSuffix() => "/team/permissionGrants/getAvailableExtensionProperties";
}
