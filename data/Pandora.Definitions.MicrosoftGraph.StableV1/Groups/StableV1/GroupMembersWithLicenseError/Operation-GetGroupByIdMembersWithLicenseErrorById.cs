...
internal class GetGroupByIdMembersWithLicenseErrorByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new GroupIdMembersWithLicenseErrorId();
