...
internal class GroupIdSiteIdTermStoreIdSetIdTermIdChildrenId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/termStores/{storeId}/sets/{setId}/terms/{termId}/children/{termId1}";
