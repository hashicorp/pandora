...
internal class GetGroupByIdSiteByIdOnenoteNotebooksNotebookFromWebUrlOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetGroupByIdSiteByIdOnenoteNotebooksNotebookFromWebUrlRequestModel);
