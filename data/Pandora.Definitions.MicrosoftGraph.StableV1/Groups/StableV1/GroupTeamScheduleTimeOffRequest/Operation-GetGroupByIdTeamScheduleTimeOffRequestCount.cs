...
internal class GetGroupByIdTeamScheduleTimeOffRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/team/schedule/timeOffRequests/$count";
}
