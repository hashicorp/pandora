...
internal class GroupIdSiteIdTermStoreSetIdParentGroupSetIdTermIdRelationId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/termStore/sets/{setId}/parentGroup/sets/{setId1}/terms/{termId}/relations/{relationId}";
