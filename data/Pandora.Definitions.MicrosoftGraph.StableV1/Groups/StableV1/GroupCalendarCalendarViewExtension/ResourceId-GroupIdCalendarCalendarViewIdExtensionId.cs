...
internal class GroupIdCalendarCalendarViewIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/calendar/calendarView/{eventId}/extensions/{extensionId}";
