...
internal class CreateGroupByIdThreadByIdReplyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdThreadByIdReplyRequestModel);
