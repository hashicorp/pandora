...
internal class GroupIdCalendarEventIdInstanceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/calendar/events/{eventId}/instances/{eventId1}/attachments/{attachmentId}";
