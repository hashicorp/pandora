...
internal class GetPolicyFeatureRolloutPolicyByIdAppliesToAvailableExtensionPropertiesOperation : Operations.ListOperation
{
    ...
    public override string? UriSuffix() => "/appliesTo/getAvailableExtensionProperties";
}
