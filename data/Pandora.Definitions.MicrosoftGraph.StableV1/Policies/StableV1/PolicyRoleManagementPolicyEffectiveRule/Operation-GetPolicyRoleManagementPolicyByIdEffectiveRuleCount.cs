...
internal class GetPolicyRoleManagementPolicyByIdEffectiveRuleCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/effectiveRules/$count";
}
