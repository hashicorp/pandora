...
internal class GetServicePrincipalByIdOwnedObjectByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new ServicePrincipalIdOwnedObjectId();
