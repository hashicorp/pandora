...
internal class GetServicePrincipalByIdMemberOfByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new ServicePrincipalIdMemberOfId();
