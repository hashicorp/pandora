...
internal class DiscoverServicePrincipalByIdSynchronizationJobByIdSchemaDirectoryByIdOperation : Operations.PostOperation
{
    ...
    public override ResourceID? ResourceId() => new ServicePrincipalIdSynchronizationJobIdSchemaDirectoryId();
