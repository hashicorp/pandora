...
internal class AddServicePrincipalPasswordOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AddServicePrincipalPasswordRequestModel);
