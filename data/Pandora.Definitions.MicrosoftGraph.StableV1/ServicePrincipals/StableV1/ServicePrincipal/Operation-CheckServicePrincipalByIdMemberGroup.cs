...
internal class CheckServicePrincipalByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckServicePrincipalByIdMemberGroupRequestModel);
