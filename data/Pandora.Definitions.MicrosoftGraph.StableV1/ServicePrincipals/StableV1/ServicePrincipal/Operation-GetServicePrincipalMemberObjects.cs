...
internal class GetServicePrincipalMemberObjectsOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetServicePrincipalMemberObjectsRequestModel);
