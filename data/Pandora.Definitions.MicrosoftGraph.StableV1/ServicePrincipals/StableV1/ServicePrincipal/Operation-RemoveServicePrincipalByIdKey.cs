...
internal class RemoveServicePrincipalByIdKeyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(RemoveServicePrincipalByIdKeyRequestModel);
