...
internal class AddServicePrincipalByIdPasswordOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AddServicePrincipalByIdPasswordRequestModel);
