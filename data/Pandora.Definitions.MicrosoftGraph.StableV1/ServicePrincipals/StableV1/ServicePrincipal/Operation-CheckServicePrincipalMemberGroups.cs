...
internal class CheckServicePrincipalMemberGroupsOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckServicePrincipalMemberGroupsRequestModel);
