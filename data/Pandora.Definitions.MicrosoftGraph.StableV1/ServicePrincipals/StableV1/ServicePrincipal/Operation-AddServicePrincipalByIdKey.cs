...
internal class AddServicePrincipalByIdKeyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AddServicePrincipalByIdKeyRequestModel);
