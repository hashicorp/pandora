...
internal class GetServicePrincipalByIdTokenIssuancePolicyByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new ServicePrincipalIdTokenIssuancePolicyId();
