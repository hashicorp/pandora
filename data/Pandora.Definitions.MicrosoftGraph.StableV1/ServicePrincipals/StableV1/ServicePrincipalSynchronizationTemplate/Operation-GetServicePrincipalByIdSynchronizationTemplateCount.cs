...
internal class GetServicePrincipalByIdSynchronizationTemplateCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/synchronization/templates/$count";
}
