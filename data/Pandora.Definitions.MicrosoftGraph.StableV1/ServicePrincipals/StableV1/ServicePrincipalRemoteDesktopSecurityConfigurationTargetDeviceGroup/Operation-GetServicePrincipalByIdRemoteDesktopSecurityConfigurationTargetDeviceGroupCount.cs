...
internal class GetServicePrincipalByIdRemoteDesktopSecurityConfigurationTargetDeviceGroupCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/remoteDesktopSecurityConfiguration/targetDeviceGroups/$count";
}
