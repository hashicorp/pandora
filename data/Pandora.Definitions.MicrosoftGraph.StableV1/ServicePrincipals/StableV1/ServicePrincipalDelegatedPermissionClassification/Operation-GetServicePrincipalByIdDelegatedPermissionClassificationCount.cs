...
internal class GetServicePrincipalByIdDelegatedPermissionClassificationCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/delegatedPermissionClassifications/$count";
}
