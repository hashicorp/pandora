...
internal class ListServicePrincipalByIdDelegatedPermissionClassificationsOperation : Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";
    public override ResourceID? ResourceId() => new ServicePrincipalId();
    public override Type NestedItemType() => typeof(DelegatedPermissionClassificationCollectionResponseModel);
