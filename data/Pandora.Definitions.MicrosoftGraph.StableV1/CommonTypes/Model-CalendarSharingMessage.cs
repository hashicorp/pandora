...
internal class CalendarSharingMessageModel
{
    ...
    public CalendarSharingMessageActionModel? SharingMessageAction { get; set; }

    [JsonPropertyName("sharingMessageActions")]
    public List<CalendarSharingMessageActionModel>? SharingMessageActions { get; set; }
