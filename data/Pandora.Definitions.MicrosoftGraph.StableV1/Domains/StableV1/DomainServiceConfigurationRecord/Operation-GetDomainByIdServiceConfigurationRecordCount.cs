...
internal class GetDomainByIdServiceConfigurationRecordCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/serviceConfigurationRecords/$count";
}
