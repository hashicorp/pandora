...
internal class GetDomainByIdFederationConfigurationCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/federationConfiguration/$count";
}
