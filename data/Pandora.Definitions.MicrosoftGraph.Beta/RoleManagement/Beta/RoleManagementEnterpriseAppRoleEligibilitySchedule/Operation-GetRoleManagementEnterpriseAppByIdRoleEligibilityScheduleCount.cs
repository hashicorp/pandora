...
internal class GetRoleManagementEnterpriseAppByIdRoleEligibilityScheduleCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/roleEligibilitySchedules/$count";
}
