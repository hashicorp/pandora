...
internal class CreateRoleManagementExchangeTransitiveRoleAssignmentOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/roleManagement/exchange/transitiveRoleAssignments";
}
