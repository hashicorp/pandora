...
internal class GetRoleManagementDeviceManagementRoleAssignmentByIdDirectoryScopeCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/directoryScopes/$count";
}
