...
internal class CreateRoleManagementEntitlementManagementTransitiveRoleAssignmentOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/roleManagement/entitlementManagement/transitiveRoleAssignments";
}
