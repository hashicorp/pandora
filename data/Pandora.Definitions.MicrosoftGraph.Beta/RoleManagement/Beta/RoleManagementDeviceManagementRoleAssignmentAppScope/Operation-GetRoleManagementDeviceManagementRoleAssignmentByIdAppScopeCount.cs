...
internal class GetRoleManagementDeviceManagementRoleAssignmentByIdAppScopeCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/appScopes/$count";
}
