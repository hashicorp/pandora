...
internal class CreateRoleManagementExchangeRoleAssignmentOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/roleManagement/exchange/roleAssignments";
}
