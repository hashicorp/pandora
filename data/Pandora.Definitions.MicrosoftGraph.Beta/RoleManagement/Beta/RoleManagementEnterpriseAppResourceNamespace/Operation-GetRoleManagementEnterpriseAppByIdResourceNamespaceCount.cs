...
internal class GetRoleManagementEnterpriseAppByIdResourceNamespaceCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/resourceNamespaces/$count";
}
