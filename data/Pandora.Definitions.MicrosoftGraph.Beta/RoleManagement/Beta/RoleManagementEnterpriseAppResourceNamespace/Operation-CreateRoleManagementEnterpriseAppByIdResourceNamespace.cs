...
internal class CreateRoleManagementEnterpriseAppByIdResourceNamespaceOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/resourceNamespaces";
}
