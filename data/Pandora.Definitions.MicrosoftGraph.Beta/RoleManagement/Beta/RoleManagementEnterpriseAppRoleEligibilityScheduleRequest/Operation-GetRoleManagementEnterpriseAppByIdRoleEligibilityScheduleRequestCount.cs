...
internal class GetRoleManagementEnterpriseAppByIdRoleEligibilityScheduleRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/roleEligibilityScheduleRequests/$count";
}
