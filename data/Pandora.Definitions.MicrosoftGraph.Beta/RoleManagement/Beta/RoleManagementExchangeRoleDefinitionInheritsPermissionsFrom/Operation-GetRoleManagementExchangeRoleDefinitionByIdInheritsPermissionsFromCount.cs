...
internal class GetRoleManagementExchangeRoleDefinitionByIdInheritsPermissionsFromCountOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new RoleManagementExchangeRoleDefinitionId();
