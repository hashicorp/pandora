...
internal class CreateRoleManagementCloudPCRoleDefinitionOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/roleManagement/cloudPC/roleDefinitions";
}
