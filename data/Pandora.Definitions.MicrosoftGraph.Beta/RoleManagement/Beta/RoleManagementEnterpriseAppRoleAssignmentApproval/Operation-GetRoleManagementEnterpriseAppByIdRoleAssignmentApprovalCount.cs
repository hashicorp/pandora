...
internal class GetRoleManagementEnterpriseAppByIdRoleAssignmentApprovalCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/roleAssignmentApprovals/$count";
}
