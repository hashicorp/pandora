...
internal class RoleManagementCloudPCRoleAssignmentIdPrincipalId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultipleId}/principals/{directoryObjectId}";
