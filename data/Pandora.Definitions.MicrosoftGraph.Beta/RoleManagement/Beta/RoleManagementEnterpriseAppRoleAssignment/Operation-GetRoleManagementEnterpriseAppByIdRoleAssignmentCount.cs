...
internal class GetRoleManagementEnterpriseAppByIdRoleAssignmentCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/roleAssignments/$count";
}
