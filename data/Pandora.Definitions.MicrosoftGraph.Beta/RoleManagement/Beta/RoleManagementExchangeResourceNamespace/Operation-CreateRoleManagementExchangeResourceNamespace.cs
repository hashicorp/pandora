...
internal class CreateRoleManagementExchangeResourceNamespaceOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/roleManagement/exchange/resourceNamespaces";
}
