...
internal class CreateRoleManagementDirectoryRoleAssignmentApprovalOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/roleManagement/directory/roleAssignmentApprovals";
}
