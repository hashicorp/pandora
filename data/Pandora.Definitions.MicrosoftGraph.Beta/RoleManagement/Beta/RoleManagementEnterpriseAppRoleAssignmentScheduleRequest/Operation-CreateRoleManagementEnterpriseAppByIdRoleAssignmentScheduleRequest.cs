...
internal class CreateRoleManagementEnterpriseAppByIdRoleAssignmentScheduleRequestOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/roleAssignmentScheduleRequests";
}
