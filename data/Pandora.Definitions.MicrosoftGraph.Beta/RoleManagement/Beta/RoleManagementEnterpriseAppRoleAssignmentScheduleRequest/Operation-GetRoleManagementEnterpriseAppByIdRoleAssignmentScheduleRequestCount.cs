...
internal class GetRoleManagementEnterpriseAppByIdRoleAssignmentScheduleRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/roleAssignmentScheduleRequests/$count";
}
