...
internal class RoleManagementEnterpriseAppIdRoleAssignmentApprovalIdStepId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/roleManagement/enterpriseApps/{rbacApplicationId}/roleAssignmentApprovals/{approvalId}/steps/{approvalStepId}";
