...
internal class GetRoleManagementEnterpriseAppByIdTransitiveRoleAssignmentCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/transitiveRoleAssignments/$count";
}
