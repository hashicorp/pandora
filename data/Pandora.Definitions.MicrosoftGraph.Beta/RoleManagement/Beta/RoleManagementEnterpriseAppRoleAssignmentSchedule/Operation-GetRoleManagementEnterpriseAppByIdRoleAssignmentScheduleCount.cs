...
internal class GetRoleManagementEnterpriseAppByIdRoleAssignmentScheduleCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/roleAssignmentSchedules/$count";
}
