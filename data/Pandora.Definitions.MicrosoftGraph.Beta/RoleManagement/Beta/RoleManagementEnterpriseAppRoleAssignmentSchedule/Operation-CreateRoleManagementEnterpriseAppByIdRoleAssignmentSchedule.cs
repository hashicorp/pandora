...
internal class CreateRoleManagementEnterpriseAppByIdRoleAssignmentScheduleOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/roleAssignmentSchedules";
}
