...
internal class GetRoleManagementEnterpriseAppByIdRoleDefinitionCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/roleDefinitions/$count";
}
