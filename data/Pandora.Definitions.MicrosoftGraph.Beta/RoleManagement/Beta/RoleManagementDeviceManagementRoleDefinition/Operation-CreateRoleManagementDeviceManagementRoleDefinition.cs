...
internal class CreateRoleManagementDeviceManagementRoleDefinitionOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/roleManagement/deviceManagement/roleDefinitions";
}
