...
internal class GetServicePrincipalByIdClaimsMappingPolicyCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/claimsMappingPolicies/$count";
}
