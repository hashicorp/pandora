...
internal class GetServicePrincipalsUserOwnedObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetServicePrincipalsUserOwnedObjectRequestModel);
