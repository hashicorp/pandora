...
internal class GetServicePrincipalMemberGroupsOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetServicePrincipalMemberGroupsRequestModel);
