...
internal class GetServicePrincipalByIdPasswordSingleSignOnCredentialOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetServicePrincipalByIdPasswordSingleSignOnCredentialRequestModel);
