...
internal class UpdateServicePrincipalByIdPasswordSingleSignOnCredentialOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(UpdateServicePrincipalByIdPasswordSingleSignOnCredentialRequestModel);
