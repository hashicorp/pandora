...
internal class GetServicePrincipalByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetServicePrincipalByIdMemberObjectRequestModel);
