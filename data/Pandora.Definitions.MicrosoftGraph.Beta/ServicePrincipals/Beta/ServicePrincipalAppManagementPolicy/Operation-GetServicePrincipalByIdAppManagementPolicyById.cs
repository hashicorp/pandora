...
internal class GetServicePrincipalByIdAppManagementPolicyByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new ServicePrincipalIdAppManagementPolicyId();
