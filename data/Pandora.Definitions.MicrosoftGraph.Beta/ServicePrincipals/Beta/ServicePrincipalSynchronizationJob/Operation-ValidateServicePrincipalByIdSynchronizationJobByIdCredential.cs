...
internal class ValidateServicePrincipalByIdSynchronizationJobByIdCredentialOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ValidateServicePrincipalByIdSynchronizationJobByIdCredentialRequestModel);
