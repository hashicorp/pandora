...
internal class GetServicePrincipalByIdSynchronizationJobCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/synchronization/jobs/$count";
}
