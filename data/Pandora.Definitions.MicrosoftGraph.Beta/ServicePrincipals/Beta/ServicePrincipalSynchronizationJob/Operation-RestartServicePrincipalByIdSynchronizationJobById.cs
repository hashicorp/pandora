...
internal class RestartServicePrincipalByIdSynchronizationJobByIdOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(RestartServicePrincipalByIdSynchronizationJobByIdRequestModel);
