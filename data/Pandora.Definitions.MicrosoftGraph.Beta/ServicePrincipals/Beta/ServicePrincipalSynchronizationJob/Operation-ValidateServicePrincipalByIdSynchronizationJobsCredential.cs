...
internal class ValidateServicePrincipalByIdSynchronizationJobsCredentialOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ValidateServicePrincipalByIdSynchronizationJobsCredentialRequestModel);
