...
internal class GetServicePrincipalByIdHomeRealmDiscoveryPolicyCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/homeRealmDiscoveryPolicies/$count";
}
