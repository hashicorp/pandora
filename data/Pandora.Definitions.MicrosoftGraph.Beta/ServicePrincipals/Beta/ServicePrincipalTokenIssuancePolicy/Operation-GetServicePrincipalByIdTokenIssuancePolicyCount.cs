...
internal class GetServicePrincipalByIdTokenIssuancePolicyCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/tokenIssuancePolicies/$count";
}
