...
internal class GetServicePrincipalByIdAppRoleAssignmentCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/appRoleAssignments/$count";
}
