...
internal class GetServicePrincipalByIdSynchronizationSecretCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/synchronization/secrets/$count";
}
