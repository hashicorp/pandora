...
internal class AcquireServicePrincipalByIdSynchronizationAccessTokenOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AcquireServicePrincipalByIdSynchronizationAccessTokenRequestModel);
