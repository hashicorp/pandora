...
internal class GetServicePrincipalByIdCreatedObjectByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new ServicePrincipalIdCreatedObjectId();
