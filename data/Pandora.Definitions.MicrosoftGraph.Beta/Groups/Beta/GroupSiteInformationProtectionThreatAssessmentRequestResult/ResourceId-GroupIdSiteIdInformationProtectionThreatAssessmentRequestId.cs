...
internal class GroupIdSiteIdInformationProtectionThreatAssessmentRequestId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/informationProtection/threatAssessmentRequests/{threatAssessmentRequestId}";
