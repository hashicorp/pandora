...
internal class GetGroupByIdSiteByIdInformationProtectionDataLossPreventionPolicyCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/informationProtection/dataLossPreventionPolicies/$count";
}
