...
internal class GetGroupByIdSiteByIdInformationProtectionSensitivityLabelCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/informationProtection/sensitivityLabels/$count";
}
