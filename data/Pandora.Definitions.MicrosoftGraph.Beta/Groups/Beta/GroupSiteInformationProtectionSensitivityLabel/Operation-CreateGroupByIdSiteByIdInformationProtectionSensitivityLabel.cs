...
internal class CreateGroupByIdSiteByIdInformationProtectionSensitivityLabelOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/informationProtection/sensitivityLabels";
}
