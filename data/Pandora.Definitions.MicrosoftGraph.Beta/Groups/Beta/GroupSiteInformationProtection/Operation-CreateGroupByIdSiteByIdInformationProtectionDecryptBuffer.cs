...
internal class CreateGroupByIdSiteByIdInformationProtectionDecryptBufferOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdSiteByIdInformationProtectionDecryptBufferRequestModel);
