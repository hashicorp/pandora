...
internal class GroupIdConversationIdThreadIdPostIdInReplyToMentionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/conversations/{conversationId}/threads/{conversationThreadId}/posts/{postId}/inReplyTo/mentions/{mentionId}";
