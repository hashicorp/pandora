...
internal class GetGroupByIdConversationByIdThreadByIdPostByIdInReplyToMentionCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/inReplyTo/mentions/$count";
}
