...
internal class GetGroupByIdSiteByIdInformationProtectionThreatAssessmentRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/informationProtection/threatAssessmentRequests/$count";
}
