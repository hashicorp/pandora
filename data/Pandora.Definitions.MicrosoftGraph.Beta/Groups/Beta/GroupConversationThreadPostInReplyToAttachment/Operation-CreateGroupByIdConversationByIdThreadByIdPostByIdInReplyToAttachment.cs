...
internal class CreateGroupByIdConversationByIdThreadByIdPostByIdInReplyToAttachmentOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/inReplyTo/attachments";
}
