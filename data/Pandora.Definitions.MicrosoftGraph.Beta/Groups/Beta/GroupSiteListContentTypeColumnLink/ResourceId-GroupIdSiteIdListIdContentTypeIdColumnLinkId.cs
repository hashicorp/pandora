...
internal class GroupIdSiteIdListIdContentTypeIdColumnLinkId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/lists/{listId}/contentTypes/{contentTypeId}/columnLinks/{columnLinkId}";
