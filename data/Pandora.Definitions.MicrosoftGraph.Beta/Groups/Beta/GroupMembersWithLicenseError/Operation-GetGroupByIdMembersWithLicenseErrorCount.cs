...
internal class GetGroupByIdMembersWithLicenseErrorCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/membersWithLicenseErrors/$count";
}
