...
internal class GetGroupByIdTeamScheduleOpenShiftChangeRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/team/schedule/openShiftChangeRequests/$count";
}
