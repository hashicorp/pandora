...
internal class GetGroupByIdTeamPrimaryChannelMemberCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/team/primaryChannel/members/$count";
}
