...
internal class GroupIdCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/calendar/events/{eventId}/exceptionOccurrences/{eventId1}/instances/{eventId2}/extensions/{extensionId}";
