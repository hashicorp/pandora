...
internal class GetGroupByIdTeamScheduleSwapShiftsChangeRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/team/schedule/swapShiftsChangeRequests/$count";
}
