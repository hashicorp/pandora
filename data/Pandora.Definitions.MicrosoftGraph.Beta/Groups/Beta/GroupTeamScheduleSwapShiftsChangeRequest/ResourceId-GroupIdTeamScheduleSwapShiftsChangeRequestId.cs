...
internal class GroupIdTeamScheduleSwapShiftsChangeRequestId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/team/schedule/swapShiftsChangeRequests/{swapShiftsChangeRequestId}";
