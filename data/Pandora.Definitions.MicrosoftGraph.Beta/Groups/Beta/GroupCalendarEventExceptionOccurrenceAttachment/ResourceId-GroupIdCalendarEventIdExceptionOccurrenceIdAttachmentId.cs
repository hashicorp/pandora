...
internal class GroupIdCalendarEventIdExceptionOccurrenceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/calendar/events/{eventId}/exceptionOccurrences/{eventId1}/attachments/{attachmentId}";
