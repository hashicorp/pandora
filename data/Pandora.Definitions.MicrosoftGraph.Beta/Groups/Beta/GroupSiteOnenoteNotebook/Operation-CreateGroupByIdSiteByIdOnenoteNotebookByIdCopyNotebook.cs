...
internal class CreateGroupByIdSiteByIdOnenoteNotebookByIdCopyNotebookOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdSiteByIdOnenoteNotebookByIdCopyNotebookRequestModel);
