...
internal class CreateGroupByIdOnenoteNotebookByIdSectionByIdCopyToNotebookOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdOnenoteNotebookByIdSectionByIdCopyToNotebookRequestModel);
