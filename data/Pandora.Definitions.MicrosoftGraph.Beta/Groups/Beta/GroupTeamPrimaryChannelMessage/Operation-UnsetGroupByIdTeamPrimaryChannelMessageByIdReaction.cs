...
internal class UnsetGroupByIdTeamPrimaryChannelMessageByIdReactionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(UnsetGroupByIdTeamPrimaryChannelMessageByIdReactionRequestModel);
