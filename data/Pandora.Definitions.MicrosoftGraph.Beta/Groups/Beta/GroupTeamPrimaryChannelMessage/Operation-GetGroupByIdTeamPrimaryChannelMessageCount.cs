...
internal class GetGroupByIdTeamPrimaryChannelMessageCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/team/primaryChannel/messages/$count";
}
