...
internal class CreateGroupByIdTeamPrimaryChannelMessageOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/team/primaryChannel/messages";
}
