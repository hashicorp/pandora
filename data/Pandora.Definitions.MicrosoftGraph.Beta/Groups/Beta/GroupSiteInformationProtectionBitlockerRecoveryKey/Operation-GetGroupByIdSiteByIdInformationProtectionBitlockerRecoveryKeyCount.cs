...
internal class GetGroupByIdSiteByIdInformationProtectionBitlockerRecoveryKeyCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/informationProtection/bitlocker/recoveryKeys/$count";
}
