...
internal class GetGroupByIdTeamScheduleTimeOffReasonCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/team/schedule/timeOffReasons/$count";
}
