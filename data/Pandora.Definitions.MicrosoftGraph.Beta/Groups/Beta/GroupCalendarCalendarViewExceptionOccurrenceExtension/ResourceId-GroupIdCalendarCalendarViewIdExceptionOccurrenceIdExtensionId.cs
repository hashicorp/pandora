...
internal class GroupIdCalendarCalendarViewIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/calendar/calendarView/{eventId}/exceptionOccurrences/{eventId1}/extensions/{extensionId}";
