...
internal class CreateGroupByIdEventByIdDeclineOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdEventByIdDeclineRequestModel);
