...
internal class CreateGroupByIdEventByIdForwardOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdEventByIdForwardRequestModel);
