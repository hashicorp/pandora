...
internal class CreateGroupByIdEventByIdAcceptOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdEventByIdAcceptRequestModel);
