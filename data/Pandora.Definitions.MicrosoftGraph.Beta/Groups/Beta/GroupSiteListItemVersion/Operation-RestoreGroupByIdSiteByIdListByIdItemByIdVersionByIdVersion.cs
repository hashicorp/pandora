...
internal class RestoreGroupByIdSiteByIdListByIdItemByIdVersionByIdVersionOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/restoreVersion";
}
