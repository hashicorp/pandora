...
internal class GroupIdCalendarViewIdInstanceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/calendarView/{eventId}/instances/{eventId1}/attachments/{attachmentId}";
