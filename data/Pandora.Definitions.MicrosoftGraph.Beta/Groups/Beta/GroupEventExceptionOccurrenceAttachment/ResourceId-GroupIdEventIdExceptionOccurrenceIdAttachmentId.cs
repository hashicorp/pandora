...
internal class GroupIdEventIdExceptionOccurrenceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/events/{eventId}/exceptionOccurrences/{eventId1}/attachments/{attachmentId}";
