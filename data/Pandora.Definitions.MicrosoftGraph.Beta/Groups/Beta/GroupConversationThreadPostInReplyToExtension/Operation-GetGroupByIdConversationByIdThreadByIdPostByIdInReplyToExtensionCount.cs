...
internal class GetGroupByIdConversationByIdThreadByIdPostByIdInReplyToExtensionCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/inReplyTo/extensions/$count";
}
