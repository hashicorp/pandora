...
internal class CheckGroupByIdTeamPermissionGrantByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckGroupByIdTeamPermissionGrantByIdMemberGroupRequestModel);
