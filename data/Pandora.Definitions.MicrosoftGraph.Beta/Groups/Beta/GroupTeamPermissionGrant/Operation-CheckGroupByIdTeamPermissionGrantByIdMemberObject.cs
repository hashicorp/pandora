...
internal class CheckGroupByIdTeamPermissionGrantByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckGroupByIdTeamPermissionGrantByIdMemberObjectRequestModel);
