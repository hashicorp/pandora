...
internal class CreateGroupByIdCalendarViewByIdAttachmentCreateUploadSessionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateGroupByIdCalendarViewByIdAttachmentCreateUploadSessionRequestModel);
