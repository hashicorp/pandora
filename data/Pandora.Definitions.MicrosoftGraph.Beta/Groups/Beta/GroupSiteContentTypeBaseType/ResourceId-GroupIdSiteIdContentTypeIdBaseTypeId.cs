...
internal class GroupIdSiteIdContentTypeIdBaseTypeId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/groups/{groupId}/sites/{siteId}/contentTypes/{contentTypeId}/baseTypes/{contentTypeId1}";
