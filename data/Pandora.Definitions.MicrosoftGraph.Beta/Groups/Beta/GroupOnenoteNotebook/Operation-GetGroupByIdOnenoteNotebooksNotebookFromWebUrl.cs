...
internal class GetGroupByIdOnenoteNotebooksNotebookFromWebUrlOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetGroupByIdOnenoteNotebooksNotebookFromWebUrlRequestModel);
