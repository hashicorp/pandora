...
internal class GetGroupByIdSiteByIdInformationProtectionPolicyLabelCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/informationProtection/policy/labels/$count";
}
