...
internal class UnsetGroupByIdTeamChannelByIdMessageByIdReactionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(UnsetGroupByIdTeamChannelByIdMessageByIdReactionRequestModel);
