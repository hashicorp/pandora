...
internal class GetPolicyServicePrincipalCreationPolicyByIdIncludeCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/includes/$count";
}
