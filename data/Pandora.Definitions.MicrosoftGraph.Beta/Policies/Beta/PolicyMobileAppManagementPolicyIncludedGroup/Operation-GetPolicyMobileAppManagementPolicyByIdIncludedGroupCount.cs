...
internal class GetPolicyMobileAppManagementPolicyByIdIncludedGroupCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/includedGroups/$count";
}
