...
internal class CreatePolicyMobileAppManagementPolicyOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/policies/mobileAppManagementPolicies";
}
