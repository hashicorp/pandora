...
internal class GetPolicyAuthorizationPolicyByIdDefaultUserRoleOverrideCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/defaultUserRoleOverrides/$count";
}
