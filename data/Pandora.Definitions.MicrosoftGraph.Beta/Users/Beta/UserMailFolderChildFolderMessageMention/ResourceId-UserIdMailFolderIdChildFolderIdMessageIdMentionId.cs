...
internal class UserIdMailFolderIdChildFolderIdMessageIdMentionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/mailFolders/{mailFolderId}/childFolders/{mailFolderId1}/messages/{messageId}/mentions/{mentionId}";
