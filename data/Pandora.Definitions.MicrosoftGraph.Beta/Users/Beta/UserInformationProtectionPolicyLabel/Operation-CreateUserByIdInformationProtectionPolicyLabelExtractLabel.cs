...
internal class CreateUserByIdInformationProtectionPolicyLabelExtractLabelOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdInformationProtectionPolicyLabelExtractLabelRequestModel);
