...
internal class GetUserByIdPendingAccessReviewInstanceByIdContactedReviewerCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/contactedReviewers/$count";
}
