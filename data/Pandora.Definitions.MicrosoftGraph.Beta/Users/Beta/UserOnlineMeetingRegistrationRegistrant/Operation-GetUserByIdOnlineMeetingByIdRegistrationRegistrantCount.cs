...
internal class GetUserByIdOnlineMeetingByIdRegistrationRegistrantCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/registration/registrants/$count";
}
