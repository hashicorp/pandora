...
internal class CreateUserByIdMessageByIdCreateReplyAllOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMessageByIdCreateReplyAllRequestModel);
