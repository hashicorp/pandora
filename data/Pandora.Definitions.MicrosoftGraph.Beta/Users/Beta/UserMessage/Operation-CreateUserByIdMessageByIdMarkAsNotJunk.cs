...
internal class CreateUserByIdMessageByIdMarkAsNotJunkOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMessageByIdMarkAsNotJunkRequestModel);
