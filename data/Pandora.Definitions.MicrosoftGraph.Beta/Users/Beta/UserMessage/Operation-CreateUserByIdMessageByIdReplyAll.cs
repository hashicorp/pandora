...
internal class CreateUserByIdMessageByIdReplyAllOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMessageByIdReplyAllRequestModel);
