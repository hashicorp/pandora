...
internal class UserIdCalendarEventIdInstanceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendar/events/{eventId}/instances/{eventId1}/extensions/{extensionId}";
