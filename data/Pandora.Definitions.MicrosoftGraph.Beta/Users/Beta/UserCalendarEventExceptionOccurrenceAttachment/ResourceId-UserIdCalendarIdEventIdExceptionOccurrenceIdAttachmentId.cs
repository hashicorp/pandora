...
internal class UserIdCalendarIdEventIdExceptionOccurrenceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendars/{calendarId}/events/{eventId}/exceptionOccurrences/{eventId1}/attachments/{attachmentId}";
