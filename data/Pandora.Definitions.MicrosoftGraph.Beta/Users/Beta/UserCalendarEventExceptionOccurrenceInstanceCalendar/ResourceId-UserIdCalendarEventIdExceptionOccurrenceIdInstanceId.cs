...
internal class UserIdCalendarEventIdExceptionOccurrenceIdInstanceId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendar/events/{eventId}/exceptionOccurrences/{eventId1}/instances/{eventId2}";
