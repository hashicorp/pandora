...
internal class GetUserByIdAppConsentRequestsForApprovalByIdUserConsentRequestByIdApprovalStepCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/approval/steps/$count";
}
