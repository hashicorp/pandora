...
internal class GetUserByIdManagedDeviceByIdSecurityBaselineStateByIdSettingStateCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/settingStates/$count";
}
