...
internal class UserIdPendingAccessReviewInstanceIdStageId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/pendingAccessReviewInstances/{accessReviewInstanceId}/stages/{accessReviewStageId}";
