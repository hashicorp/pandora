...
internal class UserIdContactFolderIdChildFolderIdContactIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/contactFolders/{contactFolderId}/childFolders/{contactFolderId1}/contacts/{contactId}/extensions/{extensionId}";
