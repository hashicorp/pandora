...
internal class GetUserByIdMailFolderByIdChildFolderByIdUserConfigurationCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/userConfigurations/$count";
}
