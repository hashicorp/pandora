...
internal class UserIdCalendarGroupIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendarGroups/{calendarGroupId}/calendars/{calendarId}/events/{eventId}/instances/{eventId1}/exceptionOccurrences/{eventId2}/extensions/{extensionId}";
