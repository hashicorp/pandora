...
internal class GetUserByIdDeviceEnrollmentConfigurationByIdAssignmentCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/assignments/$count";
}
