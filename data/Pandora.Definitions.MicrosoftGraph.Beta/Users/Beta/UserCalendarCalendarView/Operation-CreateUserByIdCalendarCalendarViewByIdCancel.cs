...
internal class CreateUserByIdCalendarCalendarViewByIdCancelOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdCalendarCalendarViewByIdCancelRequestModel);
