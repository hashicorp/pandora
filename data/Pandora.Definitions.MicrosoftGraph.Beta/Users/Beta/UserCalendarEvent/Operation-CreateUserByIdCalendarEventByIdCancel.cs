...
internal class CreateUserByIdCalendarEventByIdCancelOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdCalendarEventByIdCancelRequestModel);
