...
internal class UpdateUserByIdOnlineMeetingByIdRegistrationCustomQuestionByIdOperation : Operations.PatchOperation
{
    ...
    public override Type? RequestObject() => typeof(MeetingRegistrationQuestionModel);
