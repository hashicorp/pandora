...
internal class GetUserByIdOnlineMeetingByIdRegistrationCustomQuestionCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/registration/customQuestions/$count";
}
