...
internal class UserIdCalendarCalendarViewIdExceptionOccurrenceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendar/calendarView/{eventId}/exceptionOccurrences/{eventId1}/attachments/{attachmentId}";
