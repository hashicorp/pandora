...
internal class UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendars/{calendarId}/calendarView/{eventId}/exceptionOccurrences/{eventId1}/attachments/{attachmentId}";
