...
internal class CreateUserByIdPendingAccessReviewInstanceByIdSendReminderOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/sendReminder";
}
