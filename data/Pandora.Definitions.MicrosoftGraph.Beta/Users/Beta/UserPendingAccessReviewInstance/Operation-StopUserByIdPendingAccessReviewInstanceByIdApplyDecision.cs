...
internal class StopUserByIdPendingAccessReviewInstanceByIdApplyDecisionOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/stopApplyDecisions";
}
