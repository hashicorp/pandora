...
internal class CreateUserByIdPendingAccessReviewInstanceByIdAcceptRecommendationOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/acceptRecommendations";
}
