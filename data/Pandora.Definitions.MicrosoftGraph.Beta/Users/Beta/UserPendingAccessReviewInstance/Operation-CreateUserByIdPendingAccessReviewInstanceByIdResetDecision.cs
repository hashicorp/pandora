...
internal class CreateUserByIdPendingAccessReviewInstanceByIdResetDecisionOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/resetDecisions";
}
