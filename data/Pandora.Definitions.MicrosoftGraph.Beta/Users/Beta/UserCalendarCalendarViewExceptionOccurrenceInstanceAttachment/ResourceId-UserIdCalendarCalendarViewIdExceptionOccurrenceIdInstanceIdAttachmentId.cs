...
internal class UserIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendar/calendarView/{eventId}/exceptionOccurrences/{eventId1}/instances/{eventId2}/attachments/{attachmentId}";
