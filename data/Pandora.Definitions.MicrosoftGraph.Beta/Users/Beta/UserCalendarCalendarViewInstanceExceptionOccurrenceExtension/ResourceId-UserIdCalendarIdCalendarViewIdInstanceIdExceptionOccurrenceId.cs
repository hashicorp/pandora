...
internal class UserIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendars/{calendarId}/calendarView/{eventId}/instances/{eventId1}/exceptionOccurrences/{eventId2}";
