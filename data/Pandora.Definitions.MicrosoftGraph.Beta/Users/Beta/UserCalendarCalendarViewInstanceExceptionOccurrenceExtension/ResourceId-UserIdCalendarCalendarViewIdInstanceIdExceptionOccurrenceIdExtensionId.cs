...
internal class UserIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendar/calendarView/{eventId}/instances/{eventId1}/exceptionOccurrences/{eventId2}/extensions/{extensionId}";
