...
internal class GetUserByIdManagedDeviceByIdDeviceCompliancePolicyStateCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/deviceCompliancePolicyStates/$count";
}
