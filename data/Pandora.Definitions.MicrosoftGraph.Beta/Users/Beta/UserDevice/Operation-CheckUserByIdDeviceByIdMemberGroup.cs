...
internal class CheckUserByIdDeviceByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckUserByIdDeviceByIdMemberGroupRequestModel);
