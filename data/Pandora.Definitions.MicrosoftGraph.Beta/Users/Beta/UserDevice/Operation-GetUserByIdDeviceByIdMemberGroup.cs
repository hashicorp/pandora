...
internal class GetUserByIdDeviceByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetUserByIdDeviceByIdMemberGroupRequestModel);
