...
internal class GetUserByIdDeviceByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetUserByIdDeviceByIdMemberObjectRequestModel);
