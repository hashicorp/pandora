...
internal class CreateUserByIdMailFolderByIdMessageByIdMarkAsNotJunkOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMailFolderByIdMessageByIdMarkAsNotJunkRequestModel);
