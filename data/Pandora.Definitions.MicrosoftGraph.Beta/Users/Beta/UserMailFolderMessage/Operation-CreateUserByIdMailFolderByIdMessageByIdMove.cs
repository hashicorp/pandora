...
internal class CreateUserByIdMailFolderByIdMessageByIdMoveOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMailFolderByIdMessageByIdMoveRequestModel);
