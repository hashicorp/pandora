...
internal class CreateUserByIdMailFolderByIdMessageByIdCreateReplyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMailFolderByIdMessageByIdCreateReplyRequestModel);
