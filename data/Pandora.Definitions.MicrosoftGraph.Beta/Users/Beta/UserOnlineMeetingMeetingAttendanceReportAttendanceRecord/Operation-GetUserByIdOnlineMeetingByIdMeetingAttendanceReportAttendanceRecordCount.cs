...
internal class GetUserByIdOnlineMeetingByIdMeetingAttendanceReportAttendanceRecordCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/meetingAttendanceReport/attendanceRecords/$count";
}
