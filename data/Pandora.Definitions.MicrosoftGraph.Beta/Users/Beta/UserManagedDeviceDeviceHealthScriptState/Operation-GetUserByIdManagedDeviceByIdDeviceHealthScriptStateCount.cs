...
internal class GetUserByIdManagedDeviceByIdDeviceHealthScriptStateCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/deviceHealthScriptStates/$count";
}
