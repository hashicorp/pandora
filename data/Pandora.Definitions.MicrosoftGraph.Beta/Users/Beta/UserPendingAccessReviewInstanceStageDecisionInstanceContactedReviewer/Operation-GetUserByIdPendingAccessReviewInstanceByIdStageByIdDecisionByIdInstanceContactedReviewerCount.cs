...
internal class GetUserByIdPendingAccessReviewInstanceByIdStageByIdDecisionByIdInstanceContactedReviewerCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/instance/contactedReviewers/$count";
}
