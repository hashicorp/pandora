...
internal class UserIdCalendarCalendarViewIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendar/calendarView/{eventId}/exceptionOccurrences/{eventId1}/extensions/{extensionId}";
