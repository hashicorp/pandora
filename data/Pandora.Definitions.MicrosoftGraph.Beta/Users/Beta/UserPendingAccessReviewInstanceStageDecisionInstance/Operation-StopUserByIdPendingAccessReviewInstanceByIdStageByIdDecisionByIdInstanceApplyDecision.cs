...
internal class StopUserByIdPendingAccessReviewInstanceByIdStageByIdDecisionByIdInstanceApplyDecisionOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/instance/stopApplyDecisions";
}
