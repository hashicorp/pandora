...
internal class CreateUserByIdPendingAccessReviewInstanceByIdStageByIdDecisionByIdInstanceResetDecisionOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/instance/resetDecisions";
}
