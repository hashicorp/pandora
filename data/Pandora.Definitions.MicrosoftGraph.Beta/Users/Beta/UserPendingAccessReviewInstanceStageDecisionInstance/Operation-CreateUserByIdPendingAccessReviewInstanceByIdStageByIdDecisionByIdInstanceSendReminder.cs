...
internal class CreateUserByIdPendingAccessReviewInstanceByIdStageByIdDecisionByIdInstanceSendReminderOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/instance/sendReminder";
}
