...
internal class CreateUserByIdPendingAccessReviewInstanceByIdStageByIdDecisionByIdInstanceApplyDecisionOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/instance/applyDecisions";
}
