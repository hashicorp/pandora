...
internal class GetUserByIdPendingAccessReviewInstanceByIdDecisionByIdInstanceStageCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/instance/stages/$count";
}
