...
internal class UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendars/{calendarId}/events/{eventId}/instances/{eventId1}/exceptionOccurrences/{eventId2}/attachments/{attachmentId}";
