...
internal class GetUserByIdManagedDeviceByIdAssignmentFilterEvaluationStatusDetailCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/assignmentFilterEvaluationStatusDetails/$count";
}
