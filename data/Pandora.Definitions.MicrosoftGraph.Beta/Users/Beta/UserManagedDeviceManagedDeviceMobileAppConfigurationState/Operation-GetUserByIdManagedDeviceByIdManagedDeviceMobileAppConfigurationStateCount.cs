...
internal class GetUserByIdManagedDeviceByIdManagedDeviceMobileAppConfigurationStateCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/managedDeviceMobileAppConfigurationStates/$count";
}
