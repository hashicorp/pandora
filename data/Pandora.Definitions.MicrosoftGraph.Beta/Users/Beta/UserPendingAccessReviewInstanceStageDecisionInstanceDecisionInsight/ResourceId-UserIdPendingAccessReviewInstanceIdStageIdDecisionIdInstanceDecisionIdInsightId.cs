...
internal class UserIdPendingAccessReviewInstanceIdStageIdDecisionIdInstanceDecisionIdInsightId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/pendingAccessReviewInstances/{accessReviewInstanceId}/stages/{accessReviewStageId}/decisions/{accessReviewInstanceDecisionItemId}/instance/decisions/{accessReviewInstanceDecisionItemId1}/insights/{governanceInsightId}";
