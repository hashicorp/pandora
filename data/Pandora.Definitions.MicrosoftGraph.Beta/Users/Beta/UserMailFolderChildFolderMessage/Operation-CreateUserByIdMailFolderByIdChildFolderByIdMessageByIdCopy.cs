...
internal class CreateUserByIdMailFolderByIdChildFolderByIdMessageByIdCopyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdMailFolderByIdChildFolderByIdMessageByIdCopyRequestModel);
