...
internal class GetUserByIdAuthenticationPasswordMethodByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new UserIdAuthenticationPasswordMethodId();
