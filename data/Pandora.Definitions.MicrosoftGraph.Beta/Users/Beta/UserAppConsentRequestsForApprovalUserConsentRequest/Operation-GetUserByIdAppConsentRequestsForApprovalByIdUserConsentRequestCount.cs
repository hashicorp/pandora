...
internal class GetUserByIdAppConsentRequestsForApprovalByIdUserConsentRequestCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/userConsentRequests/$count";
}
