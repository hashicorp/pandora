...
internal class UserIdOnlineMeetingIdAttendanceReportId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/onlineMeetings/{onlineMeetingId}/attendanceReports/{meetingAttendanceReportId}";
