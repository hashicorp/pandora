...
internal class UpdateUserByIdProfilePublicationByIdOperation : Operations.PatchOperation
{
    ...
    public override ResourceID? ResourceId() => new UserIdProfilePublicationId();
