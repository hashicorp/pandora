...
internal class UserIdCalendarCalendarViewIdInstanceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendar/calendarView/{eventId}/instances/{eventId1}/attachments/{attachmentId}";
