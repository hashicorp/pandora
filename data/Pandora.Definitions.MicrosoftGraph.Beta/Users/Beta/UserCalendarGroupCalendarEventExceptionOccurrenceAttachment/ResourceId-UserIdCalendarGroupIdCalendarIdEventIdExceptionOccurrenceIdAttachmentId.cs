...
internal class UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/users/{userId}/calendarGroups/{calendarGroupId}/calendars/{calendarId}/events/{eventId}/exceptionOccurrences/{eventId1}/attachments/{attachmentId}";
