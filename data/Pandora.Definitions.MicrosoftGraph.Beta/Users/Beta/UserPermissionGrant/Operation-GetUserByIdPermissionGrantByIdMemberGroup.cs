...
internal class GetUserByIdPermissionGrantByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetUserByIdPermissionGrantByIdMemberGroupRequestModel);
