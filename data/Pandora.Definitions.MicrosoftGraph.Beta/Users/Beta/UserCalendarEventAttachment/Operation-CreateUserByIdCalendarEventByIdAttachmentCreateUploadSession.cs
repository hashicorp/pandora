...
internal class CreateUserByIdCalendarEventByIdAttachmentCreateUploadSessionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateUserByIdCalendarEventByIdAttachmentCreateUploadSessionRequestModel);
