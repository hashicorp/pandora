...
internal class GetDomainByIdSharedEmailDomainInvitationCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/sharedEmailDomainInvitations/$count";
}
