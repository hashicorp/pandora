...
internal class GetDirectoryAdministrativeUnitByIdScopedRoleMemberCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/scopedRoleMembers/$count";
}
