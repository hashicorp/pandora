...
internal class ListDirectoryCertificateAuthorityCertificateBasedApplicationConfigurationsOperation : Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";
    public override ResourceID? ResourceId() => null;
    public override Type NestedItemType() => typeof(CertificateBasedApplicationConfigurationCollectionResponseModel);
