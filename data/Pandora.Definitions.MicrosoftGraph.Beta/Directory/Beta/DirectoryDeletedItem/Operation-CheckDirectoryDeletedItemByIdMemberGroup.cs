...
internal class CheckDirectoryDeletedItemByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckDirectoryDeletedItemByIdMemberGroupRequestModel);
