...
internal class GetDirectoryDeletedItemByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetDirectoryDeletedItemByIdMemberGroupRequestModel);
