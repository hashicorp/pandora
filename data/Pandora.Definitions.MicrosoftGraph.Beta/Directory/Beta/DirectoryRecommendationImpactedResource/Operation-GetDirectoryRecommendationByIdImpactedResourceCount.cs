...
internal class GetDirectoryRecommendationByIdImpactedResourceCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/impactedResources/$count";
}
