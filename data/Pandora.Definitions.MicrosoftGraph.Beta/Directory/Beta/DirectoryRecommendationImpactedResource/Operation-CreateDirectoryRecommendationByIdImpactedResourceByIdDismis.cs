...
internal class CreateDirectoryRecommendationByIdImpactedResourceByIdDismisOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateDirectoryRecommendationByIdImpactedResourceByIdDismisRequestModel);
