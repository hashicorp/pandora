...
internal class CreateDirectoryImpactedResourceByIdPostponeOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateDirectoryImpactedResourceByIdPostponeRequestModel);
