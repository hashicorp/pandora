...
internal class GetDirectoryFeatureRolloutPolicyByIdAppliesToByIdsOperation : Operations.ListOperation
{
    ...
    public override string? UriSuffix() => "/appliesTo/getByIds";
}
