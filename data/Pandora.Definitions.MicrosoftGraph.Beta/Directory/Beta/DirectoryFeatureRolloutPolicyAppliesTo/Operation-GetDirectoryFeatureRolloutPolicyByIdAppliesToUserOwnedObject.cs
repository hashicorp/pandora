...
internal class GetDirectoryFeatureRolloutPolicyByIdAppliesToUserOwnedObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetDirectoryFeatureRolloutPolicyByIdAppliesToUserOwnedObjectRequestModel);
