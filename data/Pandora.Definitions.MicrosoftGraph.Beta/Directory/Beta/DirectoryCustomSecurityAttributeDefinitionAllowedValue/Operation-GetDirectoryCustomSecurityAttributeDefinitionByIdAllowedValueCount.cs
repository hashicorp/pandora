...
internal class GetDirectoryCustomSecurityAttributeDefinitionByIdAllowedValueCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/allowedValues/$count";
}
