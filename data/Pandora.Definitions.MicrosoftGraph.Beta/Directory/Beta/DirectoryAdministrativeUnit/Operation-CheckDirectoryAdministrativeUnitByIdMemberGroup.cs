...
internal class CheckDirectoryAdministrativeUnitByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckDirectoryAdministrativeUnitByIdMemberGroupRequestModel);
