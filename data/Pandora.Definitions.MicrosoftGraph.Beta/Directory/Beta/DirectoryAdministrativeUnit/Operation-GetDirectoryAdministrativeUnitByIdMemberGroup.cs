...
internal class GetDirectoryAdministrativeUnitByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetDirectoryAdministrativeUnitByIdMemberGroupRequestModel);
