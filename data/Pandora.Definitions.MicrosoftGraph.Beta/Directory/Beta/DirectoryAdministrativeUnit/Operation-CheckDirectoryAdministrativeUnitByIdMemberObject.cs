...
internal class CheckDirectoryAdministrativeUnitByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckDirectoryAdministrativeUnitByIdMemberObjectRequestModel);
