...
internal class AndroidManagedStoreAppModel
{
    ...
    public List<AndroidManagedStoreAppTrackModel>? AppTracks { get; set; }
    ...
    public AndroidManagedStoreAppPublishingStateConstant? PublishingState { get; set; }
