...
internal class OrganizationalBrandingModel
{
    ...
    public ContentCustomizationModel? ContentCustomization { get; set; }
    ...
    public List<OrganizationalBrandingLocalizationModel>? Localizations { get; set; }
