...
internal class WinGetAppModel
{
    ...
    public WinGetAppInstallExperienceModel? InstallExperience { get; set; }
    ...
    public WinGetAppPublishingStateConstant? PublishingState { get; set; }
