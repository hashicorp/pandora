...
internal class SecurityHostSslCertificateModel
{
    ...
    public List<SecurityHostSslCertificatePortModel>? Ports { get; set; }

    [JsonPropertyName("sslCertificate")]
    public SecuritySslCertificateModel? SslCertificate { get; set; }
}
