...
internal class ProjectParticipationModel
{
    [JsonPropertyName("allowedAudiences")]
    public ProjectParticipationAllowedAudiencesConstant? AllowedAudiences { get; set; }

    [JsonPropertyName("categories")]
    public List<string>? Categories { get; set; }

    [JsonPropertyName("client")]
    public CompanyDetailModel? Client { get; set; }

    [JsonPropertyName("collaborationTags")]
    public List<string>? CollaborationTags { get; set; }

    [JsonPropertyName("colleagues")]
    public List<RelatedPersonModel>? Colleagues { get; set; }
    ...
    public PositionDetailModel? Detail { get; set; }
    ...
    public List<RelatedPersonModel>? Sponsors { get; set; }
