...
internal class GoalsExportJobModel
{
    ...
    [JsonPropertyName("explorerViewId")]
    public string? ExplorerViewId { get; set; }

    [JsonPropertyName("goalsOrganizationId")]
    ...
    public GoalsExportJobStatusConstant? Status { get; set; }
