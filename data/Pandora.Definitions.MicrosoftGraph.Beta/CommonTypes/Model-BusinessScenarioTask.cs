...
internal class BusinessScenarioTaskModel
{
    ...
    public BusinessScenarioPropertiesModel? BusinessScenarioProperties { get; set; }
    ...
    public PlannerTaskCreationModel? CreationSource { get; set; }
    ...
    public PlannerTaskRecurrenceModel? Recurrence { get; set; }
    ...
    public BusinessScenarioTaskTargetBaseModel? Target { get; set; }
