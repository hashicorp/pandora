...
internal class AospDeviceOwnerCertificateProfileBaseModel
{
    [JsonPropertyName("assignments")]
    public List<DeviceConfigurationAssignmentModel>? Assignments { get; set; }

    [JsonPropertyName("certificateValidityPeriodScale")]
    public AospDeviceOwnerCertificateProfileBaseCertificateValidityPeriodScaleConstant? CertificateValidityPeriodScale { get; set; }
    ...
    public AospDeviceOwnerCertificateProfileBaseSubjectAlternativeNameTypeConstant? SubjectAlternativeNameType { get; set; }

    [JsonPropertyName("subjectNameFormat")]
    public AospDeviceOwnerCertificateProfileBaseSubjectNameFormatConstant? SubjectNameFormat { get; set; }
