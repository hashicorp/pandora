...
internal class GroupModel
{
    ...
    public GroupAccessTypeConstant? AccessType { get; set; }
    ...
    public MembershipRuleProcessingStatusModel? MembershipRuleProcessingStatus { get; set; }
    ...
    public List<DirectorySettingModel>? Settings { get; set; }
    ...
    public GroupWritebackConfigurationModel? WritebackConfiguration { get; set; }
}
