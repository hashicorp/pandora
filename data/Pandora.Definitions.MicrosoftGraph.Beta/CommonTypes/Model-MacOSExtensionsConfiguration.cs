...
internal class MacOSExtensionsConfigurationModel
{
    ...
    public List<MacOSKernelExtensionModel>? KernelExtensionsAllowed { get; set; }
    ...
    public List<MacOSSystemExtensionModel>? SystemExtensionsAllowed { get; set; }
    ...
    public List<MacOSSystemExtensionTypeMappingModel>? SystemExtensionsAllowedTypes { get; set; }
