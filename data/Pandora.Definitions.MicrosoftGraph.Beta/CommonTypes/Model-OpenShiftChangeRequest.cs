...
internal class OpenShiftChangeRequestModel
{
    [JsonPropertyName("assignedTo")]
    public OpenShiftChangeRequestAssignedToConstant? AssignedTo { get; set; }
    ...
    public OpenShiftChangeRequestStateConstant? State { get; set; }
}
