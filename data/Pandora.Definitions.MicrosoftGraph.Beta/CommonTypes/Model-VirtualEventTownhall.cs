...
internal class VirtualEventTownhallModel
{
    [JsonPropertyName("audience")]
    public VirtualEventTownhallAudienceConstant? Audience { get; set; }
    ...
    [JsonPropertyName("invitedAttendees")]
    public List<CommunicationsUserIdentityModel>? InvitedAttendees { get; set; }
    ...
    public VirtualEventTownhallStatusConstant? Status { get; set; }
}
