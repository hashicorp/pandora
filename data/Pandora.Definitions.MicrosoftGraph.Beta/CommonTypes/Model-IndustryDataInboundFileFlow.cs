...
internal class IndustryDataInboundFileFlowModel
{
    ...
    public IndustryDataInboundFileFlowDataDomainConstant? DataDomain { get; set; }
    ...
    public IndustryDataInboundFileFlowReadinessStatusConstant? ReadinessStatus { get; set; }
