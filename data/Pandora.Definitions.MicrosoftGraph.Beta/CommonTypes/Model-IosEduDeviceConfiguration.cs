...
internal class IosEduDeviceConfigurationModel
{
    ...
    public IosEduCertificateSettingsModel? DeviceCertificateSettings { get; set; }
    ...
    public IosEduCertificateSettingsModel? StudentCertificateSettings { get; set; }

    [JsonPropertyName("supportsScopeTags")]
    public bool? SupportsScopeTags { get; set; }

    [JsonPropertyName("teacherCertificateSettings")]
    public IosEduCertificateSettingsModel? TeacherCertificateSettings { get; set; }
