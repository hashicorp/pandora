...
internal class DeviceManagementConfigurationGroupSettingCollectionInstanceModel
{
    [JsonPropertyName("groupSettingCollectionValue")]
    public List<DeviceManagementConfigurationGroupSettingValueModel>? GroupSettingCollectionValue { get; set; }
