...
internal class PersonAnnualEventModel
{
    [JsonPropertyName("allowedAudiences")]
    public PersonAnnualEventAllowedAudiencesConstant? AllowedAudiences { get; set; }
    ...
    public PersonAnnualEventTypeConstant? Type { get; set; }
}
