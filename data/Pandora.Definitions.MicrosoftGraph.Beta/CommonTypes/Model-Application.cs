...
internal class ApplicationModel
{
    ...
    [JsonPropertyName("authenticationBehaviors")]
    public AuthenticationBehaviorsModel? AuthenticationBehaviors { get; set; }

    [JsonPropertyName("certification")]
    public CertificationModel? Certification { get; set; }

    [JsonPropertyName("connectorGroup")]
    public ConnectorGroupModel? ConnectorGroup { get; set; }
    ...
    public OnPremisesPublishingModel? OnPremisesPublishing { get; set; }
    ...
    public WindowsApplicationModel? Windows { get; set; }
}
