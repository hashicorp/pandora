...
internal class UserModel
{
    ...
    public UserAnalyticsModel? Analytics { get; set; }

    [JsonPropertyName("appConsentRequestsForApproval")]
    public List<AppConsentRequestModel>? AppConsentRequestsForApproval { get; set; }

    [JsonPropertyName("appRoleAssignedResources")]
    public List<ServicePrincipalModel>? AppRoleAssignedResources { get; set; }
    ...
    public List<DeviceKeyModel>? DeviceKeys { get; set; }
    ...
    public ItemInsightsModel? Insights { get; set; }
    ...
    public List<GroupModel>? JoinedGroups { get; set; }
    ...
    public List<MobileAppIntentAndStateModel>? MobileAppIntentAndStates { get; set; }
    ...
    public List<AccessReviewInstanceModel>? PendingAccessReviewInstances { get; set; }
    ...
    public List<DirectoryObjectModel>? TransitiveReports { get; set; }
    ...
    public UserVirtualEventsRootModel? VirtualEvents { get; set; }
