...
internal class MacOsVppAppModel
{
    [JsonPropertyName("appStoreUrl")]
    public string? AppStoreUrl { get; set; }

    [JsonPropertyName("assignedLicenses")]
    public List<MacOsVppAppAssignedLicenseModel>? AssignedLicenses { get; set; }
    ...
    public MacOsVppAppPublishingStateConstant? PublishingState { get; set; }
    ...
    public List<MacOsVppAppRevokeLicensesActionResultModel>? RevokeLicenseActionResults { get; set; }
    ...
    public MacOsVppAppVppTokenAccountTypeConstant? VppTokenAccountType { get; set; }
