...
internal class GcpAuthorizationSystemModel
{
    [JsonPropertyName("actions")]
    public List<GcpAuthorizationSystemTypeActionModel>? Actions { get; set; }

    [JsonPropertyName("associatedIdentities")]
    public GcpAssociatedIdentitiesModel? AssociatedIdentities { get; set; }
    ...
    public List<GcpAuthorizationSystemResourceModel>? Resources { get; set; }

    [JsonPropertyName("roles")]
    public List<GcpRoleModel>? Roles { get; set; }
