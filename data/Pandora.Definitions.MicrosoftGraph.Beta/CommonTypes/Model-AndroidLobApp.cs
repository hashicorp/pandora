...
internal class AndroidLobAppModel
{
    ...
    public AndroidLobAppPublishingStateConstant? PublishingState { get; set; }
    ...
    public AndroidLobAppTargetedPlatformsConstant? TargetedPlatforms { get; set; }
