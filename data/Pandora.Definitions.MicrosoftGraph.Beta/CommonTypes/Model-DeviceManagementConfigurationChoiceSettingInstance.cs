...
internal class DeviceManagementConfigurationChoiceSettingInstanceModel
{
    [JsonPropertyName("choiceSettingValue")]
    public DeviceManagementConfigurationChoiceSettingValueModel? ChoiceSettingValue { get; set; }
