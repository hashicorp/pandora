...
internal class AospDeviceOwnerEnterpriseWiFiConfigurationModel
{
    ...
    public AospDeviceOwnerTrustedRootCertificateModel? RootCertificateForServerValidation { get; set; }
