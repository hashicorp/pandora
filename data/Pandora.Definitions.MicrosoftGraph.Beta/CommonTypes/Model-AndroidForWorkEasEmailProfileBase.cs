...
internal class AndroidForWorkEasEmailProfileBaseModel
{
    [JsonPropertyName("assignments")]
    public List<DeviceConfigurationAssignmentModel>? Assignments { get; set; }

    [JsonPropertyName("authenticationMethod")]
    public AndroidForWorkEasEmailProfileBaseAuthenticationMethodConstant? AuthenticationMethod { get; set; }
    ...
    public AndroidForWorkEasEmailProfileBaseDurationOfEmailToSyncConstant? DurationOfEmailToSync { get; set; }

    [JsonPropertyName("emailAddressSource")]
    public AndroidForWorkEasEmailProfileBaseEmailAddressSourceConstant? EmailAddressSource { get; set; }
    ...
    public AndroidForWorkEasEmailProfileBaseUsernameSourceConstant? UsernameSource { get; set; }
