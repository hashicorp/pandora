...
internal class ActiveDirectoryWindowsAutopilotDeploymentProfileModel
{
    ...
    public ActiveDirectoryWindowsAutopilotDeploymentProfileDeviceTypeConstant? DeviceType { get; set; }

    [JsonPropertyName("displayName")]
    public string? DisplayName { get; set; }

    [JsonPropertyName("domainJoinConfiguration")]
    public WindowsDomainJoinConfigurationModel? DomainJoinConfiguration { get; set; }
