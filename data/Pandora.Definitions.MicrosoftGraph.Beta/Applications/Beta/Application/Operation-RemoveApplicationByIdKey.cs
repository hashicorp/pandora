...
internal class RemoveApplicationByIdKeyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(RemoveApplicationByIdKeyRequestModel);
