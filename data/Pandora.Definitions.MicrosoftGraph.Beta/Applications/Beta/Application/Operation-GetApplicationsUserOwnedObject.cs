...
internal class GetApplicationsUserOwnedObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetApplicationsUserOwnedObjectRequestModel);
