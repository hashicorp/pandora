...
internal class GetApplicationByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetApplicationByIdMemberObjectRequestModel);
