...
internal class AddApplicationByIdPasswordOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(AddApplicationByIdPasswordRequestModel);
