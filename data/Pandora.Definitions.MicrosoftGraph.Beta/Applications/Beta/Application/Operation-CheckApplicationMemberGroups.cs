...
internal class CheckApplicationMemberGroupsOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckApplicationMemberGroupsRequestModel);
