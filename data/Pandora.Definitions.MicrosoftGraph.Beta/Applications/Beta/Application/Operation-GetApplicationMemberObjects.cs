...
internal class GetApplicationMemberObjectsOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetApplicationMemberObjectsRequestModel);
