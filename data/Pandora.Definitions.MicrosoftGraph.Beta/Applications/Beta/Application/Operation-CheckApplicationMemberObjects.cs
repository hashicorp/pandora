...
internal class CheckApplicationMemberObjectsOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckApplicationMemberObjectsRequestModel);
