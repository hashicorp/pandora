...
internal class ValidateApplicationByIdSynchronizationJobsCredentialOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ValidateApplicationByIdSynchronizationJobsCredentialRequestModel);
