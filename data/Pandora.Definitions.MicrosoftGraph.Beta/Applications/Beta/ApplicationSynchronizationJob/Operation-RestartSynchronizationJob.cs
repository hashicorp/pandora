...
internal class RestartSynchronizationJobOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(RestartSynchronizationJobRequestModel);
