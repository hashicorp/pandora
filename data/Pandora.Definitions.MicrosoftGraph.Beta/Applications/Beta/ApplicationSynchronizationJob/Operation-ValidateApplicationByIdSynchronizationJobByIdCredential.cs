...
internal class ValidateApplicationByIdSynchronizationJobByIdCredentialOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ValidateApplicationByIdSynchronizationJobByIdCredentialRequestModel);
