...
internal class ProvisionApplicationByIdSynchronizationJobByIdOnDemandOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(ProvisionApplicationByIdSynchronizationJobByIdOnDemandRequestModel);
