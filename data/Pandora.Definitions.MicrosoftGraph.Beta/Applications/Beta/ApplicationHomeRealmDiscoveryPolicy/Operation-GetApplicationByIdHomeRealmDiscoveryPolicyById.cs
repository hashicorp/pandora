...
internal class GetApplicationByIdHomeRealmDiscoveryPolicyByIdOperation : Operations.GetOperation
{
    ...
    public override ResourceID? ResourceId() => new ApplicationIdHomeRealmDiscoveryPolicyId();
