...
internal class SetMeChatByIdMessageByIdReplyByIdReactionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(SetMeChatByIdMessageByIdReplyByIdReactionRequestModel);
