...
internal class CreateMeMailFolderByIdChildFolderByIdCopyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMailFolderByIdChildFolderByIdCopyRequestModel);
