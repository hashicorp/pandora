...
internal class MePendingAccessReviewInstanceIdStageIdDecisionIdInstanceDecisionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/pendingAccessReviewInstances/{accessReviewInstanceId}/stages/{accessReviewStageId}/decisions/{accessReviewInstanceDecisionItemId}/instance/decisions/{accessReviewInstanceDecisionItemId1}";
