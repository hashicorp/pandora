...
internal class GetMeManagedDeviceByIdSecurityBaselineStateCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/securityBaselineStates/$count";
}
