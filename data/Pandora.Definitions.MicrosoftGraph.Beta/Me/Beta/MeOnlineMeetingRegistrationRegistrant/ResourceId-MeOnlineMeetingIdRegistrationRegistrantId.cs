...
internal class MeOnlineMeetingIdRegistrationRegistrantId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/onlineMeetings/{onlineMeetingId}/registration/registrants/{meetingRegistrantBaseId}";
