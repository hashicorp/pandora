...
internal class MeCalendarIdEventIdExceptionOccurrenceId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendars/{calendarId}/events/{eventId}/exceptionOccurrences/{eventId1}";
