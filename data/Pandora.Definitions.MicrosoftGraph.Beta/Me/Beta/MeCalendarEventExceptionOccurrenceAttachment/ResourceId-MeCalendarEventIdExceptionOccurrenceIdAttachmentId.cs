...
internal class MeCalendarEventIdExceptionOccurrenceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendar/events/{eventId}/exceptionOccurrences/{eventId1}/attachments/{attachmentId}";
