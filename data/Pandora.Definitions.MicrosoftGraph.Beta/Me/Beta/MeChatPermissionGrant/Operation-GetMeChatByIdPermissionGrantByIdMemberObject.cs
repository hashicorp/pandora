...
internal class GetMeChatByIdPermissionGrantByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetMeChatByIdPermissionGrantByIdMemberObjectRequestModel);
