...
internal class CheckMeChatByIdPermissionGrantByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckMeChatByIdPermissionGrantByIdMemberGroupRequestModel);
