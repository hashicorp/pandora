...
internal class CheckMeChatByIdPermissionGrantByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckMeChatByIdPermissionGrantByIdMemberObjectRequestModel);
