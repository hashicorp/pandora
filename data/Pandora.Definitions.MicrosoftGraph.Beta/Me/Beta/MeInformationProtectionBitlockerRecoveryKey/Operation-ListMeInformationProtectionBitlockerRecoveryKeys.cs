...
internal class ListMeInformationProtectionBitlockerRecoveryKeysOperation : Operations.ListOperation
{
    public override string? FieldContainingPaginationDetails() => "nextLink";
    public override ResourceID? ResourceId() => null;
    public override Type NestedItemType() => typeof(BitlockerRecoveryKeyCollectionResponseModel);
    public override string? UriSuffix() => "/me/informationProtection/bitlocker/recoveryKeys";
}
