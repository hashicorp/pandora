...
internal class MeMailFolderIdChildFolderIdMessageIdMentionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/mailFolders/{mailFolderId}/childFolders/{mailFolderId1}/messages/{messageId}/mentions/{mentionId}";
