...
internal class MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendarGroups/{calendarGroupId}/calendars/{calendarId}/events/{eventId}/exceptionOccurrences/{eventId1}/extensions/{extensionId}";
