...
internal class MeCalendarIdEventIdExceptionOccurrenceIdInstanceId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendars/{calendarId}/events/{eventId}/exceptionOccurrences/{eventId1}/instances/{eventId2}";
