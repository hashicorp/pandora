...
internal class MeCalendarIdCalendarViewIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendars/{calendarId}/calendarView/{eventId}/exceptionOccurrences/{eventId1}/extensions/{extensionId}";
