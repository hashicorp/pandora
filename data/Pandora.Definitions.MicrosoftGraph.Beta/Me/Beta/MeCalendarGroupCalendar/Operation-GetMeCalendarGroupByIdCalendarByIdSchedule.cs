...
internal class GetMeCalendarGroupByIdCalendarByIdScheduleOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetMeCalendarGroupByIdCalendarByIdScheduleRequestModel);
