...
internal class CreateMeEventByIdDeclineOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeEventByIdDeclineRequestModel);
