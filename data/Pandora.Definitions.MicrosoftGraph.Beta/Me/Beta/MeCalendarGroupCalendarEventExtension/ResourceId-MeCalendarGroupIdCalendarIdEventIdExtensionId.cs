...
internal class MeCalendarGroupIdCalendarIdEventIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendarGroups/{calendarGroupId}/calendars/{calendarId}/events/{eventId}/extensions/{extensionId}";
