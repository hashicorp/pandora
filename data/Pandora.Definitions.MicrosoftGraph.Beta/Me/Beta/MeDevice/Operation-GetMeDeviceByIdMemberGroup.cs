...
internal class GetMeDeviceByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetMeDeviceByIdMemberGroupRequestModel);
