...
internal class CheckMeDeviceByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckMeDeviceByIdMemberObjectRequestModel);
