...
internal class CheckMeDeviceByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckMeDeviceByIdMemberGroupRequestModel);
