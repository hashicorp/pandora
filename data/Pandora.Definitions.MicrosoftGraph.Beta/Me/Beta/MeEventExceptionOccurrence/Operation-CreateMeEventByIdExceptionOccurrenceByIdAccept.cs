...
internal class CreateMeEventByIdExceptionOccurrenceByIdAcceptOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeEventByIdExceptionOccurrenceByIdAcceptRequestModel);
