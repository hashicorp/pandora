...
internal class CreateMeEventByIdExceptionOccurrenceByIdCancelOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeEventByIdExceptionOccurrenceByIdCancelRequestModel);
