...
internal class MeCalendarViewIdInstanceIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendarView/{eventId}/instances/{eventId1}/exceptionOccurrences/{eventId2}/extensions/{extensionId}";
