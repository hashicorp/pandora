...
internal class CreateMeMailFolderByIdChildFolderByIdMessageByIdMoveOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMailFolderByIdChildFolderByIdMessageByIdMoveRequestModel);
