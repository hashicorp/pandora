...
internal class MeCalendarIdEventIdInstanceIdExceptionOccurrenceId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendars/{calendarId}/events/{eventId}/instances/{eventId1}/exceptionOccurrences/{eventId2}";
