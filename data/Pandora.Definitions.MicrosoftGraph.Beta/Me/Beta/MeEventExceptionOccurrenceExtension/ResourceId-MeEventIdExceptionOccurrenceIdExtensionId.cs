...
internal class MeEventIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/events/{eventId}/exceptionOccurrences/{eventId1}/extensions/{extensionId}";
