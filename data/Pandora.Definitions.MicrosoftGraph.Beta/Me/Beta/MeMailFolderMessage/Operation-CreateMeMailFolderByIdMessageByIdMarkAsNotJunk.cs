...
internal class CreateMeMailFolderByIdMessageByIdMarkAsNotJunkOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMailFolderByIdMessageByIdMarkAsNotJunkRequestModel);
