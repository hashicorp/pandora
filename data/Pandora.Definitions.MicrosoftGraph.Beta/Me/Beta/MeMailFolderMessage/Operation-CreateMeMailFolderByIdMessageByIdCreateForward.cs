...
internal class CreateMeMailFolderByIdMessageByIdCreateForwardOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMailFolderByIdMessageByIdCreateForwardRequestModel);
