...
internal class CreateMeMailFolderByIdMessageByIdCopyOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMailFolderByIdMessageByIdCopyRequestModel);
