...
internal class CreateMeCalendarByIdEventByIdAcceptOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeCalendarByIdEventByIdAcceptRequestModel);
