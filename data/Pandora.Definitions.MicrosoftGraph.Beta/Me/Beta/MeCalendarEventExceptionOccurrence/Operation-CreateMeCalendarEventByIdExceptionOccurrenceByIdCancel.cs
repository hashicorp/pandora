...
internal class CreateMeCalendarEventByIdExceptionOccurrenceByIdCancelOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeCalendarEventByIdExceptionOccurrenceByIdCancelRequestModel);
