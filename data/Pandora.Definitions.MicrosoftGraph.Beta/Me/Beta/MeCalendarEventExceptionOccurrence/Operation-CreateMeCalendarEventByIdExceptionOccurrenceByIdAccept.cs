...
internal class CreateMeCalendarEventByIdExceptionOccurrenceByIdAcceptOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeCalendarEventByIdExceptionOccurrenceByIdAcceptRequestModel);
