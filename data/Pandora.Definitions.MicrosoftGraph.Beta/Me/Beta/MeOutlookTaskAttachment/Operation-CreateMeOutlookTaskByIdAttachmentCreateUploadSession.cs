...
internal class CreateMeOutlookTaskByIdAttachmentCreateUploadSessionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeOutlookTaskByIdAttachmentCreateUploadSessionRequestModel);
