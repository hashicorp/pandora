...
internal class CreateMeCalendarViewByIdDeclineOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeCalendarViewByIdDeclineRequestModel);
