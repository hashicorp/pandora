...
internal class MeCalendarEventIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendar/events/{eventId}/exceptionOccurrences/{eventId1}/extensions/{extensionId}";
