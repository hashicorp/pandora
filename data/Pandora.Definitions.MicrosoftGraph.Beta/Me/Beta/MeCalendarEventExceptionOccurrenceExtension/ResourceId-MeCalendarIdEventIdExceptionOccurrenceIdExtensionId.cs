...
internal class MeCalendarIdEventIdExceptionOccurrenceIdExtensionId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendars/{calendarId}/events/{eventId}/exceptionOccurrences/{eventId1}/extensions/{extensionId}";
