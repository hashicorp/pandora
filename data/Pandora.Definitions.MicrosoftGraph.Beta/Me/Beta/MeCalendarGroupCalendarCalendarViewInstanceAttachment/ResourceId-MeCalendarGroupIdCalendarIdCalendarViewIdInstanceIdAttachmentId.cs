...
internal class MeCalendarGroupIdCalendarIdCalendarViewIdInstanceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendarGroups/{calendarGroupId}/calendars/{calendarId}/calendarView/{eventId}/instances/{eventId1}/attachments/{attachmentId}";
