...
internal class CreateMeOnenoteSectionByIdPageByIdCopyToSectionOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeOnenoteSectionByIdPageByIdCopyToSectionRequestModel);
