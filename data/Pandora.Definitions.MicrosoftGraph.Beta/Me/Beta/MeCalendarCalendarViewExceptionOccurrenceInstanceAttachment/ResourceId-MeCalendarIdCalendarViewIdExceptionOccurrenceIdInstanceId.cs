...
internal class MeCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendars/{calendarId}/calendarView/{eventId}/exceptionOccurrences/{eventId1}/instances/{eventId2}";
