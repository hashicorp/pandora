...
internal class CreateMeChatByIdHideForUserOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeChatByIdHideForUserRequestModel);
