...
internal class MeCalendarViewIdExceptionOccurrenceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendarView/{eventId}/exceptionOccurrences/{eventId1}/attachments/{attachmentId}";
