...
internal class CreateMeInformationProtectionSensitivityLabelOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/me/informationProtection/sensitivityLabels";
}
