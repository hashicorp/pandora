...
internal class CreateMeMessageByIdMarkAsNotJunkOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMessageByIdMarkAsNotJunkRequestModel);
