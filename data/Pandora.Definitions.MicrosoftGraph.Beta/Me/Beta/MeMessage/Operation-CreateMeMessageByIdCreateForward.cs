...
internal class CreateMeMessageByIdCreateForwardOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CreateMeMessageByIdCreateForwardRequestModel);
