...
internal class MeOnlineMeetingIdAttendanceReportIdAttendanceRecordId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/onlineMeetings/{onlineMeetingId}/attendanceReports/{meetingAttendanceReportId}/attendanceRecords/{attendanceRecordId}";
