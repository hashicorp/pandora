...
internal class CreateMeSecurityInformationProtectionSensitivityLabelOperation : Operations.PostOperation
{
    ...
    public override string? UriSuffix() => "/me/security/informationProtection/sensitivityLabels";
}
