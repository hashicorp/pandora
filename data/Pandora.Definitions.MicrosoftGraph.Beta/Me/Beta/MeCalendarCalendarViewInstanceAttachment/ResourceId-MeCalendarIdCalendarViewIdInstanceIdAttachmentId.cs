...
internal class MeCalendarIdCalendarViewIdInstanceIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/calendars/{calendarId}/calendarView/{eventId}/instances/{eventId1}/attachments/{attachmentId}";
