...
internal class MeOutlookTaskGroupIdTaskFolderIdTaskIdAttachmentId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/me/outlook/taskGroups/{outlookTaskGroupId}/taskFolders/{outlookTaskFolderId}/tasks/{outlookTaskId}/attachments/{attachmentId}";
