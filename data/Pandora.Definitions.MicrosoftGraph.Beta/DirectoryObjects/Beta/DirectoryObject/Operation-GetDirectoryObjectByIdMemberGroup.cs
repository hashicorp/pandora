...
internal class GetDirectoryObjectByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(GetDirectoryObjectByIdMemberGroupRequestModel);
