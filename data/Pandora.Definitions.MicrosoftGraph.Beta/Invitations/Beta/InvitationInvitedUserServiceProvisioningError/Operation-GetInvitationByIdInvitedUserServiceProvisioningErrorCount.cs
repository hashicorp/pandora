...
internal class GetInvitationByIdInvitedUserServiceProvisioningErrorCountOperation : Operations.GetOperation
{
    ...
    public override string? UriSuffix() => "/invitedUser/serviceProvisioningErrors/$count";
}
