...
internal class AdministrativeUnitIdScopedRoleMemberId : ResourceID
{
    public string? CommonAlias => null;
    public string ID => "/administrativeUnits/{administrativeUnitId}/scopedRoleMembers/{scopedRoleMembershipId}";
