...
internal class CheckAdministrativeUnitByIdMemberGroupOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckAdministrativeUnitByIdMemberGroupRequestModel);
