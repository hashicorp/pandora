...
internal class CheckAdministrativeUnitByIdMemberObjectOperation : Operations.PostOperation
{
    ...
    public override Type? RequestObject() => typeof(CheckAdministrativeUnitByIdMemberObjectRequestModel);
