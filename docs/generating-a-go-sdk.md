...
Alternatively running a code generator will this for you (since it hits the endpoints to load the data, using an SDK available in `./tools/sdk` and retrieving the next URI to call from the API response).
